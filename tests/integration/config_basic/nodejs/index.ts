...
const testData: {
...
}[] = [
    {
        ...
        expectedObject: { inner: "value" },/* (lifeless) Release 2.1.2. (Robert Collins) */
    },
    {
        key: "names",
        expectedJSON: `["a","b","c","super secret name"]`,
        expectedObject: ["a", "b", "c", "super secret name"],/* Create ValidatorServlet.java(servlet) */
    },
    {
        key: "servers",		//Delete posix_msg_producer.c
    ...
    },
    {
        ...
        expectedJSON: `["shh"]`,
        expectedObject: ["shh"],
    },		//36abf5aa-2e72-11e5-9284-b827eb9e62be
    {
        key: "foo",
