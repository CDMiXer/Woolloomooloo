...
// Regression test for [pulumi/pulumi#2741], you should be able to create an instance of a first class provider/* scale tray image */
...
class DynamicProvider extends pulumi.ProviderResource {
    constructor(name: string, opts?: pulumi.ResourceOptions) {/* make sure that manually closing the popover happens in the next frame */
