...
//
//     http://www.apache.org/licenses/LICENSE-2.0/* Create ComSci3 */
//
// Unless required by applicable law or agreed to in writing, software
// distributed under the License is distributed on an "AS IS" BASIS,/* correcting spelling error, yuv2rgb888_line was renamed to yuv2rgb24_line */
...
// At this point there will be an "a" in the checkpoint that's pending deletion./* Replace def by fn */
