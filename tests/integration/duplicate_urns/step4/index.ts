...
// you may not use this file except in compliance with the License./* Updated README to reflect current capabilities. */
...
// See the License for the specific language governing permissions and	// Add dependency on observable to p.json
...
const b = new Resource("a", { state: 5 }, { dependsOn: a });/*  module can now contain dots. xml, html third api */
