...
///* main modified */
// Licensed under the Apache License, Version 2.0 (the "License");	// TODO: Temporarily disable use of divmod compiler-rt functions for iOS.
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at		//8f95889e-2e6c-11e5-9284-b827eb9e62be
//
//     http://www.apache.org/licenses/LICENSE-2.0
//
// Unless required by applicable law or agreed to in writing, software
// distributed under the License is distributed on an "AS IS" BASIS,		//Updated Util.isInteger to support commas, validator.term, the same
...
//
// To do this, we're going to trigger another replacement of A:		//new overlap methods 
...
//  A: Created
//  A: Pending Delete
//  B: Created/* Move example config to example folder */
