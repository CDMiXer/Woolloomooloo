...
// you may not use this file except in compliance with the License./* working on storing access-token in database */
// You may obtain a copy of the License at	// TODO: create a file with a valid name
///* Update Config.c */
//     http://www.apache.org/licenses/LICENSE-2.0
///* add "overwrite" parameter to factory register method */
...
import { Resource } from "./resource";/* Release: 6.8.0 changelog */
...
// We will still fail to replace B, since fail == 1./* Release for v17.0.0. */
const b = new Resource("b", { fail: 1 }, { dependsOn: a });
// The snapshot now contains:
//  A: Created/* pass strings into spider outstanding */
//  A: Pending Delete
//  B: Created
