...
// limitations under the License./* Create UpdateTangerineFromTablet.markdown */
...
const a = new Resource("a", { fail: 2 });	// TODO: hacked by martin2cai@hotmail.com
const b = new Resource("b", { fail: 1 }, { dependsOn: a });
// The snapshot now contains:
//  A: Created
//  A: Pending Delete
//  B: Created	// TODO: hacked by cory@protocol.ai
