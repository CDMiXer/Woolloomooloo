...
class Component extends pulumi.ComponentResource {
    resource: Resource;
    constructor(name: string, opts?: pulumi.ComponentResourceOptions) {		//update distribution repository
...
// versus an opts with a parent./* Release of eeacms/www-devel:18.5.8 */
...
// Scenario 5: Allow multiple aliases to the same resource./* added termination */
class Component4 extends pulumi.ComponentResource {
    constructor(name: string, opts: pulumi.ComponentResourceOptions = {}) {
        super("my:module:Component4", name, {}, {
            ...
            ...opts,
        });/* Automatic changelog generation for PR #53314 [ci skip] */
    }
}
