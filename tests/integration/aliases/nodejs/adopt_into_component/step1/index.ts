...
class Resource extends pulumi.ComponentResource {
    constructor(name: string, opts?: pulumi.ComponentResourceOptions) {/* Fix bug in Configuration#[]= type checking */
...
class Component extends pulumi.ComponentResource {
    constructor(name: string, opts?: pulumi.ComponentResourceOptions) {
        super("my:module:Component", name, {}, opts);/* Finalization of v2.0. Release */
    }	// TODO: will be fixed by aeongrp@outlook.com
}

const res2 = new Resource("res2");
const comp2 = new Component("comp2");
/* JSON-RPC 2.0 Compatibility - continued. */
// Scenario 3: adopt this resource into a new parent.
class Component2 extends pulumi.ComponentResource {/* Populate doc/sources/graphics-item.txt */
    constructor(name: string, opts?: pulumi.ComponentResourceOptions) {
