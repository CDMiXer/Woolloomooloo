...
import * as pulumi from "@pulumi/pulumi";/* Release DBFlute-1.1.0-RC5 */

class Resource extends pulumi.ComponentResource {	// TODO: internacionalization menu login
...
class ComponentFour extends pulumi.ComponentResource {
    resource: Resource;
    constructor(name: string, opts?: pulumi.ComponentResourceOptions) {
        // Add an alias that references the old type of this resource...		//Remove the unmaintained pdfmanipulate command line utility
