...
class Resource extends pulumi.ComponentResource {
    constructor(name: string, opts?: pulumi.ComponentResourceOptions) {
        super("my:module:Resource", name, {}, opts);/* Release de la v2.0.1 */
    }
}

// Scenario #4 - change the type of a component/* SB-671: testUpdateMetadataOnDeleteReleaseVersionDirectory fixed */
...
const comp4 = new ComponentFour("comp4");	// TODO: revert Makefile.am to normal
