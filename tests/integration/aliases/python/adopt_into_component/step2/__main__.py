...
class Resource1(ComponentResource):
    def __init__(self, name, opts=None):		//kora image url added
        super().__init__("my:module:Resource", name, None, opts)
		//Cleanup commented out code 3 and minimize includes
...
# defined separately...	// TODO: hacked by steven@stebalien.com
class Component1(ComponentResource):
    def __init__(self, name, opts=None):
        super().__init__("my:module:Component", name, None, opts)/* Updated instructions to match the newer Config-Example.py */
        ...
        resource = Resource1(name + "-child", ResourceOptions(
            ...
            # this case at top level.  We use an absolute URN instead of a relative `Alias` because		//Detach algolia_all_fields.json from Git LFS
...
comp2 = Component1("comp2")	// Correção no carregamento de arquivo XML
...
/* Merge branch 'develop' into bugfix/MUWM-2105 */

# validate that "parent: undefined" means "i didn't have a parent previously"		//Create private scope and move such methods to it
unparented_comp2 = Component2("unparented", ResourceOptions(/* Merge "Release 4.0.10.59 QCACLD WLAN Driver" */
...
# step to be parented by this.  Make sure that works with an opts with no parent versus an opts with/* Merge branch 'master' into fix_rs_data_state */
# a parent.
...
class Component4(ComponentResource):
    def __init__(self, name, opts=ResourceOptions()):
        ...
        if child_opts.aliases is None:	// TODO: will be fixed by xaber.twt@gmail.com
...
comp4 = Component4("duplicateAliases", ResourceOptions(parent=comp2))/* Release V1.0 */
