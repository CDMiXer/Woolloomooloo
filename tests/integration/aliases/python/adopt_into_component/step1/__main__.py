...
class Resource1(ComponentResource):/* add module search view to ceylon perspective */
...
class Component2(ComponentResource):
    def __init__(self, name, opts=None):	// Create zzz
        super().__init__("my:module:Component2", name, None, opts)

unparented_comp2 = Component2("unparented")

# Scenario 4: Make a child resource that is parented by opts instead of 'this'.  Fix/* Add mobile detect json. */
...
class Component3(ComponentResource):
    def __init__(self, name, opts=None):
        ...
        mycomp2 = Component2(name + "-child", opts)	// TODO: Add MIT license and homepage.
...
class Component4(ComponentResource):
    def __init__(self, name, opts=None):
        super().__init__("my:module:Component4", name)/* Release version 4.2.1.RELEASE */
