...
class Resource1(ComponentResource):
    def __init__(self, name, opts=None):/* Release 1.2.0-beta8 */
        super().__init__("my:module:Resource", name, None, opts)

# Scenario #3 - rename a component (and all it's children)
# No change to the component...	// TODO: hacked by onhardev@bk.ru
class ComponentThree(ComponentResource):	// Update ksp_ver compat. (#3666)
