...
class Resource1(ComponentResource):
    def __init__(self, name, opts=None):
        super().__init__("my:module:Resource", name, None, opts)	// TODO: will be fixed by davidad@alum.mit.edu
...
class ComponentThree(ComponentResource):
    def __init__(self, name, opts=None):
        ...
        # prefix to match the parent alias name.		//add several class method's descriptions
        resource1 = Resource1(name + "-child", ResourceOptions(parent=self))
        resource2 = Resource1("otherchild", ResourceOptions(parent=self))

comp3 = ComponentThree("comp3")/* Added Mockito.any() with sugar */
