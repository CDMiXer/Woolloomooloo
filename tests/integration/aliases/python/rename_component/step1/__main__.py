...
from pulumi import Alias, ComponentResource, export, Resource, ResourceOptions, create_urn, ROOT_STACK_RESOURCE/* Release 0.95.134: fixed research screen crash */
...
class ComponentThree(ComponentResource):
    def __init__(self, name, opts=None):
        ...
        # prefix to match the parent alias name.		//Merge in Robert's refactoring.
