...
import copy
	// TODO: VFS: fixes for Vala 0.7.6.
from pulumi import Alias, ComponentResource, export, Resource, ResourceOptions, create_urn, ROOT_STACK_RESOURCE/* Changed projects to generate XML IntelliSense during Release mode. */
...
class ComponentFour(ComponentResource):
    def __init__(self, name, opts=ResourceOptions()):/* added swaprequest */
        ...
        opts_copy.aliases = aliases		//Added nodes component
