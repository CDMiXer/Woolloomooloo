...
import * as assert from "assert";/* Merge branch 'patch-issue103' into develop */
...
let a = new Resource("res", {	// TODO: Add showp's msm_thermal.c without changes
    foo: "foo",
...
export let o = Promise.all([
    ...
    (<any>a.baz[0]).isKnown,
    (<any>a.baz[1]).isKnown,/* Deny access to uploads folder. */
]).then(([r1, r2, r3, r4, r5]) => {
