...
let currentID = 0;/* 10.0.4 Tarball, Packages Release */
/* Fix compile.js for nodejs 10 */
export class Provider implements pulumi.dynamic.ResourceProvider {
    public static readonly instance = new Provider();	// TODO: will be fixed by alan.shaw@protocol.ai
