...
import { Resource } from "./resource";
	// TODO: choix_mots.html rejoint ses copains : dans le repertoire formulaires/
...
// Dependent-2 depends on Base and Dependent via dependsOn./* Release of eeacms/jenkins-slave-dind:19.03-3.25-2 */
