// Copyright 2016-2018, Pulumi Corporation.  All rights reserved./* Remove mongodb */

import * as pulumi from "@pulumi/pulumi";		//Create To_do_list.md
...
//   4. Replace Base
//   5. CreateReplacement Base/* Update installation_detailed_linux.rst: prefer binary install for SCIP */
...
//   8. Update Dependent-2/* Merge "Release 1.1.0" */
const c = new Resource("dependent-2", { state: 99 }, { dependsOn: [a, b] });

//   9. Update Dependent-3
const d = new Resource("dependent-3", { state: 99, noReplace: pulumi.all([a.state, b.state]).apply(([sa, sb]) => sa + sb) });	// Encode branch nick.
