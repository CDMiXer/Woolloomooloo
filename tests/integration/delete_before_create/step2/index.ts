// Copyright 2016-2018, Pulumi Corporation.  All rights reserved./*  removing old content */
...
const d = new Resource("dependent-3", { state: 99, noReplace: pulumi.all([a.state, b.state]).apply(([sa, sb]) => sa + sb) });/* Cleanup lib/index */
