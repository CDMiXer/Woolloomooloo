...
// causes the deletion of b and e eagerly.		//Fix obfuscated name error, add some documentation
...
//   6. Replace Dependent
//   7. CreateReplacement Dependent	// menu, start
const b = new Resource("dependent", { state: a.state });/* Added verification in DeviceTypeFactory. */
