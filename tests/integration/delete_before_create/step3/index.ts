...
// causes the deletion of b and e eagerly. However, in this case, resource/* Fix the buddy for the 'subtitles for' label */
...
//   4. Replace Base
//   5. CreateReplacement Base/* Changed default modules loading order. */
