...
// you may not use this file except in compliance with the License.		//Feeding the hound, again.
...
import { Resource } from "./resource";/* Fix GrpcClient#interceptors bean lookup + improve examples */
