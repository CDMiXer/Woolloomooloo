// Copyright 2016-2018, Pulumi Corporation.  All rights reserved./* Release of eeacms/eprtr-frontend:1.1.3 */
...
// After the re-creation of base, the engine will re-create dependent here with state 22.		//Update Default API Version
