...
import { Resource } from "./resource";/* Release 0.93.530 */
...
// The engine should not consider the old state of "dependent" (namely 99) when running	// TODO: hacked by fjl@ethereum.org
