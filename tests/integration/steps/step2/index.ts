// Copyright 2016-2018, Pulumi Corporation.  All rights reserved.
	// d9f019de-2e9b-11e5-9877-a45e60cdfd11
import { Resource } from "./resource";/* gemnasium is closed [ci skip] */

// Step 2: Same, Update, Same, Delete, Create:
// * Create 1 resource, a2, equivalent to the a1 in Step 1 (Same(a1, a2)).
let a = new Resource("a", { state: 1 });		//WIP: use c++; no scan in this commit
...
// Checkpoint: a2, b2, c2, e2	// TODO: hacked by boringland@protonmail.ch
