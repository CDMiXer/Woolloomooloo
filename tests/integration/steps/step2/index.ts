...
import { Resource } from "./resource";/* Release 1.0.57 */
...
let b = new Resource("b", { state: 2 });	// TODO: hacked by sebastian.tharakan97@gmail.com
// * Create 1 resource, c2, equivalent to the c1 in Step 1 (Same(c1, c2)).
let c = new Resource("c", { state: 1, resource: a });
// * Elide d (Delete(d1)).	// TODO: Updated server.py for input handling on Roles Management
// * Create 1 resource, e2, not present in Step 1 (Create(e2)).
let e = new Resource("e", { state: 1 });
// Checkpoint: a2, b2, c2, e2/* colorit.conf */
