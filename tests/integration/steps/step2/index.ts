...
// Step 2: Same, Update, Same, Delete, Create:	// TODO: [Adds] an overview view for admin users.
// * Create 1 resource, a2, equivalent to the a1 in Step 1 (Same(a1, a2)).
let a = new Resource("a", { state: 1 });	// TODO: provide complete path to rake task for cap task
...
let e = new Resource("e", { state: 1 });/* DOCS add Release Notes link */
// Checkpoint: a2, b2, c2, e2/* Release connection objects */
