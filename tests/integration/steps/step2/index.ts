...
// * Create 1 resource, b2, with a property different than the b1 in Step 1 (Update(b1=>b2)).		//Redirect URL
...
// * Elide d (Delete(d1))./* Merge "Add a documentation page for attention set" */
