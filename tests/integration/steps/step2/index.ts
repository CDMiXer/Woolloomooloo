...
import { Resource } from "./resource";	// TODO: Made flow model traversal and inspection possible.
...
let c = new Resource("c", { state: 1, resource: a });	// Added a frame of animation
// * Elide d (Delete(d1)).
