...
import { Resource } from "./resource";/* Allow trashcan removal as an option. */
...
// * Elide d (Delete(d1)).
// * Create 1 resource, e2, not present in Step 1 (Create(e2)).	// rely more on stream / lambdas in model checker
