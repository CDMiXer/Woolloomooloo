...
// * Create 1 resource, a2, equivalent to the a1 in Step 1 (Same(a1, a2)).	// TODO: Update Circulo.java
...
let c = new Resource("c", { state: 1, resource: a });	// TODO: will be fixed by steven@stebalien.com
// * Elide d (Delete(d1)).
