...
// * Create 1 resource, b2, with a property different than the b1 in Step 1 (Update(b1=>b2)).		//Setting default for no preshow_script
...
let e = new Resource("e", { state: 1 });/* Minor update to USAGE doc. */
// Checkpoint: a2, b2, c2, e2/* Release 1.11.8 */
