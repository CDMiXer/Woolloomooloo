...
/* Improved string reading code */
import { Resource } from "./resource";/* Delete GRBL-Plotter/bin/Release/data/fonts directory */

// Step4: Replace a resource (but this time, deleteBeforeReplace):
// * Create 1 resource, a4, equivalent to the a3 in Step 3 (Same(a3, a4)).
let a = new Resource("a", { state: 1, replace: 1 });
// * Create 1 resource, c4, with a property different than the c3 in Step 3, requiring replacement; set	// TODO: zu früh gefreut, weiterer Fix
