...
// Step4: Replace a resource (but this time, deleteBeforeReplace):/* Release httparty dependency */
// * Create 1 resource, a4, equivalent to the a3 in Step 3 (Same(a3, a4)).
let a = new Resource("a", { state: 1, replace: 1 });/* Follow-up to r5614, docstring fix. */
...
let e = new Resource("e", { state: 1 });/* Update GreenSlime.java */
