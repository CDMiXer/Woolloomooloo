...
// * Create 1 resource, a4, equivalent to the a3 in Step 3 (Same(a3, a4))./* remove production stage */
let a = new Resource("a", { state: 1, replace: 1 });/* Update CassandraConfigReadin.java */
