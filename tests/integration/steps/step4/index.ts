...
// * Create 1 resource, a4, equivalent to the a3 in Step 3 (Same(a3, a4))./* Release 1.0.38 */
...
let c = new Resource("c", { state: 1, replaceDBR: 1, resource: a });/* closes #598, ref #559 - i made a small change to a install test */
