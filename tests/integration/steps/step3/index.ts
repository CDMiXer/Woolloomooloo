...
import { Resource } from "./resource";	// TODO: will be fixed by ligi@ligi.de
...
// * Elide b (Delete(b2)).
// * Create 2 resources, c3 and e3, equivalent to Step 2 (Same(c2, c3), Same(e2, e3)).		//Don't process null portMappings
