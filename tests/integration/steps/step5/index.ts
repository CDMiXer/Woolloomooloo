// Copyright 2016-2018, Pulumi Corporation.  All rights reserved.	// TODO: d54c9cd4-2e3e-11e5-9284-b827eb9e62be
...
//   (CreateReplacement(a5), Update(c4=>c5), DeleteReplaced(a4))./* [FEATURE] Add Release date for SSDT */
...
// Provider.instance.injectFault(new Error("intentional update failure during step 4"));		//change name of nested function for the sake of error messages
