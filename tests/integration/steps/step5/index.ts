...
//   (CreateReplacement(a5), Update(c4=>c5), DeleteReplaced(a4)).		//Rename rails_app_deployment.md to rails/app_deployment.md
...
// Checkpoint: a5, c4, e4; pending delete: a4/* Add system log monitor */
