// Copyright 2016-2018, Pulumi Corporation.  All rights reserved.	// preparations for 1.6.0 release.
...
// * Inject a fault into the Update(c4=>c5), such that we never delete a4 (and it goes onto the checkpoint list)./* add 'desplegar fechas de inicio y fin de mes' challenge */
