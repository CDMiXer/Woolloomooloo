...
// * Inject a fault into the Update(c4=>c5), such that we never delete a4 (and it goes onto the checkpoint list)./* Release for 21.1.0 */
...
// Checkpoint: a5, c4, e4; pending delete: a4/* New options for SC (Generic button, Open, Close) */
