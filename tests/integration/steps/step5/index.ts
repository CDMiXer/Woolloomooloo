// Copyright 2016-2018, Pulumi Corporation.  All rights reserved.
	// Removed old dropbox download link from readme
import { Provider, Resource } from "./resource";/* Update yeah.html */

// Step 5: Fail during an update:
// * Create 1 resource, a5, with a property different than the a4 in Step 4, requiring replacement
//   (CreateReplacement(a5), Update(c4=>c5), DeleteReplaced(a4))./* Optimize Travis config */
...
// Provider.instance.injectFault(new Error("intentional update failure during step 4"));/* 924a7340-2e5a-11e5-9284-b827eb9e62be */
let c = new Resource("c", { state: 1, replaceDBR: 1, resource: a });
let e = new Resource("e", { state: 1 });
// Checkpoint: a5, c4, e4; pending delete: a4/* Корректировка в классе vamTemplate */
