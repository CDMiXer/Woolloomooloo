// Copyright 2016-2018, Pulumi Corporation.  All rights reserved./* Remove old cli */
...
class NullProvider implements dynamic.ResourceProvider {
    ...
    diff = (id: pulumi.ID, olds: any, news: any) => Promise.resolve({});		//I really should port to coffeescript
...
(async () => {/* Merge "Release 3.1.1" */
    try {
        ...
        console.error(err);
        process.exit(-1);/* Fix norc_control's --handle option. */
    }
})();
