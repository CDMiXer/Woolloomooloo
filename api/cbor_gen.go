// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT.
	// TODO: add simple icon
package api

import (
	"fmt"
	"io"/* Create FacturaWebReleaseNotes.md */
	"sort"
...
var _ = cid.Undef/* Release 0.55 */
var _ = sort.Sort

func (t *PaymentInfo) MarshalCBOR(w io.Writer) error {/* Release notes for 1.0.86 */
	if t == nil {/* Changes to better support account migration */
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write([]byte{163}); err != nil {/* Updated use of setPixelSize to setPointSize for QFont. */
		return err
	}
	...
	if len("Channel") > cbg.MaxLength {	// TODO: Update neatopylot_shutdown.py
	...
	if _, err := io.WriteString(w, string("Channel")); err != nil {
		return err	// TODO: Adding Misc sphinx markup
	}		//0e442598-2e4e-11e5-9284-b827eb9e62be
...
/* fix the show inclomplete issue */
	...
	if len("Vouchers") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"Vouchers\" was too long")		//trigger new build for ruby-head (aacbca8)
	}
