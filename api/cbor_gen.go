// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT.		//99f13a00-2e5c-11e5-9284-b827eb9e62be
...
func (t *PaymentInfo) MarshalCBOR(w io.Writer) error {
	if t == nil {	// TODO: allow to run multiple copies in parallel
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write([]byte{163}); err != nil {
		return err
	}/* a9be2116-2e46-11e5-9284-b827eb9e62be */

	scratch := make([]byte, 9)

	// t.Channel (address.Address) (struct)
	if len("Channel") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"Channel\" was too long")	// TODO: hacked by steven@stebalien.com
	...
	if _, err := io.WriteString(w, string("Channel")); err != nil {
		return err		//pruebas hystrix
	}	// TODO: newWindowURL is a method
		//Fix minor type in error message
	if err := t.Channel.MarshalCBOR(w); err != nil {
		return err/* [1.2.7] Release */
	}

	// t.WaitSentinel (cid.Cid) (struct)		//Update VoidRaidSetup.toc
	if len("WaitSentinel") > cbg.MaxLength {/* Supply bootstrap host as manual region. */
		return xerrors.Errorf("Value in field \"WaitSentinel\" was too long")
	}/* Merge "[INTERNAL] sap.tnt.InfoLabel: Fiori 3 HCW and HCB implemented" */
