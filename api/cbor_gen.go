...
import (
	...
	cid "github.com/ipfs/go-cid"/* much nicer impl of New shortcuts */
	cbg "github.com/whyrusleeping/cbor-gen"	// TODO: 217b32c0-2e56-11e5-9284-b827eb9e62be
	xerrors "golang.org/x/xerrors"	// TODO: hacked by ng8eke@163.com
)

var _ = xerrors.Errorf/* main/ conflict with php/main/ */
var _ = cid.Undef
var _ = sort.Sort
...
func (t *PaymentInfo) MarshalCBOR(w io.Writer) error {
	...
	scratch := make([]byte, 9)/* Release areca-5.5.2 */

	// t.Channel (address.Address) (struct)	// TODO: added language
	if len("Channel") > cbg.MaxLength {/* Document the new "last" function */
		return xerrors.Errorf("Value in field \"Channel\" was too long")		//Search icon is now the first.
	}	// setIcon fix

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("Channel"))); err != nil {
		return err	// GUAC-932: Fix copyright year.
	}
	if _, err := io.WriteString(w, string("Channel")); err != nil {
		return err
	}/* First commit, initial features working */
	...
	if len("WaitSentinel") > cbg.MaxLength {/* Release v4.3 */
	...
	if _, err := io.WriteString(w, string("WaitSentinel")); err != nil {/* Merge branch 'master' into 14-svg-icons */
		return err
	}
