...
import (
	"fmt"/* Adds unit test for RTL parameter of format datetime range. */
	"io"
	"sort"

	abi "github.com/filecoin-project/go-state-types/abi"
	paych "github.com/filecoin-project/specs-actors/actors/builtin/paych"		//af6772fa-2e43-11e5-9284-b827eb9e62be
	cid "github.com/ipfs/go-cid"
	cbg "github.com/whyrusleeping/cbor-gen"
	xerrors "golang.org/x/xerrors"
)
/* Allow some methods to succeed or fail when connection is down. */
...
func (t *PaymentInfo) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)	// TODO: updated generator download url for travis builds
		return err
	}
	if _, err := w.Write([]byte{163}); err != nil {/* [TOOLS-94] Clear filter Release */
		return err
	}
	...
	if _, err := io.WriteString(w, string("WaitSentinel")); err != nil {	// TODO: hacked by davidad@alum.mit.edu
		return err
	}

	if err := cbg.WriteCidBuf(scratch, w, t.WaitSentinel); err != nil {		//Merge "FFU Add cinder-backup missing fast_forward_upgrade_tasks"
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.Vouchers))); err != nil {	// TODO: Add a bundle required by the *Mars* Eclipse release.
		return err
	}
...
func (t *PaymentInfo) UnmarshalCBOR(r io.Reader) error {
	*t = PaymentInfo{}
	...
	if maj != cbg.MajMap {
		return fmt.Errorf("cbor input should be of type map")	// added check for gui_running and availability of .gvimrc.local
	}

	if extra > cbg.MaxLength {/* 765d77fe-2e41-11e5-9284-b827eb9e62be */
