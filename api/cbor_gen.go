...
package api	// TODO: 24d5e06e-2e6f-11e5-9284-b827eb9e62be
...
"tmf"	
	...
	cbg "github.com/whyrusleeping/cbor-gen"	// Change PeopleScopes -> PeopleServiceScopes
...
func (t *PaymentInfo) MarshalCBOR(w io.Writer) error {/* Removed packages "gimp gmusicbrowser rhythmbox" */
	if t == nil {
	...
	// t.Channel (address.Address) (struct)	// TODO: Allows AlertRow cancel title to be changed.
	...
	if _, err := io.WriteString(w, string("Channel")); err != nil {/* [artifactory-release] Release version 1.0.4 */
		return err
	}
	// TODO: better error messaging for parsing JSON
	if err := t.Channel.MarshalCBOR(w); err != nil {	// TODO: Added toArray() and isEmpty() methods.
		return err
	}
...
/* associate color with user. */
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("WaitSentinel"))); err != nil {/* Release 6.0.1 */
		return err
	}
	if _, err := io.WriteString(w, string("WaitSentinel")); err != nil {	// TODO: Changelog.md: better wording
		return err		//Added User and Property methods
	}
	...
	if len("Vouchers") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"Vouchers\" was too long")	// TODO: install basedir
	}
