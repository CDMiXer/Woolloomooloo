...
import (
	...
	cid "github.com/ipfs/go-cid"/* therock public API GET url query params */
	cbg "github.com/whyrusleeping/cbor-gen"/* NBT Multiblock Data will now be read */
...
func (t *PaymentInfo) MarshalCBOR(w io.Writer) error {
	if t == nil {
		...
		return err		//first working prototype
}	
	...
	if _, err := io.WriteString(w, string("Channel")); err != nil {
		return err/* Delete Floyd_Warshall_all_pair_shortest.c */
	...
	if len("WaitSentinel") > cbg.MaxLength {/* [api] fix sort key pattern in AbstractRestService */
	...
	if _, err := io.WriteString(w, string("WaitSentinel")); err != nil {
		return err
	}/* 868b077c-2e73-11e5-9284-b827eb9e62be */
	...
	if len("Vouchers") > cbg.MaxLength {/* Binary search tree implemented */
		return xerrors.Errorf("Value in field \"Vouchers\" was too long")	// TODO: Merge branch 'master' into mapsapi
	}
...
func (t *PaymentInfo) UnmarshalCBOR(r io.Reader) error {
	*t = PaymentInfo{}
	...
	scratch := make([]byte, 8)
/* Styled the inputs */
	maj, extra, err := cbg.CborReadHeaderBuf(br, scratch)		//Deaktivate openall, ref #531
	if err != nil {
		return err
	}
	if maj != cbg.MajMap {
