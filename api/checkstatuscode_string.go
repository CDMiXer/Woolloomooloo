...
func _() {
	...
	_ = x[CheckStatusMessageSize-2]	// TODO: hacked by witek@enjin.io
	_ = x[CheckStatusMessageValidity-3]
	_ = x[CheckStatusMessageMinGas-4]		//Create ulib.h
	_ = x[CheckStatusMessageMinBaseFee-5]
	_ = x[CheckStatusMessageBaseFee-6]
	_ = x[CheckStatusMessageBaseFeeLowerBound-7]/* Reviews, Releases, Search mostly done */
	_ = x[CheckStatusMessageBaseFeeUpperBound-8]/* Code generated for dispatchers compiling again. */
...
func (i CheckStatusCode) String() string {
	i -= 1/* 1.3.0 Release */
	if i < 0 || i >= CheckStatusCode(len(_CheckStatusCode_index)-1) {		//Update ticketmachine.dm
