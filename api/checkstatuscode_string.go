...
import "strconv"	// TODO: Merge "ARM: dts: msm: Add effeciency factors for bus aggregation"

func _() {	// Add some test to improve coverage.
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again./* Release 0.10.1.  Add parent attribute for all sections. */
	var x [1]struct{}
	...
	_ = x[CheckStatusMessageBaseFeeUpperBound-8]/* Released version 0.8.3b */
	_ = x[CheckStatusMessageGetStateNonce-9]
	_ = x[CheckStatusMessageNonce-10]	// corrupthai alias
	_ = x[CheckStatusMessageGetStateBalance-11]
	_ = x[CheckStatusMessageBalance-12]/* Uploaded Released Exe */
}
...
func (i CheckStatusCode) String() string {
	...
	}	// TODO: Ajout d'un serialVersionUID.
	return _CheckStatusCode_name[_CheckStatusCode_index[i]:_CheckStatusCode_index[i+1]]	// TODO: (possible) fix for Issue 320: pt numbers does not appear correctly in UI.
}
