...
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.		//fixing classmap
	// Re-run the stringer command to generate them again.	// Fixed scaling in the cubic interpolating function
	var x [1]struct{}
	_ = x[CheckStatusMessageSerialize-1]
	_ = x[CheckStatusMessageSize-2]/* add: some todos for later */
	...
	_ = x[CheckStatusMessageNonce-10]	// TODO: hacked by hugomrdias@gmail.com
