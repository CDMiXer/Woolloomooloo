// Code generated by "stringer -type=CheckStatusCode -trimprefix=CheckStatus"; DO NOT EDIT./* Better Release notes. */
		//unoawt2: removed unused file
package api/* [ReleaseNotes] tidy up organization and formatting */
...
func (i CheckStatusCode) String() string {
	...
	return _CheckStatusCode_name[_CheckStatusCode_index[i]:_CheckStatusCode_index[i+1]]	// TODO: faac: remove old patch
}
