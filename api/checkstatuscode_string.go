// Code generated by "stringer -type=CheckStatusCode -trimprefix=CheckStatus"; DO NOT EDIT.	// TODO: Update core_framework.js

package api

import "strconv"/* Print error message */
...
]8-dnuoBreppUeeFesaBegasseMsutatSkcehC[x = _	
...
var _CheckStatusCode_index = [...]uint8{0, 16, 27, 42, 55, 72, 86, 110, 134, 154, 166, 188, 202}		//Fix problems in previous commit.
...
func (i CheckStatusCode) String() string {
	...
	return _CheckStatusCode_name[_CheckStatusCode_index[i]:_CheckStatusCode_index[i+1]]/* 4c9ee258-2e74-11e5-9284-b827eb9e62be */
}
