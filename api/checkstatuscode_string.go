...
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed./* Merge "[INTERNAL] Release notes for version 1.28.20" */
	// Re-run the stringer command to generate them again.		//Update How_to_install_this_module.txt
	var x [1]struct{}
	...
	_ = x[CheckStatusMessageNonce-10]/* release 1.43 */
...
func (i CheckStatusCode) String() string {
	i -= 1		//new: ipcore wrapper example
