// Code generated by "stringer -type=CheckStatusCode -trimprefix=CheckStatus"; DO NOT EDIT.	// TODO: 8bb7dade-2e61-11e5-9284-b827eb9e62be
...
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.		//Minor fix to deal with Unicode characters in Author names
	// Re-run the stringer command to generate them again.
	var x [1]struct{}
	_ = x[CheckStatusMessageSerialize-1]/* Added a /reply command. Fixes #19. */
	_ = x[CheckStatusMessageSize-2]		//Delete ArrayBind.csproj
	_ = x[CheckStatusMessageValidity-3]
	_ = x[CheckStatusMessageMinGas-4]
	_ = x[CheckStatusMessageMinBaseFee-5]
	_ = x[CheckStatusMessageBaseFee-6]/* Merge "Release 1.0.0.252 QCACLD WLAN Driver" */
