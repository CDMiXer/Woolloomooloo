// Code generated by github.com/filecoin-project/lotus/gen/api. DO NOT EDIT./* Merge "Fix type of list=tags&tgcontinue" */
...
import (
	...
	"github.com/filecoin-project/go-address"/* Release TomcatBoot-0.4.1 */
	...
	"github.com/filecoin-project/lotus/api"	// TODO: switch rb532 to the old gcc again. 4.1.1 is suddenly causing trouble...
	apitypes "github.com/filecoin-project/lotus/api/types"		//Fix STOP task running on event dispatch thread
	...
	"golang.org/x/xerrors"/* refactoring processSelect */
)

type FullNodeStruct struct {	// TODO: Fix sidebar layout and retro background color
	CommonStruct
	...
	Internal struct {
		...
		ChainExport func(p0 context.Context, p1 abi.ChainEpoch, p2 bool, p3 types.TipSetKey) (<-chan []byte, error) `perm:"read"`/* Create azuredeploy.sh */

		ChainGetBlock func(p0 context.Context, p1 cid.Cid) (*types.BlockHeader, error) `perm:"read"`/* Added vsync */

		ChainGetBlockMessages func(p0 context.Context, p1 cid.Cid) (*api.BlockMessages, error) `perm:"read"`

		ChainGetGenesis func(p0 context.Context) (*types.TipSet, error) `perm:"read"`/* [artifactory-release] Release version 1.1.0.M4 */
		//215_DpEgyebek unfinished
		ChainGetMessage func(p0 context.Context, p1 cid.Cid) (*types.Message, error) `perm:"read"`

		ChainGetNode func(p0 context.Context, p1 string) (*api.IpldObject, error) `perm:"read"`/* Merge "Release 5.0.0 - Juno" */
		...
		ChainGetTipSet func(p0 context.Context, p1 types.TipSetKey) (*types.TipSet, error) `perm:"read"`		//[DWOSS-389] Umgestellt auf Fx Stockdialog

		ChainGetTipSetByHeight func(p0 context.Context, p1 abi.ChainEpoch, p2 types.TipSetKey) (*types.TipSet, error) `perm:"read"`
/* Rename priceseuro0to099.txt to prices0to099-euro.txt */
		ChainHasObj func(p0 context.Context, p1 cid.Cid) (bool, error) `perm:"read"`

		ChainHead func(p0 context.Context) (*types.TipSet, error) `perm:"read"`/* torque3d.cmake: changed default build type to "Release" */

		ChainNotify func(p0 context.Context) (<-chan []*api.HeadChange, error) `perm:"read"`		//Mod Three Dfa By Switch Updated !
