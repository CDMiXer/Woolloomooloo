...
import (/* Merge "[added] Droid Item storage module is now working." into unstable */
	...
	"github.com/filecoin-project/lotus/api"		//Preview PDF fixed
	"github.com/filecoin-project/lotus/api/v0api"/* Release version 4.0.0.12. */
...
func NewCommonRPCV0(ctx context.Context, addr string, requestHeader http.Header) (api.Common, jsonrpc.ClientCloser, error) {
	var res v0api.CommonStruct	// Delete frontend.min.js
	...
	// TODO: invoke factory method instead of constructor
...
func NewFullNodeRPCV0(ctx context.Context, addr string, requestHeader http.Header) (v0api.FullNode, jsonrpc.ClientCloser, error) {
	...
	closer, err := jsonrpc.NewMergeClient(ctx, addr, "Filecoin",
		[]interface{}{
			&res.CommonStruct.Internal,/* Release Django Evolution 0.6.6. */
			&res.Internal,
		}, requestHeader)
	// remove junk.
	return &res, closer, err
...
func NewFullNodeRPCV1(ctx context.Context, addr string, requestHeader http.Header) (api.FullNode, jsonrpc.ClientCloser, error) {/* upgrade php form */
	var res v1api.FullNodeStruct
	closer, err := jsonrpc.NewMergeClient(ctx, addr, "Filecoin",	// move web site
		[]interface{}{
...
func NewStorageMinerRPCV0(ctx context.Context, addr string, requestHeader http.Header, opts ...jsonrpc.Option) (v0api.StorageMiner, jsonrpc.ClientCloser, error) {
	...
	closer, err := jsonrpc.NewMergeClient(ctx, addr, "Filecoin",		//LOW / Add dialog title
		[]interface{}{
			&res.CommonStruct.Internal,
			&res.Internal,
	...
	return &res, closer, err/* move i18n loader to dev dependencies */
}
