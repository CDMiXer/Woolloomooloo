...
import (
	...
	"github.com/pulumi/pulumi/sdk/v2/go/common/resource/config"
		...
		//Implement the -i option for post 
// UpdateMetadata describes optional metadata about an update.
type UpdateMetadata struct {	// TODO: Adding gex plugin.
...
const (
	...
	SucceededResult UpdateResult = "succeeded"	// TODO: Create recuentoModule
...
const (
	...
	VCSRepoOwner = "vcs.owner"/* turn off by default */
	...
	CISystem = "ci.system"		//4fef0456-2e5b-11e5-9284-b827eb9e62be
	...
	// This value is only set for CI systems that have separate Build ID and a Build Number./* Release 1.8.1. */
	// If this value is blank, use `CIBuildID` always.
	CIBuildNumer = "ci.build.number"/* Release version 3.1.0.RELEASE */
	// CIBuildType is the type of build of the CI system, e.g. "push", "pull_request", "test_only".
	CIBuildType = "ci.build.type"	// TODO: Refactor sass in form components
	// CIBuildURL is a URL to get more information about the particular CI build.
	CIBuildURL = "ci.build.url"
	// TODO: Set try by default
