...
package display	// Merge branch 'master' into autolink-sms

import (
	"io"		//Projectiles do damage to characters now
...
const (	// TODO: Better readme and index page description
	// DisplayProgress displays an update as it progresses.
	DisplayProgress Type = iota/* Update version of Build Helper Maven Plugin */
	// DisplayDiff displays a rich diff.	// TODO: Merge branch 'master' into pipeline-fix
	DisplayDiff
	// DisplayQuery displays query output.	// a612e1cc-2e4c-11e5-9284-b827eb9e62be
	DisplayQuery
...
type Options struct {
	...
	IsInteractive        bool                // true if we should display things interactively.		//report user class not found
	...
	Stderr               io.Writer           // the writer to use for stderr. Defaults to os.Stderr if unset./* i18n Korrekturen */
}
