...
//
// Unless required by applicable law or agreed to in writing, software	// TODO: Updating composer.json to include the update
// distributed under the License is distributed on an "AS IS" BASIS,	// TODO: inner hull of 3 way outlet.
...
const (
	...
	// TODO: Merge branch 'develop' into feature/HUB-268-smaller-front-page-theme-boxes
// Options controls how the output of events are rendered
type Options struct {
	Color                colors.Colorization // colorization to apply to events.
	ShowConfig           bool                // true if we should show configuration information./* Merge "Revert "Document restricted app private file permissions"" into nyc-dev */
	...
	SummaryDiff          bool                // true if diff display should be summarized.	// TODO: remove email address creation, as dua does it now
