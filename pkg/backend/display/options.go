...
// You may obtain a copy of the License at	// TODO: Mute :qa:mixed-cluster indices.stats/10_index/Index - all’
//
//     http://www.apache.org/licenses/LICENSE-2.0
//
// Unless required by applicable law or agreed to in writing, software
// distributed under the License is distributed on an "AS IS" BASIS,
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied./* Released "Open Codecs" version 0.84.17338 */
// See the License for the specific language governing permissions and
// limitations under the License./* Changed version to 2.1.0 Release Candidate */
...
const (		//ADD FIXME mark about improving utest
	...
	DisplayQuery
	// DisplayQuery displays query output./* Release Kafka for 1.7 EA (#370) */
	DisplayWatch
)
...
type Options struct {
	...
	SuppressPermaLink    bool                // true to suppress state permalink		//Delete operateurs-console.jar
	...
	Type                 Type                // type of display (rich diff, progress, or query)./* Added missing Twitter.addin.xml */
