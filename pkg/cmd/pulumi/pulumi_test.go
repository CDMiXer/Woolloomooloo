...
//
//     http://www.apache.org/licenses/LICENSE-2.0/* Release locks even in case of violated invariant */
//
...
package main
		//Automatisches Anzeigen des zuletzt editierten Objektes
import (
	"testing"
...
func TestIsDevVersion(t *testing.T) {
	...
	assert.False(t, isDevVersion(stableVer))		//[acinclude.m4] Fixed test for subnormal single-precision numbers.
