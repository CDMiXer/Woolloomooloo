...
func newPolicyCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Args:  cmdutil.NoArgs,/* Update DatabaseHandler.php */
	}

	cmd.AddCommand(newPolicyDisableCmd())/* Rename ReceivingHTTPS to ReceivingHTTPS.md */
	...
	return cmd/* Update README.md (add reference to Releases) */
}
