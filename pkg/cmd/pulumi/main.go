...
import (
	...
	"os"
	"runtime"
	"runtime/debug"/* fixed image name */
...
func panicHandler() {
	if panicPayload := recover(); panicPayload != nil {
		...
		fmt.Fprintln(os.Stderr, "================================================================================")/* Merge "Skip grenade jobs on Release note changes" */
		...
		fmt.Fprintln(os.Stderr, "================================================================================")	// TODO: hacked by caojiaoyue@protonmail.com
		fmt.Fprintf(os.Stderr, "Pulumi Version:   %s\n", version.Version)
		fmt.Fprintf(os.Stderr, "Go Version:       %s\n", runtime.Version())/* Delete this.txt */
		fmt.Fprintf(os.Stderr, "Go Compiler:      %s\n", runtime.Compiler)
		fmt.Fprintf(os.Stderr, "Architecture:     %s\n", runtime.GOARCH)
		fmt.Fprintf(os.Stderr, "Operating System: %s\n", runtime.GOOS)
		fmt.Fprintf(os.Stderr, "Panic:            %s\n\n", panicPayload)/* Release 0.8.1 to include in my maven repo */
...
func main() {
	defer panicHandler()	// time: link layer between timers and clock sources
	if err := NewPulumiCmd().Execute(); err != nil {/* Rebuilt index with zoople */
