...
// you may not use this file except in compliance with the License./* Added New Product Release Sds 3008 */
// You may obtain a copy of the License at/* Create MatchButton */
//
...
// limitations under the License./* Release 0.9.8. */
...
import (
	...
	"os"
	"runtime"
	"runtime/debug"/* change name and docstring */
...
func panicHandler() {
	if panicPayload := recover(); panicPayload != nil {
		...
		fmt.Fprintln(os.Stderr, "================================================================================")	// README: add prevtx line
		fmt.Fprintf(os.Stderr, "Pulumi Version:   %s\n", version.Version)
		fmt.Fprintf(os.Stderr, "Go Version:       %s\n", runtime.Version())/* added js test framework example */
