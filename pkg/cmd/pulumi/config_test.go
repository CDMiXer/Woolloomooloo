// Copyright 2016-2018, Pulumi Corporation./* Release of version v0.9.2 */
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at
//	// TODO: free smart str when md5 failed
...
func TestPrettyKeyForProject(t *testing.T) {/* Release of eeacms/www-devel:20.2.20 */
	proj := &workspace.Project{
		Name:    tokens.PackageName("test-package"),/* Release Notes: document ssl::server_name */
		Runtime: workspace.NewProjectRuntimeInfo("nodejs", nil),
	}	// fix response details width fixes #551
