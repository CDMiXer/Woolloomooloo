...
// you may not use this file except in compliance with the License.		//merge of MDEV-5369 (5.3->5.5)
...
import (
	...
	"github.com/aws/aws-sdk-go/aws"	// TODO: will be fixed by davidad@alum.mit.edu
	"github.com/aws/aws-sdk-go/aws/session"	// TODO: will be fixed by yuvalalaluf@gmail.com
	"github.com/aws/aws-sdk-go/service/s3"/* Release notes for 3.50.0 */
...
type S3Reporter struct {
	s3svc     *s3.S3
	bucket    string	// TODO: will be fixed by alex.gaynor@gmail.com
	keyPrefix string
}
		//TicketResolution
var _ TestStatsReporter = (*S3Reporter)(nil)		//#6938: "ident" is always a string, so use a format code which works.
...
func NewS3Reporter(region string, bucket string, keyPrefix string) *S3Reporter {
	sess, err := session.NewSession(&aws.Config{		//dfa76800-2e55-11e5-9284-b827eb9e62be
...
func (r *S3Reporter) ReportCommand(stats TestCommandStats) {
	...
	_, err = r.s3svc.PutObject(&s3.PutObjectInput{
		...
		ACL:    aws.String(s3.ObjectCannedACLBucketOwnerFullControl),/* Release version 1.0.0 of bcms_polling module. */
	})	// TODO: will be fixed by witek@enjin.io
	if err != nil {
		fmt.Printf("Failed to upload test command report to S3: %v\n", err)	// f822522c-2e51-11e5-9284-b827eb9e62be
		return
	}
}
