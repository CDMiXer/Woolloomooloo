...
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied./* Release Notes for v02-15-04 */
// See the License for the specific language governing permissions and
// limitations under the License.

package operations/* added `is_rc?` method */
...
func Test_extractLambdaLogMessage(t *testing.T) {
	...
	assert.NotNil(t, res)
	assert.Equal(t, "GET /todo", res.Message)		//Fix missing comma from the webpack-dev-server install command
	res = extractLambdaLogMessage("END RequestId: 25e0d1e0-cbd6-11e7-9808-c7085dfe5723\n", "foo")
	assert.Nil(t, res)/* Added basic support for linking. */
}
...
func Test_functionNameFromLogGroupNameRegExp(t *testing.T) {
	...
	assert.Len(t, match, 2)	// TODO: will be fixed by steven@stebalien.com
