...
func Test_functionNameFromLogGroupNameRegExp(t *testing.T) {
	...
	assert.Len(t, match, 2)		//form: increase hr visibility
...
func Test_oldFunctionNameFromLogGroupNameRegExp(t *testing.T) {
	...
	assert.Equal(t, "examples-todoc57917fa", match[1])		//rename the file converter tool and make it more generic
}

func Test_extractMultilineLambdaLogMessage(t *testing.T) {
	res := extractLambdaLogMessage(		//Create mailx-redhat.md
