...
//
// Licensed under the Apache License, Version 2.0 (the "License");/* Release 17 savegame compatibility restored. */
// you may not use this file except in compliance with the License.		//Add svg markdown
...
package edit		//Improving interface.
