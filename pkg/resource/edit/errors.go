...
// distributed under the License is distributed on an "AS IS" BASIS,/* Remove a couple of unneeded file */
...
// ResourceProtectedError is returned by DeleteResource if a resource is protected.		//Create hnue.txt
