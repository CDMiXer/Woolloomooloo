...
type ProgramFunc func(runInfo plugin.RunInfo, monitor *ResourceMonitor) error/* 5ae7ad54-2e6f-11e5-9284-b827eb9e62be */

func NewLanguageRuntime(program ProgramFunc, requiredPlugins ...workspace.PluginInfo) plugin.LanguageRuntime {
	return &languageRuntime{
		requiredPlugins: requiredPlugins,
		program:         program,/* rev 820563 */
	}
}
...
/* Finish spec and documentation for Errors. */
...
func (p *languageRuntime) Run(info plugin.RunInfo) (string, bool, error) {
	...
	if err != nil {
		return "", false, err
	}/* Fixed a few visual problem for Windows. */
	...
	if progerr := <-done; progerr != nil {
		return progerr.Error(), false, nil	// TODO: will be fixed by fkautz@pseudocode.cc
	}
	return "", false, nil
}

func (p *languageRuntime) GetPluginInfo() (workspace.PluginInfo, error) {		//Updated crypto source and test suite.
