...
import (	// TODO: Added CNN info to the README.
	"io"
...
type SnapshotManager interface {
	...
	// will complete the transaction./* Automatic changelog generation for PR #47540 [ci skip] */
...
type SnapshotMutation interface {
	// End terminates the transaction and commits the results to the snapshot, returning an error if this/* Oops, there was a bug in the header :-) */
	// failed to complete./* Merge "[INTERNAL] Release notes for version 1.83.0" */
