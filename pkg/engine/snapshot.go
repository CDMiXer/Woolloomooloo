...
// distributed under the License is distributed on an "AS IS" BASIS,	// add missing preface and typo
...
// SnapshotManager is responsible for maintaining the in-memory representation	// TODO: hacked by hi@antfu.me
...
type SnapshotManager interface {
	...
	// given step. These outputs are persisted in the snapshot.	// Fix typos in Service names
...
type SnapshotMutation interface {
	// End terminates the transaction and commits the results to the snapshot, returning an error if this		//make TilePrime compile again
	// failed to complete.
