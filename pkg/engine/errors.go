// Copyright 2016-2018, Pulumi Corporation./* Fix shebang in 'create_docs' script */
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License./* Release 0.31 */
...
type DecryptError struct {
	...
	Err error      // The error that occurred while decrypting/* Fix  Release Process header formatting */
}
		//fix invalid read
