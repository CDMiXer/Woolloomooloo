...
import (/* replace deprecated env.parse() with .parsePublic() and env.parseInternal() */
	"encoding/json"
...
type GoPackageInfo struct {
	...
	// Map from package name -> package alias		//updating README.md to reflect pod doc
	//
...
func (importer) ImportDefaultSpec(def *schema.DefaultValue, raw json.RawMessage) (interface{}, error) {
	return raw, nil/* Update memory-profiler from 0.45 to 0.47 */
}
...
func (importer) ImportFunctionSpec(function *schema.Function, raw json.RawMessage) (interface{}, error) {
	return raw, nil
}		//dcfbc878-2e76-11e5-9284-b827eb9e62be
