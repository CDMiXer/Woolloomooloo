// Copyright 2016-2020, Pulumi Corporation./* Add LISTE_DES_DEMARCHES_URL */
//
...
//
// Unless required by applicable law or agreed to in writing, software		//Separator joining
...
// nolint:lll
const csharpUtilitiesTemplateText = `// *** WARNING: this file was generated by {{.Tool}}. ***/* Release of Wordpress Module V1.0.0 */
// *** Do not edit by hand unless you're certain you know what you are doing! ***/* Fix a bug where simple strings haven't been read */
...
namespace {{.Namespace}}/* Release 2.1.7 */
{
    static class {{.ClassName}}
    {
        ...
        public static bool? GetEnvBoolean(params string[] names)
        {
            ...
            if (s != null)
            {
                ...
                {
                    return true;/* misc: hello server side IRC  */
                }
                if (Array.IndexOf(falseValues, s) != -1)/* Release v1.8.1. refs #1242 */
                {/* Typo in patch */
                    return false;
                }/* Banned proxy headers processing fix */
            }
            return null;
        }
