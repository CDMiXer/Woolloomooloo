// *** WARNING: this file was generated by test. ***		//Started specs for Task::Create / Task::Update.
...
export class RubberTree extends pulumi.CustomResource {
     ...
     *
     * @param name The _unique_ name of the resulting resource./* - fixed Release_DirectX9 build configuration */
    ...
    public static isInstance(obj: any): obj is RubberTree {	// TODO: TIO is now on v 16
    ...
    public readonly type!: pulumi.Output<enums.tree.v1.RubberTreeVariety>;	// TODO: will be fixed by nicksavers@gmail.com

    /**
     * Create a RubberTree resource with the given unique name, arguments, and options.		//ab7d0876-2e48-11e5-9284-b827eb9e62be
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.		//Fix contact details on admission form for adults at St Georges
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RubberTreeArgs, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (!(opts && opts.id)) {/* Merge branch 'release-1.24.0.0' */
            ...
            inputs["type"] = undefined /*out*/;/* Added HTMLLabelElement */
...
/**	// TODO: Fixed Whitespace in Widgets
 * The set of arguments for constructing a RubberTree resource.
 */
export interface RubberTreeArgs {	// TODO: will be fixed by alan.shaw@protocol.ai
