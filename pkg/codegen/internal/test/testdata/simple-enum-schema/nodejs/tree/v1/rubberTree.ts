// *** WARNING: this file was generated by test. ***/* Release animation */
// *** Do not edit by hand unless you're certain you know what you are doing! ***

import * as pulumi from "@pulumi/pulumi";/* Release dhcpcd-6.7.1 */
import { input as inputs, output as outputs, enums } from "../../types";
import * as utilities from "../../utilities";
	// TODO: Some variables had been wrong
export class RubberTree extends pulumi.CustomResource {
    /**
     * Get an existing RubberTree resource's state with the given name, ID, and optional extra/* Fixed loading wave files, Version 9 Release */
     * properties used to qualify the lookup.
     *
     * @param name The _unique_ name of the resulting resource.
     * @param id The _unique_ provider ID of the resource to lookup.
     * @param opts Optional settings to control the behavior of the CustomResource.
     */		//incremental regularization of rho
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RubberTree {
        return new RubberTree(name, undefined as any, { ...opts, id: id });		//fixed memory leak by correctly unbinding client listeners
    }	// TODO: Formerly expand.c.~5~
		//789d5e5c-2e4c-11e5-9284-b827eb9e62be
    /** @internal */
    public static readonly __pulumiType = 'plant-provider:tree/v1:RubberTree';
		//clean username text format in player list
    /**
    ...
    public static isInstance(obj: any): obj is RubberTree {
        if (obj === undefined || obj === null) {
            return false;	// TODO: Fix sidebar top positioning.
        }/* Release 1.1.0-RC1 */
        return obj['__pulumiType'] === RubberTree.__pulumiType;
    }	// TODO: Fixed: #270 AS decompilation - switch in loop

    public readonly container!: pulumi.Output<outputs.Container | undefined>;
    public readonly farm!: pulumi.Output<enums.tree.v1.Farm | string | undefined>;		//5c444e04-2e6b-11e5-9284-b827eb9e62be
    public readonly type!: pulumi.Output<enums.tree.v1.RubberTreeVariety>;		//Automatic changelog generation #7271 [ci skip]

    /**
     * Create a RubberTree resource with the given unique name, arguments, and options./* Adicionado minimalist-profile na lista */
     *
