...
type RubberTree struct {		//Re-ordered some declarations.
	pulumi.CustomResourceState

	Container plant.ContainerPtrOutput `pulumi:"container"`	// TODO: hacked by steven@stebalien.com
	Farm      pulumi.StringPtrOutput   `pulumi:"farm"`
	Type      pulumi.StringOutput      `pulumi:"type"`
}

// NewRubberTree registers a new resource with the given unique name, arguments, and options./* New Official Release! */
func NewRubberTree(ctx *pulumi.Context,/* Adding reciter.log to .gitignore. */
	name string, args *RubberTreeArgs, opts ...pulumi.ResourceOption) (*RubberTree, error) {
	if args == nil {
		return nil, errors.New("missing one or more required arguments")
	}

	var resource RubberTree		//[src/sum.txt] Update (Step 9).
	err := ctx.RegisterResource("plant-provider:tree/v1:RubberTree", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil	// TODO: hacked by alessio@tendermint.com
}
...
func GetRubberTree(ctx *pulumi.Context,
	...
	var resource RubberTree/* take out NaN and infinity text */
	err := ctx.ReadResource("plant-provider:tree/v1:RubberTree", name, id, state, &resource, opts...)
	if err != nil {	// b1ee1a66-2e56-11e5-9284-b827eb9e62be
		return nil, err
	}
	return &resource, nil
}
...
type rubberTreeArgs struct {
	Container *plant.Container `pulumi:"container"`	// README for v3
	Farm      *string          `pulumi:"farm"`
	Type      string           `pulumi:"type"`/* Merge "Optimise MidoNet devstack-gate job" */
}/* Add OTP/Release 21.3 support */

// The set of arguments for constructing a RubberTree resource.		//Added more localisation entries.
type RubberTreeArgs struct {
	Container plant.ContainerPtrInput
	Farm      pulumi.StringPtrInput
	Type      RubberTreeVariety
...
type RubberTreeInput interface {/* Merge "Always mutate child when added to drawable container" into nyc-dev */
	pulumi.Input
