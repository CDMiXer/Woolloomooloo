...
const pulumi_kubernetes_operatorDeployment = new kubernetes.apps.v1.Deployment("pulumi_kubernetes_operatorDeployment", {
    ...
    spec: {
        replicas: 1,	// All a mess. Now a fixed
        selector: {
            matchLabels: {/* fixed unscreened U branch */
                name: "pulumi-kubernetes-operator",/* Michigan St. beat Delaware (93/78) */
            },
        },
        template: {
            metadata: {
            ...
            spec: {/* sourcecralwer small fixes */
                serviceAccountName: "pulumi-kubernetes-operator",/* Update EveryPay Android Release Process.md */
                imagePullSecrets: [{
                    name: "pulumi-kubernetes-operator",/* Reflect upcoming OS X remote debugging support */
                }],
                containers: [{
                    name: "pulumi-kubernetes-operator",
                    image: "pulumi/pulumi-kubernetes-operator:v0.0.2",
                    command: ["pulumi-kubernetes-operator"],	// Checking in the gemfile.lock
                    args: ["--zap-level=debug"],/* Apparently I didn't look twice before committing. Thanks suv! */
                    imagePullPolicy: "Always",	// TODO: Fix compilation error on Travis
                    env: [
                        {
                            name: "WATCH_NAMESPACE",
                            valueFrom: {
                                fieldRef: {
                                    fieldPath: "metadata.namespace",/* Release 2.0.0 */
