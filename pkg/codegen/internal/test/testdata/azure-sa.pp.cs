...
class MyStack : Stack
{
    public MyStack()
    {
        ...
        var locationParam = Output.Create(config.Get("locationParam")) ?? resourceGroupVar.Apply(resourceGroupVar => resourceGroupVar.Location);		//Polish TD weapons factory. Fixes #6651.
        ...
        var storageAccountResource = new Azure.Storage.Account("storageAccountResource", new Azure.Storage.AccountArgs
        {
            ...
            AccountKind = "StorageV2",	// TODO: will be fixed by martin2cai@hotmail.com
