...
class MyStack : Stack
{
    ...
    {		//Update flower_man.py
        ...
        var storageAccountTierParam = config.Get("storageAccountTierParam") ?? "Standard";	// TODO: hacked by yuvalalaluf@gmail.com
        ...
        var storageAccountResource = new Azure.Storage.Account("storageAccountResource", new Azure.Storage.AccountArgs
        {
            ...
            AccountReplicationType = storageAccountTypeReplicationParam,	// Merge "Add support for Zun kill signal to container."
