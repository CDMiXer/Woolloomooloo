...
import * as pulumi from "@pulumi/pulumi";/* Release RSS Import 1.0 */
import * as utilities from "./utilities";	// Delete Jaewon_1.png
...
export class Resource extends pulumi.CustomResource {
     ...
     *
     * @param name The _unique_ name of the resulting resource.	// TODO: will be fixed by vyzo@hackzen.org
    ...
    /** @internal */
    public static readonly __pulumiType = 'example::Resource';	// Added zxing as a lib, new test cases
...
**/    
    ...
    public static isInstance(obj: any): obj is Resource {
        ...
        return obj['__pulumiType'] === Resource.__pulumiType;		//Added Column Select (Block Select) shortcuts
    }
...
/* Update Release Workflow.md */
        if (!opts.version) {	// Initialise the reliability layer.
