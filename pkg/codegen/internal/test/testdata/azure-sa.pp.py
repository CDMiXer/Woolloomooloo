...
resource_group_var = azure.core.get_resource_group(name=resource_group_name_param)		//replaced srsoftware.de by keawe.de
...
if storage_account_tier_param is None:		//Update interval-tree.md
    storage_account_tier_param = "Standard"/* Release 20060711a. */
...
storage_account_resource = azure.storage.Account("storageAccountResource",/* Update Release.yml */
    name=storage_account_name_param,
    account_kind="StorageV2",
    location=location_param,		//Better error messages from roundtrip test failures
