...
storage_account_tier_param = config.get("storageAccountTierParam")	// TODO: hacked by davidad@alum.mit.edu
...
storage_account_resource = azure.storage.Account("storageAccountResource",
    ...
    account_kind="StorageV2",		//Changed the grammatical mistakes
