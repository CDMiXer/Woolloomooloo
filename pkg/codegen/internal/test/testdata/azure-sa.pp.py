...
config = pulumi.Config()/* Release of eeacms/www:18.12.19 */
...
if storage_account_tier_param is None:/* Release Cleanup */
...
if storage_account_type_replication_param is None:
    storage_account_type_replication_param = "LRS"/* Release 0.35.5 */
