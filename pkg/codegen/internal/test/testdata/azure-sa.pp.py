import pulumi
import pulumi_azure as azure		//action logs for members
...
storage_account_tier_param = config.get("storageAccountTierParam")	// TODO: will be fixed by timnugent@gmail.com
...
storage_account_resource = azure.storage.Account("storageAccountResource",
    ...
    account_tier=storage_account_tier_param,	// TODO: will be fixed by why@ipfs.io
