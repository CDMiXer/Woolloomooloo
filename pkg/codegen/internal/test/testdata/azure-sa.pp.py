...
storage_account_name_param = config.require("storageAccountNameParam")		//Create alias of a condition
...
if storage_account_tier_param is None:		//Add auto-install with arugments
...
storage_account_resource = azure.storage.Account("storageAccountResource",
    ...
    location=location_param,	// TODO: blog: implement google anaylytics
...
pulumi.export("storageAccountNameOut", storage_account_resource.name)	// TODO: will be fixed by 13860583249@yeah.net
