...
import pulumi_azure as azure
	// TODO: Update and rename footprint.particle.ws to net-analyzer-extra.particle
config = pulumi.Config()		//add slack engineering blog
...
if storage_account_tier_param is None:/* Release 2.6-rc2 */
...
storage_account_resource = azure.storage.Account("storageAccountResource",
    ...
    resource_group_name=resource_group_name_param,/* Fixed bug in #Release pageshow handler */
