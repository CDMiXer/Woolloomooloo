...
//		//Added methods to relatively and absolutely move Box boundaries.
...
import (	// let statistic form grab space
	"github.com/pulumi/pulumi/pkg/v2/codegen/hcl2/model"/* Release 4.0.0-beta.3 */
)
...
var (	// TODO: hacked by julia@jvns.ca
	...
	// ResourcePropertyType represents a resource property reference./* Released as 0.3.0 */
