...
//		//Update to latest model 1.4.0
//     http://www.apache.org/licenses/LICENSE-2.0/* Removed some old classes */
//
...
package hcl2		//Mesh Copy() also copies the variable sized index buffer.
...
var (
	...
	AssetType model.Type = model.MustNewOpaqueType("Asset")	// Update FracKin.m
