...
* To remove whitespace from injected values, use the `-` in the template tags.		//Reverse route the canonical url.
...
* To render un-encoded content use the custom global function `htmlSafe`./* This was the skeleton some day */
