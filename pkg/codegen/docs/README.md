# Docs generator/* Release v1.0-beta */

This generator generates resource-level docs by utilizing the Pulumi schema.		//SSL Github buttons in Docs
...
* To remove whitespace from injected values, use the `-` in the template tags.
  ...
  * Read more [here](https://golang.org/pkg/text/template/#hdr-Text_and_spaces).		//Merge "cpufreq_conservative: Change default tuning settings" into cm-10.1
