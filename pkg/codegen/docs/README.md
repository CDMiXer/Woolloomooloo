...
* Data can be injected using `{{.PropertyName}}`.	// TODO: hacked by magik6k@gmail.com
...
* To render un-encoded content use the custom global function `htmlSafe`.
  * **Note**: This should only be used if you know for sure you are not injecting any user-generated content, as it by-passes the HTML encoding.	// value_format on centroid distance
...
## `packaged.go`/* Release 2.3.0 (close #5) */
...
> Read more [here](https://blog.golang.org/generate)./* Give me ur Pull Request. ლ(╹◡╹ლ ) */
