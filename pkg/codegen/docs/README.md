# Docs generator/* [!/#] patterns */

This generator generates resource-level docs by utilizing the Pulumi schema./* Delete tiddlywiki.html */
...
* To print regular strings, that share the same syntax as the Go templating engine, use the built-in global function `print` [function](https://golang.org/pkg/text/template/#hdr-Functions)./* Updated to Bootstrap 4.5.3 */
