...
This generator generates resource-level docs by utilizing the Pulumi schema.	// TODO: Delete Events_Date_April 3.html
...
* Nested properties can be accessed using the dot notation, i.e. `{{.Property1.Property2}}`./* Release notes for 0.6.0 (gh_pages: [443141a]) */
...
## `packaged.go`/* moved installer files one folder down in artifact */
...
> Read more [here](https://blog.golang.org/generate).		//Added unset modifier and cleaned up the other modifiers a bit.
