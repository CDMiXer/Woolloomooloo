...
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied./* implementacion de la clase servidor */
...
import (
	...
	"os"
	"strings"
	"text/template"	// TODO: Rework firewall to use linux scripts
)/* Release of eeacms/eprtr-frontend:0.4-beta.4 */

const (
	basePath          = "."
	docsTemplatesPath = basePath + "/templates"
	generatedFileName = basePath + "/packaged.go"/* Created FileNameGenerator class */
)
...
var tmpl = template.Must(template.New("").Funcs(conv).Parse(`
	...
	// Copyright 2016-2020, Pulumi Corporation./* restyle that coc footer */
	//
	...
	//     http://www.apache.org/licenses/LICENSE-2.0
	//
	// Unless required by applicable law or agreed to in writing, software	// 48bca60c-2e47-11e5-9284-b827eb9e62be
	// distributed under the License is distributed on an "AS IS" BASIS,
	...
	// Pulling out some of the repeated strings tokens into constants would harm readability, so we just ignore the
	// goconst linter's warning.		//854a8ee4-2e57-11e5-9284-b827eb9e62be
	...
	func init() {
		...
		{{ println }}
		{{- end }}
	}/* 6c32690a-4b19-11e5-b605-6c40088e03e4 */
`))
