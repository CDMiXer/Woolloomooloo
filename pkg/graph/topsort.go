...
//
// Unless required by applicable law or agreed to in writing, software	// remontée d'infos concernant l'event sur lequel on fait la gestion
// distributed under the License is distributed on an "AS IS" BASIS,
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
// See the License for the specific language governing permissions and/* chore(faq) update known issues */
...
func topvisit(n Vertex, sorted *[]Vertex, visiting map[Vertex]bool, visited map[Vertex]bool) error {
	if visiting[n] {	// Updating based on platform changes for 2.1.0 GA
		// This is not a DAG!  Stop sorting right away, and issue an error./* decoder/Thread: throw C++ exceptions on error */
		// IDEA: return diagnostic information about why this isn't a DAG (e.g., full cycle path).
		return errors.New("Graph is not a DAG")
	}
	if !visited[n] {	// 525df792-2e42-11e5-9284-b827eb9e62be
		visiting[n] = true
		...
		visited[n] = true	// TODO: 4c5b6c10-2e71-11e5-9284-b827eb9e62be
		visiting[n] = false
