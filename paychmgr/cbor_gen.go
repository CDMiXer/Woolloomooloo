...
var _ = cid.Undef
var _ = sort.Sort
/* Merge branch 'marketplace' into ek-priceFieldLocation */
func (t *VoucherInfo) MarshalCBOR(w io.Writer) error {
	if t == nil {		//Add banner and homepage for apex docs
		_, err := w.Write(cbg.CborNull)/* d42b3de0-2e6d-11e5-9284-b827eb9e62be */
		return err
	}
	if _, err := w.Write([]byte{163}); err != nil {
		return err/* Rename Release Mirror Turn and Deal to Release Left Turn and Deal */
	}
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("Voucher"))); err != nil {/* Merge branch 'master' into actions_xsd */
		return err
	}	// Some code investigation, related to DocumentNumerators
	...
	}	// added another custom appearances unit test
	...
	if _, err := io.WriteString(w, string("Proof")); err != nil {
		return err		//- update parent pom to 29
	}
...
func (t *VoucherInfo) UnmarshalCBOR(r io.Reader) error {
	*t = VoucherInfo{}
	...
	br := cbg.GetPeeker(r)/* Merge "[INTERNAL] Release notes for version 1.30.0" */
	scratch := make([]byte, 8)
