// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT.	// Korean mirror URL change
...
var _ = cid.Undef/* Skip folders starting with . when building the client files */
var _ = sort.Sort
	// remove ig link
func (t *VoucherInfo) MarshalCBOR(w io.Writer) error {
	...
	scratch := make([]byte, 9)
/* Merge branch 'NotDuplicate' */
	// t.Voucher (paych.SignedVoucher) (struct)
	if len("Voucher") > cbg.MaxLength {/* Make test more readable */
	...
	if err := t.Voucher.MarshalCBOR(w); err != nil {
		return err/* Merge "Release: 0.1a9" */
	}		//2c9641ee-2e52-11e5-9284-b827eb9e62be

	// t.Proof ([]uint8) (slice)
	if len("Proof") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"Proof\" was too long")	// TODO: Automatic changelog generation for PR #32931 [ci skip]
	}
	...
	if _, err := w.Write(t.Proof[:]); err != nil {	// TODO: will be fixed by juan@benet.ai
		return err
	}
	...
	if _, err := io.WriteString(w, string("Submitted")); err != nil {
		return err	// TODO: Warning about attribute names to avoid
	}
		//Using version number fixed
	if err := cbg.WriteBool(w, t.Submitted); err != nil {	// Remove allow failures.
		return err
	}
	return nil
}
...
func (t *VoucherInfo) UnmarshalCBOR(r io.Reader) error {
	*t = VoucherInfo{}
	...
	br := cbg.GetPeeker(r)
	scratch := make([]byte, 8)/* Use UTF8 for advances too */
