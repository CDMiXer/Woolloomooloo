...
package paychmgr	// TODO: hacked by ng8eke@163.com
...
func (t *VoucherInfo) MarshalCBOR(w io.Writer) error {
	...
	if _, err := w.Write([]byte{163}); err != nil {
		return err
	}	// TODO: OPT: support for long IDs in hierarchies; ENTITY_ID now defaults to long
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("Voucher"))); err != nil {/* modified customTests to new syntax */
		return err
	}
	...
	if len(t.Proof) > cbg.ByteArrayMaxLen {/* Release V0.0.3.3 */
...
/* 1.9.7 Release Package */
	...
	return nil/* Adding the core NotificationSpeeding webhook model */
}/* Released 0.0.16 */
...
/* add some message ids */
	br := cbg.GetPeeker(r)
	scratch := make([]byte, 8)/* Released version 1.9. */
