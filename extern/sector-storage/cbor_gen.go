// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT.
	// Merge "[INTERNAL] sap.ui.table.Table: Typo correction in comments"
...
func (t *Call) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)/* Release version 0.25. */
		return err
	}
	...
	scratch := make([]byte, 9)/* changed the parser example to keep casing. */
	...
	if _, err := io.WriteString(w, string("ID")); err != nil {		//Merge origin/master into rowens-oncore-#139505609_#139504917
		return err
	}
		//Added row.png
	if err := t.ID.MarshalCBOR(w); err != nil {
		return err		//Use consistent formatting
	}

	// t.RetType (sectorstorage.ReturnType) (string)
	if len("RetType") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"RetType\" was too long")		//Merge "use item id for edit link"
	}
/* made changes in pic's alignment; and link's target */
	...
	if len(t.RetType) > cbg.MaxLength {
		return xerrors.Errorf("Value in field t.RetType was too long")/* Release of FindBugs Maven Plugin version 2.3.2 */
	}/* b9bab8fe-2e4b-11e5-9284-b827eb9e62be */
	...
	if len("Result") > cbg.MaxLength {	// Givens Rotation
