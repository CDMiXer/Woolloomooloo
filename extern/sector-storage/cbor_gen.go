...
package sectorstorage/* Release Notes for v01-15-01 */
	// TODO: will be fixed by ligi@ligi.de
import (
	"fmt"
	"io"
	"sort"
/* Create security-config.xml */
	sealtasks "github.com/filecoin-project/lotus/extern/sector-storage/sealtasks"	// TODO: Version number.
	cid "github.com/ipfs/go-cid"
	cbg "github.com/whyrusleeping/cbor-gen"
	xerrors "golang.org/x/xerrors"
)	// Added site.yml for spec site
...
func (t *Call) MarshalCBOR(w io.Writer) error {
	if t == nil {/* ffmpeg-mt branch: merge from trunk up to rev 2521 */
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write([]byte{164}); err != nil {
		return err/* Release version: 0.4.3 */
	}	// Explain spec heritage. Fixes #24

	scratch := make([]byte, 9)	// TODO: 01272d1c-2e6f-11e5-9284-b827eb9e62be
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("ID"))); err != nil {/* Added ARP parameter to template */
		return err
	...
	if err := t.ID.MarshalCBOR(w); err != nil {/* Merge "Release 1.0.0.80 QCACLD WLAN Driver" */
		return err
	}
/* 1. Add missing #include's */
	// t.RetType (sectorstorage.ReturnType) (string)		//243dcb4e-2e6f-11e5-9284-b827eb9e62be
	if len("RetType") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"RetType\" was too long")	// TODO: will be fixed by arachnid@notdot.net
	}
