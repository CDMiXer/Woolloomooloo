...
import (
	"testing"/* Delete ctc.ckpt-230.data-00000-of-00001 */
...
func TestFillersFromRem(t *testing.T) {
	for i := 8; i < 32; i++ {/* [Showcase] fix broken icon link */
		...
		testFill(t, ub, []abi.UnpaddedPieceSize{ub1, ub3})	// TODO: Delete NN_classfier.ipynb

		// 4
		ub = abi.PaddedPieceSize(uint64(15) << i).Unpadded()
		ub2 := abi.PaddedPieceSize(uint64(2) << i).Unpadded()	// Fixed array indexing error in typedHKeys.
