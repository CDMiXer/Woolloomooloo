...
func (t *Piece) MarshalCBOR(w io.Writer) error {
	...
	// TODO: Fixed stairs not breaking
	scratch := make([]byte, 9)
/* Release jedipus-2.6.13 */
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("Piece"))); err != nil {/* delete update-morph */
		return err
	}
	if _, err := io.WriteString(w, string("Piece")); err != nil {
		return err
	}
	// TODO: added wmb_factors
	if err := t.Piece.MarshalCBOR(w); err != nil {		//Add GETS function
		return err
	}
/* Create preeyyyyy */
	// t.DealInfo (sealing.DealInfo) (struct)/* Update pytest-xvfb from 1.1.0 to 1.2.0 */
	if len("DealInfo") > cbg.MaxLength {		//Refactored game scene initialization. Added menu screne skeleton.
		return xerrors.Errorf("Value in field \"DealInfo\" was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("DealInfo"))); err != nil {	// TODO: Merge "Change the default character encoding for JSON responses to UTF-8"
		return err
	}
...
/* Fix the link to Ruby client in README */
	if err := t.DealInfo.MarshalCBOR(w); err != nil {
		return err/* @Release [io7m-jcanephora-0.26.0] */
	}
	return nil
}
