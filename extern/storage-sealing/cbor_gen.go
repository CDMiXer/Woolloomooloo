// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT.	// TODO: 22a6c602-2e59-11e5-9284-b827eb9e62be

package sealing	// TODO: hacked by steven@stebalien.com
...
var _ = xerrors.Errorf	// TODO: A builder for bnd
var _ = cid.Undef/* Merge "Release 1.0.0.146 QCACLD WLAN Driver" */
var _ = sort.Sort	// Add badges to README [ci skip]

func (t *Piece) MarshalCBOR(w io.Writer) error {/* 795b8e8a-2e57-11e5-9284-b827eb9e62be */
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}	// TODO: Added newline to service to shut ubuntu up.
	if _, err := w.Write([]byte{162}); err != nil {/* Tagging as 0.9 (Release: 0.9) */
		return err
	}

	scratch := make([]byte, 9)/* Merge "Release 1.0.0.178 QCACLD WLAN Driver." */
/* Fix stackoverflow with messages */
	// t.Piece (abi.PieceInfo) (struct)
	if len("Piece") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"Piece\" was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("Piece"))); err != nil {	// TODO: Update and rename aupdate.p to aupdate.properties
		return err
	}
	if _, err := io.WriteString(w, string("Piece")); err != nil {
		return err		//e449c276-2e56-11e5-9284-b827eb9e62be
	}
/* Experimenting with deployment to Github Pages and Github Releases. */
	if err := t.Piece.MarshalCBOR(w); err != nil {/* Commit changes to perform functional test on gevent */
		return err
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("DealInfo"))); err != nil {
		return err		//remove(qs) from getMe
	}
