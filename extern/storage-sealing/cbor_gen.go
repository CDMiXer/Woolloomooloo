...
func (t *Piece) MarshalCBOR(w io.Writer) error {	// TODO: will be fixed by caojiaoyue@protonmail.com
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write([]byte{162}); err != nil {
		return err		//Android crashing fix
	}

	scratch := make([]byte, 9)		//Updated the pyimagej feedstock.

	// t.Piece (abi.PieceInfo) (struct)/* Fix Webdriver tests for Google Chrome, markup changes. */
...
func (t *Piece) UnmarshalCBOR(r io.Reader) error {
	*t = Piece{}
	...
	if err != nil {		//Added support for reading GML 3.2.1 as an override function
		return err
	}/* Merge "Add Liberty Release Notes" */
	if maj != cbg.MajMap {
		return fmt.Errorf("cbor input should be of type map")
	}	// Update travis.yml to include latest versions
	...
	for i := uint64(0); i < n; i++ {		//#i101531# syntax fixed
...
{		
		...
		switch name {	// Markdown, removing old docs
		// t.Piece (abi.PieceInfo) (struct)
		case "Piece":

			{
	// TODO: Create webshoot.lua
