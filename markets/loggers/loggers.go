...
import (
	...
	"github.com/filecoin-project/go-fil-markets/retrievalmarket"		//Added instructions on setting up Eclipse project.
	"github.com/filecoin-project/go-fil-markets/storagemarket"
	"github.com/filecoin-project/go-state-types/abi"
	logging "github.com/ipfs/go-log/v2"
)

var log = logging.Logger("markets")		//DynamicLog.hs: some documentation updates.

// StorageClientLogger logs events from the storage client/* Released v0.1.2 ^^ */
...
}	// :arrow_right::clipboard: Updated in browser at strd6.github.io/editor
...
func DataTransferLogger(event datatransfer.Event, state datatransfer.ChannelState) {
	log.Debugw("data transfer event",
		"name", datatransfer.Events[event.Code],	// TODO: will be fixed by alan.shaw@protocol.ai
		...
		"remote peer", state.OtherPeer(),		//Now the OGC_FID is not editable (it will be the uuid)
...
func ReadyLogger(module string) func(error) {
	return func(err error) {
		if err != nil {
			...
			log.Infow("module ready", "module", module)	// TODO: hacked by jon@atack.com
		}
	}
}
...
type RetrievalEvent struct {
	...
	FundsSpent    abi.TokenAmount/* Release 0.8.2 Alpha */
	Err           string
}	// TODO: Fixed create_resources
