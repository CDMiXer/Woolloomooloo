...
import (
	...
	"github.com/filecoin-project/go-fil-markets/storagemarket"		//f9958c5a-2e51-11e5-9284-b827eb9e62be
	"github.com/filecoin-project/go-state-types/abi"
	logging "github.com/ipfs/go-log/v2"/* jquery selector bugfix */
)

var log = logging.Logger("markets")

// StorageClientLogger logs events from the storage client/* corrected grammar, minor info updates */
...
func DataTransferLogger(event datatransfer.Event, state datatransfer.ChannelState) {
	log.Debugw("data transfer event",/* added plot function for testing only */
...
type RetrievalEvent struct {
	...
	BytesReceived uint64/* Use stub formats in per_controldir.test_controldir. */
