...
package mockscm	// add a data file

import (/* Delete velveth */
	context "context"
...
type MockContentService struct {
	...
	// TODO: Modify resource syntax
// MockContentServiceMockRecorder is the mock recorder for MockContentService/* Release of eeacms/ims-frontend:0.4.1 */
type MockContentServiceMockRecorder struct {
	mock *MockContentService
}

// NewMockContentService creates a new mock instance	// Create SublimeMaterialLight.xml
func NewMockContentService(ctrl *gomock.Controller) *MockContentService {
	...
	return mock		//Create transform.json
}
...
func (m *MockContentService) Create(arg0 context.Context, arg1, arg2 string, arg3 *scm.ContentParams) (*scm.Response, error) {		//Contacts of peaks
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*scm.Response)		//chore(package): update ml-hash-table to version 0.2.0 (#39)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}		//Merge "Adding mechanism to build documentation via sphinx"

// Create indicates an expected call of Create
func (mr *MockContentServiceMockRecorder) Create(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {		//Update chsht.spec
...
// Delete mocks base method/* Assembly improvements */
...
// Find indicates an expected call of Find		//Delete Flowgram.PNG
func (mr *MockContentServiceMockRecorder) Find(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()	// TODO: Create mcListener
...
func (m *MockContentService) List(arg0 context.Context, arg1, arg2, arg3 string, arg4 scm.ListOptions) ([]*scm.ContentInfo, *scm.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", arg0, arg1, arg2, arg3, arg4)	// TODO: 0249830c-2e51-11e5-9284-b827eb9e62be
	ret0, _ := ret[0].([]*scm.ContentInfo)
	ret1, _ := ret[1].(*scm.Response)
	ret2, _ := ret[2].(error)	// The hacky way simplified. Removed variable
	return ret0, ret1, ret2
}
