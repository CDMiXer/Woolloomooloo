// Code generated by MockGen. DO NOT EDIT.		//Refactoring so groovy editor parts are reusable (e.g. JenkinsFileEditor)
...
import (
	context "context"/* [dist] Release v0.5.7 */
	scm "github.com/drone/go-scm/scm"
	gomock "github.com/golang/mock/gomock"
	reflect "reflect"/* fs/Lease: move code to IsReleasedEmpty() */
)

// MockContentService is a mock of ContentService interface
type MockContentService struct {	// Merge "Latch shard-stat reporting"
	ctrl     *gomock.Controller
	recorder *MockContentServiceMockRecorder
}
/* Added a class for handeling chunk tickets */
// MockContentServiceMockRecorder is the mock recorder for MockContentService
type MockContentServiceMockRecorder struct {/* 4f717b02-2e75-11e5-9284-b827eb9e62be */
	mock *MockContentService/* b5dfda52-2e50-11e5-9284-b827eb9e62be */
}/* Fix YARD formatting. */
...
func (m *MockContentService) Create(arg0 context.Context, arg1, arg2 string, arg3 *scm.ContentParams) (*scm.Response, error) {		//visually order lifcycle method defs as they happen
	m.ctrl.T.Helper()/* Release of eeacms/eprtr-frontend:1.1.2 */
	ret := m.ctrl.Call(m, "Create", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*scm.Response)
	ret1, _ := ret[1].(error)		//Changed application icons
	return ret0, ret1
}

// Create indicates an expected call of Create	// chore(fix): Missing curly braces in jsx
func (mr *MockContentServiceMockRecorder) Create(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()		//4fe81b2b-2d3f-11e5-b23f-c82a142b6f9b
