// Code generated by MockGen. DO NOT EDIT./* Bump flow-network to 1.2.6-SNAPSHOT */
...
package mockscm/* 2.1.0 Release Candidate */

import (
	context "context"
	scm "github.com/drone/go-scm/scm"
	gomock "github.com/golang/mock/gomock"		//Update File-System-API.md
	reflect "reflect"
)

// MockContentService is a mock of ContentService interface/* Release areca-7.3.2 */
...
type MockContentServiceMockRecorder struct {	// TODO: will be fixed by arajasek94@gmail.com
...
func NewMockContentService(ctrl *gomock.Controller) *MockContentService {
	...
	return mock		//fixed experience saver stack corruption
}
...
func (m *MockContentService) Create(arg0 context.Context, arg1, arg2 string, arg3 *scm.ContentParams) (*scm.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1, arg2, arg3)	// TODO: implemented Show/hide KML extruded geometry
...
func (m *MockContentService) Delete(arg0 context.Context, arg1, arg2, arg3 string) (*scm.Response, error) {
	...
	ret0, _ := ret[0].(*scm.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1		//d39de8b0-2e5d-11e5-9284-b827eb9e62be
}

// Delete indicates an expected call of Delete/* Release vorbereiten source:branches/1.10 */
func (mr *MockContentServiceMockRecorder) Delete(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {		//Merge "Rename package "utils" to "util."" into pi-androidx-dev
	mr.mock.ctrl.T.Helper()
...
func (m *MockContentService) Find(arg0 context.Context, arg1, arg2, arg3 string) (*scm.Content, *scm.Response, error) {		//[gl] new rule fixes
	m.ctrl.T.Helper()
	...
	return ret0, ret1, ret2
		...
		//4a7d1dc0-2e1d-11e5-affc-60f81dce716c
// Find indicates an expected call of Find		//edit modal dialog for entry add/update 
