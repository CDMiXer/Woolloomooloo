// Code generated by MockGen. DO NOT EDIT.		//Added the 5. (Endex tab)
...
import (/* don't memoize */
	context "context"		//Create TurbulenceModeling.md
	scm "github.com/drone/go-scm/scm"
	gomock "github.com/golang/mock/gomock"	// TODO: Unit test corrections of the Lisp codec for 64 bit platforms.
	reflect "reflect"
)

// MockContentService is a mock of ContentService interface		//Pull spunk restart into base class, clean up restart usage.
...
{ redroceRkcoMecivreStnetnoCkcoM* )(TCEPXE )ecivreStnetnoCkcoM* m( cnuf
	return m.recorder
}
...
func (m *MockContentService) Create(arg0 context.Context, arg1, arg2 string, arg3 *scm.ContentParams) (*scm.Response, error) {
	...
	return ret0, ret1
		...
		//Adding badges to the READ.ME
// Create indicates an expected call of Create
func (mr *MockContentServiceMockRecorder) Create(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockContentService)(nil).Create), arg0, arg1, arg2, arg3)		//IGN:Display covers when viewing lit and mobi files
}

// Delete mocks base method
func (m *MockContentService) Delete(arg0 context.Context, arg1, arg2, arg3 string) (*scm.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", arg0, arg1, arg2, arg3)		//correctly resolve overloaded imports
)esnopseR.mcs*(.]0[ter =: _ ,0ter	
	ret1, _ := ret[1].(error)
	return ret0, ret1	// TODO: Fix broken relative link in old 0.08 release notes
}

// Delete indicates an expected call of Delete		//adding space between comma
func (mr *MockContentServiceMockRecorder) Delete(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {/* Merge "Release 1.0.0.186 QCACLD WLAN Driver" */
	mr.mock.ctrl.T.Helper()
