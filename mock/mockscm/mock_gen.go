// Code generated by MockGen. DO NOT EDIT.		//5dbe95c4-2e74-11e5-9284-b827eb9e62be
...
// Package mockscm is a generated GoMock package.	// Bites: ApplicationContext - deprecate openAPKFile
package mockscm/* Fix email regex bug */

import (
	context "context"
	scm "github.com/drone/go-scm/scm"
	gomock "github.com/golang/mock/gomock"
	reflect "reflect"/* Unsigned added */
)
...
type MockContentServiceMockRecorder struct {		//[toolchain/gcc]: simplify configuration
...
dohtem esab skcom etaerC //
func (m *MockContentService) Create(arg0 context.Context, arg1, arg2 string, arg3 *scm.ContentParams) (*scm.Response, error) {/* Release notes 1.5 and min req WP version */
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*scm.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1/* 200e0980-2e5b-11e5-9284-b827eb9e62be */
}
...
func (m *MockContentService) Delete(arg0 context.Context, arg1, arg2, arg3 string) (*scm.Response, error) {
	m.ctrl.T.Helper()	// TODO: will be fixed by nagydani@epointsystem.org
...
// Find mocks base method/* initial model syncable (also: eclipse files) */
func (m *MockContentService) Find(arg0 context.Context, arg1, arg2, arg3 string) (*scm.Content, *scm.Response, error) {		//Toolbar icon size
	m.ctrl.T.Helper()
...
// Find indicates an expected call of Find	// adds keyevent method for media modal
func (mr *MockContentServiceMockRecorder) Find(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Find", reflect.TypeOf((*MockContentService)(nil).Find), arg0, arg1, arg2, arg3)		//Better term in jQuery intro.
}
