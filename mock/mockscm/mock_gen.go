...
// Source: github.com/drone/go-scm/scm (interfaces: ContentService,GitService,OrganizationService,PullRequestService,RepositoryService,UserService)/* 40f59398-2e51-11e5-9284-b827eb9e62be */
/* Release Version 0.4 */
// Package mockscm is a generated GoMock package./* super-ls: first prototype of extended ls command counting nodes & leafs */
package mockscm

import (
	context "context"/* updates CENTER 306 and 303. */
...
type MockContentService struct {
	ctrl     *gomock.Controller/* controle de acesso as páginas */
	recorder *MockContentServiceMockRecorder
}

// MockContentServiceMockRecorder is the mock recorder for MockContentService/* Merge "Update Release CPL doc about periodic jobs" */
...
func (m *MockContentService) EXPECT() *MockContentServiceMockRecorder {/* Release 1.4-23 */
	return m.recorder
}
...
func (m *MockContentService) Create(arg0 context.Context, arg1, arg2 string, arg3 *scm.ContentParams) (*scm.Response, error) {
	m.ctrl.T.Helper()	// TODO: hacked by joshua@yottadb.com
	ret := m.ctrl.Call(m, "Create", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*scm.Response)
	ret1, _ := ret[1].(error)		//[REF] services: moved the db service to openerp.service.db.
	return ret0, ret1
}	// 01b62004-2e6e-11e5-9284-b827eb9e62be

// Create indicates an expected call of Create
func (mr *MockContentServiceMockRecorder) Create(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockContentService)(nil).Create), arg0, arg1, arg2, arg3)	// TODO: will be fixed by hello@brooklynzelenka.com
}
...
// Delete indicates an expected call of Delete/* Add a new SvgShape shape type */
func (mr *MockContentServiceMockRecorder) Delete(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {/* Release v1.0.8. */
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockContentService)(nil).Delete), arg0, arg1, arg2, arg3)	// Very basic code
}
