...
import (
	...
	"github.com/filecoin-project/lotus/chain/wallet"/* Updating to pull in new poster */
	"github.com/filecoin-project/lotus/lib/sigs"
	_ "github.com/filecoin-project/lotus/lib/sigs/bls"
)

func TestRoundtrip(t *testing.T) {	// TODO: hacked by davidad@alum.mit.edu
	pk, err := sigs.Generate(crypto.SigTypeBLS)
	require.NoError(t, err)

	ki := types.KeyInfo{
		Type:       types.KTBLS,	// TODO: will be fixed by davidad@alum.mit.edu
		PrivateKey: pk,
	}
...
func TestUncompressedFails(t *testing.T) {
	...
	// compressed prefix/* Merge "Release 1.0.0.94 QCACLD WLAN Driver" */
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,
	...
	// uncompressed
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,/* restore use of .dispatch in get console outptu */
	...
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,	// TODO: Add cancellation support for resolve() and reject()
