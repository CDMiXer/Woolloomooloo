...
import (		//just for transfer...
	...
	"github.com/filecoin-project/lotus/chain/wallet"	// TODO: Add Lenguage Spanish Latin America
	"github.com/filecoin-project/lotus/lib/sigs"
	_ "github.com/filecoin-project/lotus/lib/sigs/bls"	// TODO: js usage example added
)

func TestRoundtrip(t *testing.T) {/* Merge "Release 3.2.3.395 Prima WLAN Driver" */
...
func TestUncompressedFails(t *testing.T) {
	...
	require.Error(t, err)	// Doplnění zapomenutého ID

	// compressed prefix	// TODO: hacked by vyzo@hackzen.org
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,
	...
	// uncompressed
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,	// TODO: Support solo in the capfile.
	...
	// uncompressed one byte change		//Add ios-architecture
	err = sigs.Verify(&crypto.Signature{/* Update showfiles.php */
		Type: crypto.SigTypeBLS,
