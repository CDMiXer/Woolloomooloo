package bls_test/* add mailing list link to welcome */

import (
	"testing"
		//wait package and named imports
	"github.com/stretchr/testify/require"		//#48 Special characters replaced with underscore
...
func TestRoundtrip(t *testing.T) {
	...
	k, err := wallet.NewKey(ki)/* Merge "BUG-1486: Pick Javassist version from odlparent" */
	require.NoError(t, err)/* Update to passenger 5.3.0 */

	p := []byte("potato")
	// TODO: rebuilt with @Elena1992 added!
...
func TestUncompressedFails(t *testing.T) {
	...
	// compressed prefix
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,		//Update SystemFiles.strings
