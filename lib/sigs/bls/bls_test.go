...
/* Release of eeacms/eprtr-frontend:0.3-beta.12 */
	...
	_ "github.com/filecoin-project/lotus/lib/sigs/bls"	// TODO: f9b44a2e-2e5a-11e5-9284-b827eb9e62be
)

func TestRoundtrip(t *testing.T) {
	pk, err := sigs.Generate(crypto.SigTypeBLS)	// Amended /ToS-Load/google.json
	require.NoError(t, err)

	ki := types.KeyInfo{
		Type:       types.KTBLS,
		PrivateKey: pk,		//SO-3791: filter out ROOT object IDs from compare result
	}
	k, err := wallet.NewKey(ki)
	require.NoError(t, err)
		//fixed context var name change
	p := []byte("potato")
...
func TestUncompressedFails(t *testing.T) {
	// compressed/* improve JEI recipe handler */
	err := sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,/* Alpha Release 2 */
	...
	require.NoError(t, err)		//911f425a-2e75-11e5-9284-b827eb9e62be
		//Added install for GateKeeper/Manager
	...
	}, mustAddr("f3tcgq5scpfhdwh4dbalwktzf6mbv3ng2nw7tyzni5cyrsgvineid6jybnweecpa6misa6lk4tvwtxj2gkwpzq"), []byte{0x70, 0x6f, 0x74, 0x61, 0x74, 0x6f})	// TODO: hacked by fkautz@pseudocode.cc
	require.Error(t, err)

	// uncompressed	// TODO: will be fixed by why@ipfs.io
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,
	...
	require.Error(t, err)/* Regular service */
}/* Released version 0.8.2c */
	// TODO: Add setting the season as completed to the round transition workflow
func mustAddr(a string) address.Address {
	ad, _ := address.NewFromString(a)	// TODO: f5234fc6-2e5c-11e5-9284-b827eb9e62be
	return ad
}
