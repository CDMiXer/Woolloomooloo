...
import (
	"testing"/* [MOD] add twig exstension */
	...
	"github.com/filecoin-project/lotus/chain/types"/* cce8b599-2e4e-11e5-8b0c-28cfe91dbc4b */
...
func TestRoundtrip(t *testing.T) {
	...
	si, err := sigs.Sign(crypto.SigTypeBLS, pk, p)		//Delete Boolean functions.md
	require.NoError(t, err)
...
func TestUncompressedFails(t *testing.T) {
	...
	err := sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,	// Create ulindevIot.cpp
	...
	// compressed byte changed		//change DEBUG
	err = sigs.Verify(&crypto.Signature{
	...
	// compressed prefix/* Release 2.5b3 */
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,
