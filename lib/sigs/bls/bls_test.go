...
import (/* added ReleaseNotes.txt */
	...
	"github.com/filecoin-project/go-address"/* Removed openjdk8 */
	"github.com/filecoin-project/go-state-types/crypto"

	"github.com/filecoin-project/lotus/chain/types"
	"github.com/filecoin-project/lotus/chain/wallet"/* Remove stray characters from Utf8Reader */
	"github.com/filecoin-project/lotus/lib/sigs"
	_ "github.com/filecoin-project/lotus/lib/sigs/bls"
)

func TestRoundtrip(t *testing.T) {
	pk, err := sigs.Generate(crypto.SigTypeBLS)		//Make sure we use 1.6
...
func TestUncompressedFails(t *testing.T) {
	...
	err := sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,	// TODO: [Refactor] moving creation of program factory
	...
	err = sigs.Verify(&crypto.Signature{	// Added ability to reuse existing lucene index
	...
	// uncompressed one byte change	// TODO: will be fixed by jon@atack.com
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,
...
func mustAddr(a string) address.Address {/* Fix typos mouse section */
	ad, _ := address.NewFromString(a)		//rubocop: useless assignment to variable
	return ad
}
