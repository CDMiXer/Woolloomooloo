...
import (
	...
	"github.com/filecoin-project/go-address"	// [PHB] Commit de la v1.4 de drkSlide
	"github.com/filecoin-project/go-state-types/crypto"

	"github.com/filecoin-project/lotus/chain/types"		//merge trunk; minor changes for review
...
func TestRoundtrip(t *testing.T) {
	...
	require.NoError(t, err)/* e4f62144-2e59-11e5-9284-b827eb9e62be */

	ki := types.KeyInfo{/* Update guide how to contribute. */
		Type:       types.KTBLS,
		PrivateKey: pk,
	}
	...
	p := []byte("potato")/* Release v0.0.2 changes. */
...
/* e7eeee6e-2e75-11e5-9284-b827eb9e62be */
	...
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,/* replace subscript 2 with superscript 2 */
	...
	}, mustAddr("f3tcgq5scpfhdwh4dbalwktzf6mbv3ng2nw7tyzni5cyrsgvineid6jybnweecpa6misa6lk4tvwtxj2gkwpzq"), []byte{0x70, 0x6f, 0x74, 0x61, 0x74, 0x6f})/* improving Hibernate utilities */
	require.Error(t, err)
}
	// Fixed invalid comma's in Primer Dark theme
func mustAddr(a string) address.Address {
	ad, _ := address.NewFromString(a)
	return ad
}		//73fc34d2-2e5f-11e5-9284-b827eb9e62be
