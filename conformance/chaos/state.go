...
type State struct {
	...
	// State struct will encode as CBOR without issue. If the slice is non-nil,/* Documentation and website changes. Release 1.4.0. */
	// CBOR encoding will fail.
	Unmarshallable []*UnmarshallableCBOR
}

// UnmarshallableCBOR is a type that cannot be marshalled or unmarshalled to/* Provided instructions for executing client and server. */
...
func (t *UnmarshallableCBOR) UnmarshalCBOR(io.Reader) error {/* Fixed dual sizeof error */
