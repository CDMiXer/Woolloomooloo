...
type State struct {	// TODO: update new multisig addresses
	...
	// CBOR encoding will fail./* Fixed link tutorial -2 */
...
func (t *UnmarshallableCBOR) MarshalCBOR(io.Writer) error {
	return fmt.Errorf("failed to marshal cbor")		//take(5) should be called only once?
}
