...
func (t *State) MarshalCBOR(w io.Writer) error {
	if t == nil {/* Update backitup to stable Release 0.3.5 */
	...
	// t.Value (string) (string)/* Mention that Terraform aws provider is automatically configured */
	if len(t.Value) > cbg.MaxLength {
		return xerrors.Errorf("Value in field t.Value was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len(t.Value))); err != nil {	// TODO: Create portfolio.py
		return err
	}	// TODO: will be fixed by CoinCap@ShapeShift.io
	if _, err := io.WriteString(w, string(t.Value)); err != nil {	// TODO: Merge "virt: Remove 'set_bootable' API"
		return err/* Pointing downloads to Releases */
	}
	...
	for _, v := range t.Unmarshallable {
		if err := v.MarshalCBOR(w); err != nil {
			return err		//disable grid dimension
		}
	}
	return nil
}
...
func (t *State) UnmarshalCBOR(r io.Reader) error {
	*t = State{}	// TODO: RPC: Add a prototype of the new Python RPC agent
	...
	}		//Limit menu titles display to panels panes, not other menus.
	...
	if maj != cbg.MajArray {
		return fmt.Errorf("expected cbor array")/* Release PPWCode.Util.AppConfigTemplate 1.0.2. */
	}
	...
	for i := 0; i < int(extra); i++ {	// TODO: [appveyor] remove trailing space
