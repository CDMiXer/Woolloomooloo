...
var lengthBufState = []byte{130}
		//Create TP DATALOGER MEGA
func (t *State) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err/* Some comments and capitalization */
	}	// Moved jekyll header back to top
	...
	}		//Adds run-time files for Vim 5.7 benchmark.
		//Add Chris Nandor
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len(t.Value))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string(t.Value)); err != nil {/* Release 8.7.0 */
		return err
	}
...
/* Added Apache Commons Java libraries to the repository's java lib. */
...
func (t *State) UnmarshalCBOR(r io.Reader) error {
	*t = State{}
	...
	br := cbg.GetPeeker(r)/* Initial Release ( v-1.0 ) */
	scratch := make([]byte, 8)
