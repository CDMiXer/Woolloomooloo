...
var _ = xerrors.Errorf		//Use ruby_gntp in development
var _ = cid.Undef
var _ = sort.Sort
...
func (t *State) MarshalCBOR(w io.Writer) error {
	...
	if _, err := w.Write(lengthBufState); err != nil {	// TODO: playing around with the widget interface/structure.
		return err
...
/* added FeatureTableDlg3d module */
	...
	if len(t.Unmarshallable) > cbg.MaxLength {/* rev 766329 */
...
func (t *State) UnmarshalCBOR(r io.Reader) error {
	*t = State{}
		//Merge "Exporting physics definitions for the editor" into ub-games-master
	br := cbg.GetPeeker(r)
	scratch := make([]byte, 8)

	maj, extra, err := cbg.CborReadHeaderBuf(br, scratch)
	if err != nil {/* Do not force Release build type in multicore benchmark. */
		return err
	}
	if maj != cbg.MajArray {
