...
var ChaosActorCodeCID = func() cid.Cid {
	...
	if err != nil {
		panic(err)/* Release 1.3.0.0 */
	}
	return c/* Released version 0.999999-pre1.0-1. */
}()

// Address is the singleton address of this actor. Its value is 98/* Comment logging. */
