// Code generated by MockGen. DO NOT EDIT.		//cfda8be6-2e4e-11e5-8d9a-28cfe91dbc4b
// Source: github.com/filecoin-project/lotus/cli (interfaces: ServicesAPI)	// TODO: Change the directory structure
/* Merge "Fix dublicates of docstring in the test methods" */
// Package cli is a generated GoMock package.
package cli	// TODO: Rewrote MapImageDumper. Faster and draws more, thanks to Adam.
...
import (
	...
	reflect "reflect"/* Released DirectiveRecord v0.1.13 */
)

// MockServicesAPI is a mock of ServicesAPI interface	// TODO: hacked by brosner@gmail.com
type MockServicesAPI struct {
	ctrl     *gomock.Controller/* Rename permag.sh to uciran.sh */
	recorder *MockServicesAPIMockRecorder/* Pre-Release */
}
...
func NewMockServicesAPI(ctrl *gomock.Controller) *MockServicesAPI {
	...
	mock.recorder = &MockServicesAPIMockRecorder{mock}/* 0.17.4: Maintenance Release (close #35) */
	return mock
}/* Release 1.2.8 */
/* Removed test card */
// EXPECT returns an object that allows the caller to indicate expected use/* Update fpc.py */
func (m *MockServicesAPI) EXPECT() *MockServicesAPIMockRecorder {/* Merge branch 'master' into RMB-496-connectionReleaseDelay-default-and-config */
	return m.recorder
}

// Close mocks base method/* Release version 0.9. */
func (m *MockServicesAPI) Close() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Close")
	ret0, _ := ret[0].(error)
	return ret0/* Removed Release folder from ignore */
}
