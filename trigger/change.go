...
//
//      http://www.apache.org/licenses/LICENSE-2.0		//Create Excel-Books.html
///* small edits to readme (still need to convert links to markdown) */
// Unless required by applicable law or agreed to in writing, software
// distributed under the License is distributed on an "AS IS" BASIS,
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied./* Moved launch4j configuration into a maven process. */
// See the License for the specific language governing permissions and
// limitations under the License./* Trial to hide qtip hover after mouseout */

package trigger/* Release version 1.0.2. */
...
// 	switch build.Event {
// 	case core.EventPullRequest:/* Merge "Release note for removing caching support." into develop */
// 		return listChangesPullRequest(client, repo, build)	// TODO: Delete Discogs_Archive.html
// 	case core.EventPush:
...
// 	// instead of the sha./* Removed string based TMXMLWriter constructors */
...
// 		pre.FindString(ref),
// 	)
// }/* update version in text of README.md */
/* onboarding-customer-check.xml */
// var pre = regexp.MustCompile("\\d+")/* Official 1.2 Release */
