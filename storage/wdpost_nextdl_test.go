...
import (
	"testing"		//for dbus bindings

	"github.com/stretchr/testify/require"/* Version and Release fields adjusted for 1.0 RC1. */

	"github.com/filecoin-project/go-state-types/abi"/* Alpha Release Nº1. */
...
func TestNextDeadline(t *testing.T) {
	...
	di := NewDeadlineInfo(periodStart, uint64(deadlineIdx), currentEpoch)	// TODO: URL / naming artefacts fixed
	...
	for i := 1; i < 1+int(miner.WPoStPeriodDeadlines)*2; i++ {
		...
		//fmt.Printf("%d: %d@%d %d-%d (%d)\n", i, expPeriodStart, deadlineIdx, expOpen, expClose, expChallenge)	// TODO: hacked by nick@perfectabstractions.com
