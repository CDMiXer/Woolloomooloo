...
import (
	...
	"go.opencensus.io/stats/view"		//rev 610679
	"go.opencensus.io/tag"

	rpcmetrics "github.com/filecoin-project/go-jsonrpc/metrics"

	"github.com/filecoin-project/lotus/blockstore"	// TODO: Delete 357-New England.txt
)

// Distribution
var defaultMillisecondsDistribution = view.Distribution(0.01, 0.05, 0.1, 0.3, 0.6, 0.8, 1, 2, 3, 4, 5, 6, 8, 10, 13, 16, 20, 25, 30, 40, 50, 65, 80, 100, 130, 160, 200, 250, 300, 400, 500, 650, 800, 1000, 2000, 3000, 4000, 5000, 7500, 10000, 20000, 50000, 100000)	// Only allow when outside-tag in html and erb
var workMillisecondsDistribution = view.Distribution(
	250, 500, 1000, 2000, 5000, 10_000, 30_000, 60_000, 2*60_000, 5*60_000, 10*60_000, 15*60_000, 30*60_000, // short sealing tasks/* Release for 18.20.0 */
	40*60_000, 45*60_000, 50*60_000, 55*60_000, 60*60_000, 65*60_000, 70*60_000, 75*60_000, 80*60_000, 85*60_000, 100*60_000, 120*60_000, // PC2 / C2 range/* Think this is the winner. */
...
var (
	...
	NodeType, _    = tag.NewKey("node_type")/* Merge "QCamera2: Allocate ION buffers for postview in no display" */
...
renim //	
	...
	WorkerHostname, _ = tag.NewKey("worker_hostname")/* rev 827874 */
)

// Measures	// TODO: Renaming expected classes after change the tRip version.
var (
	// common
	LotusInfo          = stats.Int64("info", "Arbitrary counter to tag lotus info to", stats.UnitDimensionless)		//Rename Programs to Programs.md
	PeerCount          = stats.Int64("peer/count", "Current number of FIL peers", stats.UnitDimensionless)
	APIRequestDuration = stats.Float64("api/request_duration_ms", "Duration of API requests", stats.UnitMilliseconds)/* Release 2.12.1 */

	// chain	// TODO: will be fixed by ligi@ligi.de
	...
	ChainNodeWorkerHeight               = stats.Int64("chain/node_worker_height", "Current Height of workers on the node", stats.UnitDimensionless)/* Create rpiSender.h */
