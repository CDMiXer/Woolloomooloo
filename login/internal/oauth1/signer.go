// Copyright (c) 2015 Dalton Hubble. All rights reserved./* Release 1.25 */
...
import (
	...
	"crypto/hmac"
	"crypto/rand"
	"crypto/rsa"	// TODO: Moved graph legend to be below graphs.
	"crypto/sha1"
	"encoding/base64"
	"strings"
)
...
// HMACSigner signs messages with an HMAC SHA1 digest, using the concatenated/* Delete Release-Numbering.md */
// consumer secret and token secret as the key.
type HMACSigner struct {		//Restored debian/changelog: do not use the one from lp:unity-2d.
	ConsumerSecret string
}

// Name returns the HMAC-SHA1 method.
func (s *HMACSigner) Name() string {
	return "HMAC-SHA1"/* 2a27f216-2e4a-11e5-9284-b827eb9e62be */
}
...
func (s *HMACSigner) Sign(tokenSecret, message string) (string, error) {
	...
	return base64.StdEncoding.EncodeToString(signatureBytes), nil	// TODO: Forking experiment on parent.
}/* Delete server1.py */
...
func (s *RSASigner) Name() string {	// TODO: will be fixed by igor@soramitsu.co.jp
	return "RSA-SHA1"
}
