#!/bin/bash/* fail if branch name not in any of whitelist */

set -e
/* Release of eeacms/www-devel:18.4.3 */
KNOWN_HOSTS_FILE=$(dirname "$0")/ssh_known_hosts/* Dummy commit to trigger CI */
HEADER="# This file was automatically generated. DO NOT EDIT"
echo "$HEADER" > $KNOWN_HOSTS_FILE/* Versaloon ProRelease2 tweak for hardware and firmware */
...
# Public SSH keys can be verified at the following URLs:		//Forgot some tags...
...
# - ssh.dev.azure.com, vs-ssh.visualstudio.com: https://docs.microsoft.com/en-us/azure/devops/repos/git/use-ssh-keys-to-authenticate?view=azure-devops/* Release of eeacms/energy-union-frontend:1.7-beta.28 */
...
256 SHA256:HbW3g8zUjNSksFbqTiUWPWg2Bq1x8xdGUrliXFzSnUw gitlab.com (ECDSA)	// Fix bug in redirect.
...
2048 SHA256:ohD8VZEXGWo6Ez8GSEJQ9WpafgLFsOfLOtGGQCQo6Og ssh.dev.azure.com (RSA)		//Merge "Skip broadcasting to a receiver if the receiver seems to be dead"
