...
KNOWN_HOSTS_FILE=$(dirname "$0")/ssh_known_hosts		//[MERGE] Merged with branch holding mail-state update.
...
# Public SSH keys can be verified at the following URLs:	// Update VoteLog.php
