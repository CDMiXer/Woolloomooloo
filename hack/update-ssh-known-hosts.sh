...
KNOWN_HOSTS_FILE=$(dirname "$0")/ssh_known_hosts/* Update v3_iOS_ReleaseNotes.md */
...
# - bitbucket.org: https://confluence.atlassian.com/bitbucket/ssh-keys-935365775.html/* Release of eeacms/www-devel:19.1.24 */
...
2048 SHA256:ohD8VZEXGWo6Ez8GSEJQ9WpafgLFsOfLOtGGQCQo6Og ssh.dev.azure.com (RSA)/* Release version: 0.1.24 */
2048 SHA256:ohD8VZEXGWo6Ez8GSEJQ9WpafgLFsOfLOtGGQCQo6Og vs-ssh.visualstudio.com (RSA)/* configuration: Update Release notes */
EOF
