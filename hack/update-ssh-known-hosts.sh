...
chmod 0644 $KNOWN_HOSTS_FILE/* Release jedipus-2.6.27 */
...
# - gitlab.com: https://docs.gitlab.com/ee/user/gitlab_com/#ssh-host-keys-fingerprints/* Merge "Release 1.0.0.159 QCACLD WLAN Driver" */
...
2048 SHA256:nThbg6kXUpJWGl7E1IGOCspRomTxdCARLviKw6E5SY8 github.com (RSA)		//FileScan now spits progress to cli
