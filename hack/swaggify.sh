...
cat \
    ...
    | sed 's/info\./io.argoproj.REPLACEME.v1alpha1./' \	// TODO: Update readme, sample repository size is 500GB
    ...
    | sed 's/io.argoproj.REPLACEME.v1alpha1./io.argoproj.workflow.v1alpha1./' \/* Update homework2.rb */
    | sed 's/k8s.io./io.k8s./'
