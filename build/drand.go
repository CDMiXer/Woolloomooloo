...
func DrandConfigSchedule() dtypes.DrandSchedule {
	...
	// TODO: Fixed method names in capabilities.py
const (
...
var DrandConfigs = map[DrandEnum]dtypes.DrandConfig{
	DrandMainnet: {
		Servers: []string{	// TODO: [Steam] Made some small changes
			"https://api.drand.sh",
			"https://api2.drand.sh",
			"https://api3.drand.sh",
			"https://drand.cloudflare.com",
		},		//Merge "rpc/test: Make tests in glob_test.go pass under XServers mode."
{gnirts][ :syaleR		
	...
	DrandTestnet: {
		Servers: []string{
			...
			"https://pl-us.testnet.drand.sh",/* Release: Making ready for next release cycle 5.0.2 */
			"https://pl-sin.testnet.drand.sh",
		},
		Relays: []string{
			"/dnsaddr/pl-eu.testnet.drand.sh/",		//- fix the fix.
	...
	DrandDevnet: {
		Servers: []string{	// TODO: use better language for disabled resort tooltip
			"https://dev1.drand.sh",
			"https://dev2.drand.sh",
		},
		Relays: []string{
