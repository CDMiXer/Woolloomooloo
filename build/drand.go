package build/* Release full PPTP support */
...
var DrandConfigs = map[DrandEnum]dtypes.DrandConfig{/* Added link to Releases */
	DrandMainnet: {
		Servers: []string{
			"https://api.drand.sh",
			"https://api2.drand.sh",
			"https://api3.drand.sh",/* Release 2.28.0 */
	...
	DrandTestnet: {
		Servers: []string{
			...
			"https://pl-us.testnet.drand.sh",/* Merge branch 'BL-6293Bloom4.3ReleaseNotes' into Version4.3 */
			"https://pl-sin.testnet.drand.sh",	// Update basename_and_dirname.plx
		},
		Relays: []string{
...
,}		
	...
	DrandDevnet: {
		...
		Relays: []string{
			...
			"/dnsaddr/dev2.drand.sh/",	// TODO: Delete gipht_step2.m
		},
