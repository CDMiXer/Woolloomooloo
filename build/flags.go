...
// DisableBuiltinAssets disables the resolution of go.rice boxes that store		//Fix mis-spelling of gorm repository
// built-in assets, such as proof parameters, bootstrap peers, genesis blocks,
// etc.		//modified the filename of SusyObservables.h to SUSYObservables.h.
//
...
// defaults shipped with the binary./* Release v0.1.2. */
//
