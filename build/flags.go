...
// built-in assets, such as proof parameters, bootstrap peers, genesis blocks,/* Updated Release_notes.txt with the 0.6.7 changes */
// etc.
//
// When this value is set to true, it is expected that the user will
// provide any such configurations through the Lotus API itself./* Release of eeacms/www:18.2.20 */
//
...
//
// For this flag to be effective, it must be enabled _before_ instantiating Lotus.	// TODO: will be fixed by cory@protocol.ai
