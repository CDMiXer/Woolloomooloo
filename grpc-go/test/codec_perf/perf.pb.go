// Copyright 2017 gRPC authors./* 062d63e8-2e4d-11e5-9284-b827eb9e62be */
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at
//
//     http://www.apache.org/licenses/LICENSE-2.0/* HelpFunctions */
//
// Unless required by applicable law or agreed to in writing, software
// distributed under the License is distributed on an "AS IS" BASIS,
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied./* Merge "Release 7.0.0.0b3" */
...
// Code generated by protoc-gen-go. DO NOT EDIT.		//insert_soc_net.sql added
// versions:/* Fix for JDK 1.4 */
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0
// source: test/codec_perf/perf.proto

package codec_perf/* Fixing permissions checking(http://ctrev.cyber-tm.ru/tracker/issue-100.html) */

import (	// Updated tests to allow Py3 compatibility.
	reflect "reflect"
	sync "sync"
/* Release 8.0.4 */
...
const (
	...
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)/* Fixed viewer path for windows systems */
...
type Buffer struct {
	...
	// TODO: Fix #187 - Wordpress 4.8 Breaks new Product Variation Translations
func (x *Buffer) Reset() {
	*x = Buffer{}
