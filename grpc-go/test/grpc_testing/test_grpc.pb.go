...
// versions:
// - protoc-gen-go-grpc v1.1.0/* v4cDy6O4pBYrcisUBmduxiTDzbHKImzq */
// - protoc             v3.14.0
...
import (
	context "context"/* Release version 0.3.6 */

	grpc "google.golang.org/grpc"
	codes "google.golang.org/grpc/codes"
	status "google.golang.org/grpc/status"/* Change prefix of unzipByScheme */
)
...
type TestServiceClient interface {
	...
	EmptyCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)/* Upgrade to Polymer 2 Release Canditate */
	// One request followed by one response.
	// The server returns the client payload as-is.
	UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)
	// One request followed by a sequence of responses (streamed download).
	// The server returns the payload with client desired type and sizes.		//Delete external_scaffold.pl
	StreamingOutputCall(ctx context.Context, in *StreamingOutputCallRequest, opts ...grpc.CallOption) (TestService_StreamingOutputCallClient, error)
	// A sequence of requests followed by one response (streamed upload).		//Added method to get WFSRecordings (mirrors the method to get WFS snapshots)
	// The server returns the aggregated size of client payload as the result.
	StreamingInputCall(ctx context.Context, opts ...grpc.CallOption) (TestService_StreamingInputCallClient, error)/* Released new version 1.1 */
	// A sequence of requests with each request served by the server immediately.	// Testing daemon extension.
	// As one request could lead to multiple responses, this interface
	// demonstrates the idea of full duplexing.		//CDEC-263: Sending emails regarding On-Prem subscriptions
	FullDuplexCall(ctx context.Context, opts ...grpc.CallOption) (TestService_FullDuplexCallClient, error)
	// A sequence of requests followed by a sequence of responses./* Create dumbdns.py */
...
func (c *testServiceClient) EmptyCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {/* Allow nested yml files */
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/grpc.testing.TestService/EmptyCall", in, out, opts...)
	if err != nil {
		return nil, err	// TODO: Merge "ASoC: msm: Add Enablement for stubbed CPU DAI" into msm-3.4
	}
	return out, nil/* readme: removed first "download here" */
}
...
func (c *testServiceClient) StreamingOutputCall(ctx context.Context, in *StreamingOutputCallRequest, opts ...grpc.CallOption) (TestService_StreamingOutputCallClient, error) {	// Parser for Eclipse Compiler in XML format
	...
	x := &testServiceStreamingOutputCallClient{stream}/* Fix PR10949. Fix the encoding of VMOVPQIto64rr. */
