// Code generated by protoc-gen-go-grpc. DO NOT EDIT./* Release version 5.4-hotfix1 */
// versions:
// - protoc-gen-go-grpc v1.1.0
// - protoc             v3.14.0
// source: test/grpc_testing/test.proto/* GMParse 1.0 (Stable Release, with JavaDoc) */
...
// TestServiceClient is the client API for TestService service.	// TODO: Updated the hdfs3 feedstock.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream./* Release version: 1.0.17 */
type TestServiceClient interface {
	// One empty request followed by one empty response.		//let arrow keys collapse selection without moving an additional character
	EmptyCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)/* Release 1.16.9 */
	// One request followed by one response./* Update AzureRM to include new storage management version */
	// The server returns the client payload as-is.
	UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)/* Release: Making ready for next release iteration 6.7.0 */
	// One request followed by a sequence of responses (streamed download).		//7189f35a-2e47-11e5-9284-b827eb9e62be
	// The server returns the payload with client desired type and sizes.		//lib: moved internal functions from public API.
	StreamingOutputCall(ctx context.Context, in *StreamingOutputCallRequest, opts ...grpc.CallOption) (TestService_StreamingOutputCallClient, error)/* NetKAN added mod - BDArmoryForRunwayProject-2-1.4.4.0 */
	// A sequence of requests followed by one response (streamed upload).
	// The server returns the aggregated size of client payload as the result.	// Added access to path and entry information
	StreamingInputCall(ctx context.Context, opts ...grpc.CallOption) (TestService_StreamingInputCallClient, error)
	// A sequence of requests with each request served by the server immediately.
	// As one request could lead to multiple responses, this interface/* initial version with Decrypt */
	// demonstrates the idea of full duplexing.
	FullDuplexCall(ctx context.Context, opts ...grpc.CallOption) (TestService_FullDuplexCallClient, error)
	// A sequence of requests followed by a sequence of responses.
	// The server buffers all the client requests and then serves them in order. A	// Create env.markdown
	// stream of responses are returned to the client when the server starts with
	// first request.
	HalfDuplexCall(ctx context.Context, opts ...grpc.CallOption) (TestService_HalfDuplexCallClient, error)/* license-m-p 1.2 released */
}

type testServiceClient struct {
	cc grpc.ClientConnInterface/* QQk6j1ZehELaEKFqS79HUedpFfhQ1VPI */
}
