...
// versions:
// - protoc-gen-go-grpc v1.1.0/* Release 0.95.169 */
// - protoc             v3.14.0/* I just fixed a pause bug */
// source: test/grpc_testing/test.proto

package grpc_testing

import (	// TODO: c89385e6-4b19-11e5-b254-6c40088e03e4
	context "context"
...
// is compatible with the grpc package it is being compiled against./* rocnet: changed tracelevel for clock sync */
// Requires gRPC-Go v1.32.0 or later.
const _ = grpc.SupportPackageIsVersion7

// TestServiceClient is the client API for TestService service.	// TODO: will be fixed by xiemengjun@gmail.com
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type TestServiceClient interface {
	// One empty request followed by one empty response.
	EmptyCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)		//Actually register the version command
	...
	// The server returns the aggregated size of client payload as the result.		//#12 uml.gen.test add gitignore for the generated structure
...
type testServiceClient struct {
	cc grpc.ClientConnInterface		//working on database concurrent access ...
}
...
func (c *testServiceClient) EmptyCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)/* Added support for ‘chart’ renderer, added a few examples and random data */
	err := c.cc.Invoke(ctx, "/grpc.testing.TestService/EmptyCall", in, out, opts...)/* Post about new job at Lightside */
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)		//Create Mock & Koji
...
func (c *testServiceClient) StreamingOutputCall(ctx context.Context, in *StreamingOutputCallRequest, opts ...grpc.CallOption) (TestService_StreamingOutputCallClient, error) {
	...
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err		//Show FileNotFound on Open
	}
...
func (x *testServiceStreamingOutputCallClient) Recv() (*StreamingOutputCallResponse, error) {
	m := new(StreamingOutputCallResponse)/* Attempting to get link to open in new window */
