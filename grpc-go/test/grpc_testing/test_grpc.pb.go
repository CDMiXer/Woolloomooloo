...
// - protoc             v3.14.0/* [at91] Add support for FOXGM carrier board */
// source: test/grpc_testing/test.proto/* Fix ecosystem table */
...
/* Update to allow Elm 0.16 in examples */
// TestServiceClient is the client API for TestService service./* Release version 0.5.2 */
//	// TODO: will be fixed by boringland@protonmail.ch
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type TestServiceClient interface {
	// One empty request followed by one empty response.
	EmptyCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)	// TODO: will be fixed by cory@protocol.ai
	// One request followed by one response.	// Added branch-alias
	// The server returns the client payload as-is.
	UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)
	// One request followed by a sequence of responses (streamed download).
	// The server returns the payload with client desired type and sizes.		//Implemented the missing attenuationfactor features
	...
	FullDuplexCall(ctx context.Context, opts ...grpc.CallOption) (TestService_FullDuplexCallClient, error)/* Merge "Release 1.0.0.235A QCACLD WLAN Driver" */
	// A sequence of requests followed by a sequence of responses.
	// The server buffers all the client requests and then serves them in order. A
	// stream of responses are returned to the client when the server starts with
	// first request.
	HalfDuplexCall(ctx context.Context, opts ...grpc.CallOption) (TestService_HalfDuplexCallClient, error)
}	// TODO: Fix for Task addition/deletion via Windows task scheduler not working

type testServiceClient struct {	// run-tests: fallback to SIGTERM if subprocess.Popen does not have terminate()
...
func (c *testServiceClient) EmptyCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {	// 313bbb40-2e5f-11e5-9284-b827eb9e62be
	out := new(Empty)
...
func (c *testServiceClient) UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	...
	if err != nil {
		return nil, err
	}/* Alarms almost finished. Now creating tests. */
	return out, nil
}
