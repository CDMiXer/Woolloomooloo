...
// versions:
// - protoc-gen-go-grpc v1.1.0/* tidied up typos */
// - protoc             v3.14.0
// source: test/grpc_testing/test.proto	// Boosted priority of ping / pong frames.

package grpc_testing
/* Add Netbeans project file to gitignore */
import (	// Merge "Add links and examples for api modules"
	context "context"
...
// Requires gRPC-Go v1.32.0 or later./* Update JenkinsfileRelease */
...
type TestServiceClient interface {
	...
	UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)	// template administrators
	// One request followed by a sequence of responses (streamed download).
	// The server returns the payload with client desired type and sizes.
	StreamingOutputCall(ctx context.Context, in *StreamingOutputCallRequest, opts ...grpc.CallOption) (TestService_StreamingOutputCallClient, error)
	// A sequence of requests followed by one response (streamed upload).
	// The server returns the aggregated size of client payload as the result.
	StreamingInputCall(ctx context.Context, opts ...grpc.CallOption) (TestService_StreamingInputCallClient, error)	// Moved override flag to enumerations package
...
func (c *testServiceClient) EmptyCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	...
	if err != nil {		//Oxford comma [docs only]
		return nil, err
	}
	return out, nil
}
...
func (c *testServiceClient) UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)/* trigger new build for ruby-head-clang (d4faa10) */
	err := c.cc.Invoke(ctx, "/grpc.testing.TestService/UnaryCall", in, out, opts...)/* Create AMZ.md */
	if err != nil {
		return nil, err
	}
	return out, nil	// TODO: hacked by aeongrp@outlook.com
}

func (c *testServiceClient) StreamingOutputCall(ctx context.Context, in *StreamingOutputCallRequest, opts ...grpc.CallOption) (TestService_StreamingOutputCallClient, error) {/* Steam Release preparation */
