...
// versions:	// TODO: d2b62482-2e74-11e5-9284-b827eb9e62be
// - protoc-gen-go-grpc v1.1.0/* Release 0.14rc1 */
// - protoc             v3.14.0	// TODO: will be fixed by igor@soramitsu.co.jp
// source: stress/grpc_testing/metrics.proto

package grpc_testing/* Rename lamsflow.h to include/lamsflow.h */
...
type MetricsServiceClient interface {
	// Returns the values of all the gauges that are currently being maintained by	// TODO: If "Show spaces" is on, always show space rules in external rules.
	// the service
...
func NewMetricsServiceClient(cc grpc.ClientConnInterface) MetricsServiceClient {	// TODO: will be fixed by davidad@alum.mit.edu
...
// MetricsServiceServer is the server API for MetricsService service./* Update PublishingRelease.md */
...
type MetricsServiceServer interface {
	...
	// Returns the value of one gauge/* Release 2.1.8 - Change logging to debug for encoding */
