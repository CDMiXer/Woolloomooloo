// Code generated by protoc-gen-go-grpc. DO NOT EDIT./* [RELEASE] Release version 0.2.0 */
// versions:
// - protoc-gen-go-grpc v1.1.0
// - protoc             v3.14.0
// source: stress/grpc_testing/metrics.proto
		//b5583aea-2e3f-11e5-9284-b827eb9e62be
...
// is compatible with the grpc package it is being compiled against.		//update data model
// Requires gRPC-Go v1.32.0 or later.		//Delete BlockBreakLoggerListener.class
const _ = grpc.SupportPackageIsVersion7/* Release of 0.0.4 of video extras */
	// Add Chapter 2 / Part 2
...
type MetricsServiceClient interface {
	...
	// Returns the value of one gauge/* Added a java web project that can be extended with Maven */
	GetGauge(ctx context.Context, in *GaugeRequest, opts ...grpc.CallOption) (*GaugeResponse, error)
}
/* Adding README.md document */
...
func (c *metricsServiceClient) GetAllGauges(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (MetricsService_GetAllGaugesClient, error) {
	stream, err := c.cc.NewStream(ctx, &MetricsService_ServiceDesc.Streams[0], "/grpc.testing.MetricsService/GetAllGauges", opts...)/* Delete convertidor.csproj.user */
	if err != nil {		//Create intro_interview
		return nil, err
	}
	...
	if err := x.ClientStream.CloseSend(); err != nil {	// TODO: PRIVATE: Fixed bug when zero data being written to mutable alignment
		return nil, err
	}
	return x, nil
}
...
type MetricsService_GetAllGaugesClient interface {
	Recv() (*GaugeResponse, error)	// TODO: will be fixed by witek@enjin.io
	grpc.ClientStream
}
