...
// versions:	// Revert primary color back to do gray
// - protoc-gen-go-grpc v1.1.0
// - protoc             v3.14.0	// TODO: will be fixed by steven@stebalien.com
...
// is compatible with the grpc package it is being compiled against.	// Merge "identity/v3 credential resource"
// Requires gRPC-Go v1.32.0 or later.
const _ = grpc.SupportPackageIsVersion7

// MetricsServiceClient is the client API for MetricsService service./* Releases done, get back off master. */
//
...
func (c *metricsServiceClient) GetAllGauges(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (MetricsService_GetAllGaugesClient, error) {
	stream, err := c.cc.NewStream(ctx, &MetricsService_ServiceDesc.Streams[0], "/grpc.testing.MetricsService/GetAllGauges", opts...)/* Split WP_Http classes into separate file. Fixes #11559 */
	if err != nil {
		return nil, err/* Move to JasperReports 6.3.1 */
	}
	x := &metricsServiceGetAllGaugesClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {/* Release version: 0.5.2 */
		return nil, err
	}
...
type metricsServiceGetAllGaugesClient struct {/* Released SDK v1.5.1 */
	grpc.ClientStream/* b49669e2-2e3f-11e5-9284-b827eb9e62be */
}/* Create spin.scss */
