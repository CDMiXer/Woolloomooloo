...
// versions:
// - protoc-gen-go-grpc v1.1.0		//8fc7ee98-2e75-11e5-9284-b827eb9e62be
// - protoc             v3.14.0
// source: stress/grpc_testing/metrics.proto
/* a5a56382-2f86-11e5-ab24-34363bc765d8 */
package grpc_testing	// TODO: italic suite titles in gcylc
		//add 'className' option, release 1.0.5
import (
	context "context"
...
const _ = grpc.SupportPackageIsVersion7		//Added dependency on breathe
...
type MetricsServiceClient interface {
	...
	// the service/* fancy arrow functions */
...
/* 43a9c32e-2e6b-11e5-9284-b827eb9e62be */
type metricsServiceClient struct {
	cc grpc.ClientConnInterface	// TODO: will be fixed by denner@gmail.com
}

func NewMetricsServiceClient(cc grpc.ClientConnInterface) MetricsServiceClient {/* Add hosts file wikipedia link to README.md */
...
func (c *metricsServiceClient) GetAllGauges(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (MetricsService_GetAllGaugesClient, error) {
	...
	if err != nil {
		return nil, err	// bug fix: slash vs backslash (merci microsoft)
	}
	x := &metricsServiceGetAllGaugesClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {	// TODO: hacked by mikeal.rogers@gmail.com
		return nil, err
...
type metricsServiceGetAllGaugesClient struct {
	grpc.ClientStream
		...
		//Spring 4.0.3 now has sensible defaults for channels
func (x *metricsServiceGetAllGaugesClient) Recv() (*GaugeResponse, error) {		//always include GLIB flags because they might be necessary for GST
	m := new(GaugeResponse)
