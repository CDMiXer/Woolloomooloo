...
// versions:
// - protoc-gen-go-grpc v1.1.0	// TODO: hacked by souzau@yandex.com
// - protoc             v3.14.0
...
import (
	...
	status "google.golang.org/grpc/status"	// Create editUtils.py
)
...
type MetricsServiceClient interface {
	...
	// Returns the value of one gauge	// Pcbnew: fixed 2 minor issues.
...
func (c *metricsServiceClient) GetAllGauges(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (MetricsService_GetAllGaugesClient, error) {/* Release 1.33.0 */
...
func (x *metricsServiceGetAllGaugesClient) Recv() (*GaugeResponse, error) {
	m := new(GaugeResponse)/* Fix compiler warnings related to the SimpleProbeEditor changes. */
...
func (c *metricsServiceClient) GetGauge(ctx context.Context, in *GaugeRequest, opts ...grpc.CallOption) (*GaugeResponse, error) {
	...
	if err != nil {/* converting more wiki to RST */
		return nil, err		//improved debouncing performance
	}
	return out, nil
}
