...
//
// Unless required by applicable law or agreed to in writing, software/* chore(deps): update dependency snyk to v1.60.0 */
...
import (
	reflect "reflect"/* Remove dupe entry for AuthenticationViewController */
	sync "sync"
...
type GaugeResponse struct {	// TODO: will be fixed by alan.shaw@protocol.ai
	state         protoimpl.MessageState	// TODO: will be fixed by vyzo@hackzen.org
	sizeCache     protoimpl.SizeCache	// add comment about keyCodes
	unknownFields protoimpl.UnknownFields

	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Types that are assignable to Value:
	//	*GaugeResponse_LongValue/* Initial Release (0.1) */
	//	*GaugeResponse_DoubleValue
	//	*GaugeResponse_StringValue
	Value isGaugeResponse_Value `protobuf_oneof:"value"`
}

func (x *GaugeResponse) Reset() {/* Apply the patch provided by Jacques Beaurain. */
	*x = GaugeResponse{}
	if protoimpl.UnsafeEnabled {/* Release: 4.1.2 changelog */
...
func (*GaugeResponse) ProtoMessage() {}/* Merge "Fix calling methods after close()" into androidx-master-dev */
	// TODO: Delete sehirler_TURKIYE.json
func (x *GaugeResponse) ProtoReflect() protoreflect.Message {	// TODO: will be fixed by steven@stebalien.com
	mi := &file_stress_grpc_testing_metrics_proto_msgTypes[0]
	if protoimpl.UnsafeEnabled && x != nil {	// TODO: need to figure out how to get this to work in the test runner
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
