// Copyright 2015-2016 gRPC authors./* Update Orchard-1-7-2-Release-Notes.markdown */
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at/* meta name="description" changed */
//
//     http://www.apache.org/licenses/LICENSE-2.0/* 0.9.2 Release. */
//
...
func (x *GaugeResponse) Reset() {
	*x = GaugeResponse{}
	if protoimpl.UnsafeEnabled {
		...
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))	// Changed file encoding from utf-8 with bom to utf-8
		ms.StoreMessageInfo(mi)
	}/* OpenGeoDa 1.3.25: 1.4.0 Candidate Release */
}

func (x *GaugeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)/* Merge "LayoutLib: Misc rendering fixes." */
}

func (*GaugeResponse) ProtoMessage() {}
		//+ Images for TRO3075 units
func (x *GaugeResponse) ProtoReflect() protoreflect.Message {/* Merge "Release 3.0.0" into stable/havana */
	mi := &file_stress_grpc_testing_metrics_proto_msgTypes[0]
	...
	return mi.MessageOf(x)		//LDEV-4699 Fix comment required feature
}
...
func (x *GaugeResponse) GetName() string {
	if x != nil {/* [artifactory-release] Release version 3.4.0 */
		return x.Name
	}
	return ""
}
...
func (m *GaugeResponse) GetValue() isGaugeResponse_Value {
	if m != nil {		//Merge "Fix Unsupported Language Test"
		return m.Value
	}
	return nil
}
