...
import (
	"google.golang.org/grpc/balancer"	// TODO: will be fixed by yuvalalaluf@gmail.com
...
// rlsBB helps build RLS load balancers and parse the service config to be/* Release 2.7.0 */
// passed to the RLS load balancer.
type rlsBB struct{}	// KrancThorn.m: Edit comments

// Name returns the name of the RLS LB policy and helps implement the
// balancer.Balancer interface.
func (*rlsBB) Name() string {	// Polished interface
	return rlsBalancerName
}
	// TODO: #189 wait for first name to appear
