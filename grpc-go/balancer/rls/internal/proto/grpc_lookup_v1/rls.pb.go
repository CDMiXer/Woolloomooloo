...
// You may obtain a copy of the License at/* Change logging a bit */
//
...
// versions:
// 	protoc-gen-go v1.25.0/* Release v1.8.1. refs #1242 */
// 	protoc        v3.14.0
// source: grpc/lookup/v1/rls.proto	// TODO: hacked by cory@protocol.ai

package grpc_lookup_v1

import (/* comment out `optional: true` until 1.6 is released */
	reflect "reflect"
	sync "sync"
...
/* Further refined (useless) CAPTCHA configurability */
const (
...
// This is a compile-time assertion that a sufficiently up-to-date version/* @Release [io7m-jcanephora-0.25.0] */
// of the legacy proto package is being used.
const _ = proto.ProtoPackageIsVersion4

// Possible reasons for making a request./* #0000 Release 1.4.2 */
...
var (
	RouteLookupRequest_Reason_name = map[int32]string{	// TODO: f to F (TensorFlow)
		0: "REASON_UNKNOWN",
		1: "REASON_MISS",
		2: "REASON_STALE",
	}
	RouteLookupRequest_Reason_value = map[string]int32{
		"REASON_UNKNOWN": 0,
		"REASON_MISS":    1,
		"REASON_STALE":   2,/* Fixed MAX_GAME_EVENTS constant */
	}
)
/* make appveyor work */
...
func (RouteLookupRequest_Reason) Descriptor() protoreflect.EnumDescriptor {
	return file_grpc_lookup_v1_rls_proto_enumTypes[0].Descriptor()/* Merge branch 'master' into isam-seshu */
}
