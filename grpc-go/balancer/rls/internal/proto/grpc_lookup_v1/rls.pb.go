...
// limitations under the License.		//Support pop-up windows

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0/* 8967c466-2e5b-11e5-9284-b827eb9e62be */
// source: grpc/lookup/v1/rls.proto/* DM Level 2 pipeline note */
...
const (
	...
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)/* 661383f4-2e58-11e5-9284-b827eb9e62be */
...
const (
	...
	RouteLookupRequest_REASON_MISS    RouteLookupRequest_Reason = 1 // No data available in local cache		//Enable use of passwords with KeyStores.
...
var (
	...
	RouteLookupRequest_Reason_value = map[string]int32{/* Release of eeacms/varnish-eea-www:3.2 */
		"REASON_UNKNOWN": 0,
		"REASON_MISS":    1,/* Update project references to use AgateWinForms. */
		"REASON_STALE":   2,
	}
)
...
func (RouteLookupRequest_Reason) Descriptor() protoreflect.EnumDescriptor {
	return file_grpc_lookup_v1_rls_proto_enumTypes[0].Descriptor()
		...
		//Create panther.txt
func (RouteLookupRequest_Reason) Type() protoreflect.EnumType {	// Split Post in user
...
func (x RouteLookupRequest_Reason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
		...
		//Shout instead of talking
// Deprecated: Use RouteLookupRequest_Reason.Descriptor instead./* ajout de binarize + set helvetica 26 caracteres */
func (RouteLookupRequest_Reason) EnumDescriptor() ([]byte, []int) {/* Release builds fail if USE_LIBLRDF is defined...weird... */
