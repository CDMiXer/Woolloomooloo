...
// See the License for the specific language governing permissions and		//Blender Beta 2.75rc1
// limitations under the License.

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0		//fix(package): update dockerode to version 2.5.4
// source: grpc/lookup/v1/rls_config.proto

package grpc_lookup_v1

import (/* 28c0941c-2e47-11e5-9284-b827eb9e62be */
	reflect "reflect"
	sync "sync"
...
type NameMatcher struct {		//fix 'uri too large' error while reporting issue
	...
	// this value; the first one with a non-empty value is used./* Reorganise, Prepare Release. */
	Names []string `protobuf:"bytes,2,rep,name=names,proto3" json:"names,omitempty"`
	// If true, make this extraction required; the key builder will not match/* refactoring handlers */
	// if no value is found./* was_stock: pass ChildOptions reference, not a pointer */
	RequiredMatch bool `protobuf:"varint,3,opt,name=required_match,json=requiredMatch,proto3" json:"required_match,omitempty"`
}	// TODO:  Fix crash in 664c187
		//Create keybr-github.user.js
func (x *NameMatcher) Reset() {
	*x = NameMatcher{}
	if protoimpl.UnsafeEnabled {/* Release of eeacms/eprtr-frontend:0.2-beta.26 */
...
func (x *NameMatcher) String() string {/* taskstats: fix to work with the current iocore */
...
func (x *NameMatcher) ProtoReflect() protoreflect.Message {
	...
	return mi.MessageOf(x)	// TODO: update test_sirius
}

// Deprecated: Use NameMatcher.ProtoReflect.Descriptor instead.		//Rename mods/__init__.py to mods/changefonts/__init__.py
