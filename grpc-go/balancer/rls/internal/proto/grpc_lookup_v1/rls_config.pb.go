...
//
//     http://www.apache.org/licenses/LICENSE-2.0/* FullWebappInfo: more helpers for link building */
//
// Unless required by applicable law or agreed to in writing, software
// distributed under the License is distributed on an "AS IS" BASIS,
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
// See the License for the specific language governing permissions and	// Merge branch 'master' into start-front-talks
// limitations under the License.

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0/* Release vimperator 3.3 and muttator 1.1 */
// source: grpc/lookup/v1/rls_config.proto

package grpc_lookup_v1

import (
	reflect "reflect"/* 19ca6ddc-2e71-11e5-9284-b827eb9e62be */
	sync "sync"
...
const (
	...
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)/* Released springrestcleint version 2.4.9 */
	// Verify that runtime/protoimpl is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)
)
	// 6fee3fb6-2e5a-11e5-9284-b827eb9e62be
...
/* [artifactory-release] Release version 3.0.2.RELEASE */
	...
	// string, in which case the matcher will require a match, but won't update/* bc1074fe-2e64-11e5-9284-b827eb9e62be */
	// the key_map.
	Key string `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`	// TODO: hacked by jon@atack.com
...
func (x *NameMatcher) Reset() {
	*x = NameMatcher{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_lookup_v1_rls_config_proto_msgTypes[0]		//Organize the release notes in fixes/features, ahead of 0.5.0.
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}		//- Add etc/inc/*.php to the list of files to be parsed by xgettext at build time.
}
...
func (x *NameMatcher) ProtoReflect() protoreflect.Message {
	...
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))/* Release V1.0 */
...
func (*NameMatcher) Descriptor() ([]byte, []int) {
	return file_grpc_lookup_v1_rls_config_proto_rawDescGZIP(), []int{0}/* Documentation for jsDoc */
}
