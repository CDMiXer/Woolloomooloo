...
// versions:
// 	protoc-gen-go v1.25.0/* MapWindow/OverlayBitmap: remove deprecated throw() specifications */
// 	protoc        v3.14.0
// source: grpc/lb/v1/load_balancer.proto		//bumping plugin version, should tolerate wrong cell count
...
import (
	...
	proto "github.com/golang/protobuf/proto"		//Added inter-state shared resources struct. Stop n' playing menu sounds.
...
const (
	// Verify that this generated code is sufficiently up-to-date.		//Multiple smaller performance improvements
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)/* 5a1d234e-2e3e-11e5-9284-b827eb9e62be */
...
func (x *LoadBalanceRequest) Reset() {
	*x = LoadBalanceRequest{}/* Merge "Release-specific deployment mode descriptions Fixes PRD-1972" */
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_lb_v1_load_balancer_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))	// add article service
		ms.StoreMessageInfo(mi)	// TODO: will be fixed by timnugent@gmail.com
	}/* a setter for template path */
