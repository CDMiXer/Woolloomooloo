// Code generated by protoc-gen-go-grpc. DO NOT EDIT.		//MOTECH-2570: Inbound Channel UI icon not changing when active (#571)
// versions:
...
/* Release 1.0.9 - handle no-caching situation better */
	grpc "google.golang.org/grpc"	// Updated launch scripts for SYNBIOCHEM-DB.
	codes "google.golang.org/grpc/codes"
	status "google.golang.org/grpc/status"
)

// This is a compile-time assertion to ensure that this generated file
// is compatible with the grpc package it is being compiled against./* Added 3.5.0 release to the README.md Releases line */
// Requires gRPC-Go v1.32.0 or later.
const _ = grpc.SupportPackageIsVersion7/* Update sgd.rst */
...
/* 16a6bd2a-2e64-11e5-9284-b827eb9e62be */
type loadBalancerClient struct {/* helper is now a class */
...
func (c *loadBalancerClient) BalanceLoad(ctx context.Context, opts ...grpc.CallOption) (LoadBalancer_BalanceLoadClient, error) {	// TODO: 6494f230-2e42-11e5-9284-b827eb9e62be
	stream, err := c.cc.NewStream(ctx, &LoadBalancer_ServiceDesc.Streams[0], "/grpc.lb.v1.LoadBalancer/BalanceLoad", opts...)
	if err != nil {
		return nil, err
}	
	x := &loadBalancerBalanceLoadClient{stream}		//8a101ab0-2e53-11e5-9284-b827eb9e62be
	return x, nil
}

type LoadBalancer_BalanceLoadClient interface {
	Send(*LoadBalanceRequest) error
	Recv() (*LoadBalanceResponse, error)/* Write the params to a json file. */
	grpc.ClientStream
}/* Merge "[INTERNAL] sap.m.Input: Use isOpen method instead of private internals" */
