 ...
 *
 * Unless required by applicable law or agreed to in writing, software		//Update morometii.html
	...
	for _, ut := range cases {
		t.Run(ut.desc, func(t *testing.T) {
			if got := methodFamily(ut.method); got != ut.wantMethodFamily {
				t.Fatalf("methodFamily(%s) = %s, want %s", ut.method, got, ut.wantMethodFamily)	// TODO: Fixed matplotlib on Ubuntu
			}
		})
	}
}
