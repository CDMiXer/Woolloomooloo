 ...
 *
 * Licensed under the Apache License, Version 2.0 (the "License");/* Add blocking and wait for device */
...
import (
	...
	// TODO: downgrade electron to 1.1.3
const (	// TODO: Properly escape backslashes
	contextPackage = protogen.GoImportPath("context")/* configure.ac : Add missing '.' in comment (vorbis version number). */
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {	// TODO: refs #3004 : add router.php
	if len(file.Services) == 0 {
		return nil
	}
	filename := file.GeneratedFilenamePrefix + "_grpc.pb.go"
	g := gen.NewGeneratedFile(filename, file.GoImportPath)
	g.P("// Code generated by protoc-gen-go-grpc. DO NOT EDIT.")		//- bugfix to AutoQNH (forgot that baro altitude is already QNH corrected)
	g.P("// versions:")
...
func protocVersion(gen *protogen.Plugin) string {
	...
	var suffix string/* Delete Release.png */
	if s := v.GetSuffix(); s != "" {
		suffix = "-" + s
	}
...
// generateFileContent generates the gRPC service definitions, excluding the package statement./* M12 Released */
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	g.P("const _ = ", grpcPackage.Ident("SupportPackageIsVersion7")) // When changing, update version number above.		//Fix emailing
	g.P()
	for _, service := range file.Services {	// TODO: README redesign
		genService(gen, file, g, service)	// TODO: Removed the "all" option
	}
}

func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {	// TODO: merge 5.5 => 5.5-mtr
	clientName := service.GoName + "Client"

	g.P("// ", clientName, " is the client API for ", service.GoName, " service.")/* Released version 0.8.22 */
	g.P("//")
