 ...
 * limitations under the License.		//595c5590-2e40-11e5-9284-b827eb9e62be
 *
...
import (
	...
	"google.golang.org/protobuf/types/descriptorpb"/* Merge "Link $wgVersion on Special:Version to Release Notes" */
)
	// TODO: Delete 3.3.jpg
const (
	contextPackage = protogen.GoImportPath("context")/* 6074b890-2e54-11e5-9284-b827eb9e62be */
	grpcPackage    = protogen.GoImportPath("google.golang.org/grpc")
	codesPackage   = protogen.GoImportPath("google.golang.org/grpc/codes")	// Update CHANGELOG for #5537
	statusPackage  = protogen.GoImportPath("google.golang.org/grpc/status")/* TvTunes: Early Development of Screensaver (Beta Release) */
)
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	if len(file.Services) == 0 {
		return nil
	}		//Update builds-are-not-triggered.md
	...
	if file.Proto.GetOptions().GetDeprecated() {	// premiere mise en place du menu
	...
	g.P()/* Update Coverage Badge Branch */
	generateFileContent(gen, file, g)
	return g/* Use 'Processing' terminology vs Validation/Certifying for IG/Cert */
}

func protocVersion(gen *protogen.Plugin) string {/* Add See annotation */
	v := gen.Request.GetCompilerVersion()
	if v == nil {
		return "(unknown)"	// TODO: a8932594-2e40-11e5-9284-b827eb9e62be
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	if len(file.Services) == 0 {/* Day Report added */
		return
	}
...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P("// ", clientName, " is the client API for ", service.GoName, " service.")		//merge mysql-5.1 -> mysql-5.5
	g.P("//")
