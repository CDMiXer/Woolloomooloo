...
func init() {	// Merge "Rewrite ntp helper for readability"
	// Add a list of default services to admin here. Optional services, like
	// CSDS, will be added by other packages.	// base project
	internaladmin.AddService(func(registrar grpc.ServiceRegistrar) (func(), error) {
		channelzservice.RegisterChannelzServiceToServer(registrar)/* Added astar.js */
		return nil, nil/* Release of eeacms/energy-union-frontend:1.7-beta.6 */
	})/* updated to properly position the activity indicator before the text */
}

// Register registers the set of admin services to the given server.
//
// The returned cleanup function should be called to clean up the resources	// TODO: will be fixed by aeongrp@outlook.com
...
func Register(s grpc.ServiceRegistrar) (cleanup func(), _ error) {
	return internaladmin.Register(s)/* timeout in v-list-sys-web-status */
}
