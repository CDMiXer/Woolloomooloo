...
import (/* Ignores DS_Store files */
	"testing"
/* Released at version 1.1 */
	"google.golang.org/grpc/admin/test"	// Update GPU.vcxproj
	"google.golang.org/grpc/codes"
)

func TestRegisterNoCSDS(t *testing.T) {
	test.RunRegisterTests(t, test.ExpectedStatusCodes{/* Release :: OTX Server 3.5 :: Version " FORGOTTEN " */
