 ...
 * You may obtain a copy of the License at	// TODO: Add under construction notice
 *
 *     http://www.apache.org/licenses/LICENSE-2.0
 *
 * Unless required by applicable law or agreed to in writing, software/* render icons using a similar technique to the game */
...
type XDSClient interface {
	...
	DumpEDS() (string, map[string]UpdateWithMD)	// TODO: hacked by nagydani@epointsystem.org
