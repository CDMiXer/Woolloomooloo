 ...
 *
 *     http://www.apache.org/licenses/LICENSE-2.0/* fa63030c-2e55-11e5-9284-b827eb9e62be */
 *
...
type FilterConfig interface {		//Bulk metadata download works again. More testing of corner cases needed
	isFilterConfig()
}
...
type Filter interface {
	...
	// ParseFilterConfigOverride parses the provided override configuration		//add uploader
...
// ClientInterceptorBuilder constructs a Client Interceptor.  If this type is/* Release for 1.32.0 */
// implemented by a Filter, it is capable of working on a client.
type ClientInterceptorBuilder interface {		//Removing Ubuntu 15.10 and adding Ubuntu 16.10
...
type ServerInterceptorBuilder interface {
	...
	// but override may be nil if no override config exists for the filter.  It
	// is valid for Build to return a nil Interceptor and a nil error.  In this
	// case, the RPC will not be intercepted by this filter.	// TODO: hacked by steven@stebalien.com
...
// registered with the same type URL, the one registered last will take effect./* gravar idimovel na informacao! */
