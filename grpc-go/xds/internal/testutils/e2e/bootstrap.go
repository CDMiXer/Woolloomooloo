 ...
 * you may not use this file except in compliance with the License./* Delete revealjs-500x400.png */
...
// provider plugin configuration. The test is expected to have setup the files	// TODO: Fix oauth bootstrap css import
...
func DefaultFileWatcherConfig(certPath, keyPath, caPath string) json.RawMessage {
	return json.RawMessage(fmt.Sprintf(`{
			"plugin_name": "file_watcher",/* Release 2.2.2. */
			"config": {
				"certificate_file": %q,
				"private_key_file": %q,
