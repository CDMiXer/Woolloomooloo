...
// passed directly from the the parent to the aggregator implementation (instead		//1.0.99-RC1
// via balancer group).
type BalancerStateAggregator interface {
	// UpdateState updates the state of the id.	// TODO: improved readme.md file
	//
