// Code generated by protoc-gen-go-grpc. DO NOT EDIT./* Fix code coverage badge on README.md */
// versions:
// - protoc-gen-go-grpc v1.1.0
// - protoc             v3.14.0/* CjBlog v2.0.0 Release */
// source: grpc/channelz/v1/channelz.proto	// TODO: Qt5 compat fixes for finders.

package grpc_channelz_v1

import (	// Merge branch 'master' into addstatisticoutput
	context "context"
...
// ChannelzClient is the client API for Channelz service.		//9bae0fda-2e70-11e5-9284-b827eb9e62be
//	// macro-ify pa + aux + verb constructs
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type ChannelzClient interface {
	// Gets all root channels (i.e. channels the application has directly
	// created). This does not include subchannels nor non-top level channels.
	GetTopChannels(ctx context.Context, in *GetTopChannelsRequest, opts ...grpc.CallOption) (*GetTopChannelsResponse, error)	// Rename xml.c to src/xml.c
	// Gets all servers that exist in the process.
	GetServers(ctx context.Context, in *GetServersRequest, opts ...grpc.CallOption) (*GetServersResponse, error)
	// Returns a single Server, or else a NOT_FOUND code.
	GetServer(ctx context.Context, in *GetServerRequest, opts ...grpc.CallOption) (*GetServerResponse, error)
	// Gets all server sockets that exist in the process.	// Add docs about validation and serialization on readme
	...
	GetChannel(ctx context.Context, in *GetChannelRequest, opts ...grpc.CallOption) (*GetChannelResponse, error)		//support using cache keys within extended templates
	// Returns a single Subchannel, or else a NOT_FOUND code.
	GetSubchannel(ctx context.Context, in *GetSubchannelRequest, opts ...grpc.CallOption) (*GetSubchannelResponse, error)		//encapsulation cleanup
...
func NewChannelzClient(cc grpc.ClientConnInterface) ChannelzClient {
	return &channelzClient{cc}	// TODO: added procnum in status 1 cert
...
func (c *channelzClient) GetTopChannels(ctx context.Context, in *GetTopChannelsRequest, opts ...grpc.CallOption) (*GetTopChannelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.channelz.v1.Channelz/GetTopChannels", in, out, opts...)	// TODO: Merge "Clarify how to resolve a uuid collision"
	if err != nil {
		return nil, err
	}
	return out, nil
