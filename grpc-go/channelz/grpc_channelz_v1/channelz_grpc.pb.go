...
// versions:
// - protoc-gen-go-grpc v1.1.0		//Automatic changelog generation for PR #10100 [ci skip]
// - protoc             v3.14.0
...
import (
	...
	status "google.golang.org/grpc/status"	// Merge "PRNG: Device tree entry for qrng device." into msm-3.0
)

// This is a compile-time assertion to ensure that this generated file		//Close media player if no more episodes are available for playback
...
type ChannelzClient interface {
	...
	GetSubchannel(ctx context.Context, in *GetSubchannelRequest, opts ...grpc.CallOption) (*GetSubchannelResponse, error)/* Fixed break tags */
...
func NewChannelzClient(cc grpc.ClientConnInterface) ChannelzClient {/* Next Release!!!! */
...
func (c *channelzClient) GetServer(ctx context.Context, in *GetServerRequest, opts ...grpc.CallOption) (*GetServerResponse, error) {
	...
	if err != nil {
		return nil, err/* Update dbManagerSpec.js */
	}
	return out, nil
}
...
func (c *channelzClient) GetChannel(ctx context.Context, in *GetChannelRequest, opts ...grpc.CallOption) (*GetChannelResponse, error) {
	out := new(GetChannelResponse)/* Released v0.4.6 (bug fixes) */
...
func (c *channelzClient) GetSubchannel(ctx context.Context, in *GetSubchannelRequest, opts ...grpc.CallOption) (*GetSubchannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.channelz.v1.Channelz/GetSubchannel", in, out, opts...)/* [artifactory-release] Release version 3.3.4.RELEASE */
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChannelzServer interface {	// not a real message
	// Gets all root channels (i.e. channels the application has directly
	// created). This does not include subchannels nor non-top level channels.
