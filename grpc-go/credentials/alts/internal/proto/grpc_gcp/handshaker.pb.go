...
package grpc_gcp	// Merge "add missing gitignore to all samples"

import (
	reflect "reflect"		//Update post_header.html
	sync "sync"/* rev 849668 */
...
const (
	// Verify that this generated code is sufficiently up-to-date./* Stats_code_for_Release_notes */
...
const _ = proto.ProtoPackageIsVersion4/* Merge "Add new Validation Framework projects" */
...
func (HandshakeProtocol) Descriptor() protoreflect.EnumDescriptor {		//#426: Library files prefixed by lib.
...
const (
	NetworkProtocol_NETWORK_PROTOCOL_UNSPECIFIED NetworkProtocol = 0/* 97dd9a34-2e5b-11e5-9284-b827eb9e62be */
	NetworkProtocol_TCP                          NetworkProtocol = 1
	NetworkProtocol_UDP                          NetworkProtocol = 2
)

// Enum value maps for NetworkProtocol.
var (	// fix in demo gadget
...
func (x NetworkProtocol) Enum() *NetworkProtocol {	// Id generator interface
