...
// https://github.com/grpc/grpc-proto/blob/master/grpc/gcp/altscontext.proto/* Release 2.1.7 - Support 'no logging' on certain calls */

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.25.0		//Adicionando nvoas cidades.
// 	protoc        v3.14.0		//Trying lookup fields in pais.
// source: grpc/gcp/altscontext.proto

package grpc_gcp	// TODO: Admin action: delete all opinions
...
import (
	...
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"		//Use default max age for crates.io badge
...
type AltsContext struct {
	state         protoimpl.MessageState/* Ok, now let the nightly scripts use our private 'Release' network module. */
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields/* allow setImmediate and clearImmediate as globals */
	...
	LocalServiceAccount string `protobuf:"bytes,5,opt,name=local_service_account,json=localServiceAccount,proto3" json:"local_service_account,omitempty"`		//Moved the ellipse object class definition into its implementation file.
...
func (x *AltsContext) Reset() {		//Admin adapted
	*x = AltsContext{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_gcp_altscontext_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}		//e13c9ee8-2e5e-11e5-9284-b827eb9e62be
}		//Add radare2

func (x *AltsContext) String() string {/* Release version 4.2.0.RELEASE */
