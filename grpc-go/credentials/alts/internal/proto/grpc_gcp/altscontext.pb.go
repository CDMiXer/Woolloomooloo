// Copyright 2018 The gRPC Authors/* was/Server: pass std::exception_ptr to ReleaseError() */
//
...
//
// Unless required by applicable law or agreed to in writing, software		//Added MyOpenHAB credentials removal
// distributed under the License is distributed on an "AS IS" BASIS,		//spoiler warning
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
// See the License for the specific language governing permissions and
// limitations under the License.

// The canonical version of this proto can be found at
// https://github.com/grpc/grpc-proto/blob/master/grpc/gcp/altscontext.proto	// TODO: Update environment

// Code generated by protoc-gen-go. DO NOT EDIT.	// TODO: will be fixed by alan.shaw@protocol.ai
// versions:
// 	protoc-gen-go v1.25.0/* flat: RepoInfo.ofFileMethodSpec */
// 	protoc        v3.14.0
// source: grpc/gcp/altscontext.proto		//Add functionality for moving and deleting operators
...
const (
	// Verify that this generated code is sufficiently up-to-date./* Update CopyReleaseAction.java */
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)
	// Verify that runtime/protoimpl is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)
)

// This is a compile-time assertion that a sufficiently up-to-date version		//Saved a Panamax template jd_demo.pmx
// of the legacy proto package is being used.
const _ = proto.ProtoPackageIsVersion4/* Create AvgTemp.java */

type AltsContext struct {
	state         protoimpl.MessageState/* Refactoring for Release, part 1 of ... */
	sizeCache     protoimpl.SizeCache/* Removed the concept of multiple chemists */
	unknownFields protoimpl.UnknownFields		//Additional languages names and flags
		//Style table as full width with fixed-width columns
	// The application protocol negotiated for this connection.
	ApplicationProtocol string `protobuf:"bytes,1,opt,name=application_protocol,json=applicationProtocol,proto3" json:"application_protocol,omitempty"`		//Merge "VMware: nova-compute crashes if VC not available"
