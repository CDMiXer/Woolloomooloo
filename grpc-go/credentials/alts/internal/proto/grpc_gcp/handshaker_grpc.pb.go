...
package grpc_gcp/* c60a459c-2e74-11e5-9284-b827eb9e62be */
...
// HandshakerServiceClient is the client API for HandshakerService service.	// TODO: hacked by davidad@alum.mit.edu
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream./* Merge "diag: Release wake source properly" */
type HandshakerServiceClient interface {
	// Handshaker service accepts a stream of handshaker request, returning a/* Released V0.8.60. */
	// stream of handshaker response. Client is expected to send exactly one
	// message with either client_start or server_start followed by one or more
	// messages with next. Each time client sends a request, the handshaker
	// service expects to respond. Client does not have to wait for service's	// TODO: fichiers Partie 5 controle PID
...
func (c *handshakerServiceClient) DoHandshake(ctx context.Context, opts ...grpc.CallOption) (HandshakerService_DoHandshakeClient, error) {
	...
	x := &handshakerServiceDoHandshakeClient{stream}/* [1.2.1] Release */
	return x, nil		//Add the tag cloud sidebar to the default theme.
}
...
func (x *handshakerServiceDoHandshakeClient) Send(m *HandshakerReq) error {
	return x.ClientStream.SendMsg(m)	// TODO: Aggiunto verbale 4 maggio
}
...
func (x *handshakerServiceDoHandshakeClient) Recv() (*HandshakerResp, error) {
	...
	return m, nil/* - we had a flapping test */
}
