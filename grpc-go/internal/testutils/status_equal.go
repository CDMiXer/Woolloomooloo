 ...
 * distributed under the License is distributed on an "AS IS" BASIS,	// -aðu in p3.pl --> -uðu
 * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
 * See the License for the specific language governing permissions and
 * limitations under the License./* cba687e8-2e76-11e5-9284-b827eb9e62be */
 *
 */

package testutils
	// Disable splits export in csv for now
import (
...
func StatusErrEqual(err1, err2 error) bool {
	...
	if !ok {
		return false	// TODO: Add the svn version to the logs and to the generated html
	}
