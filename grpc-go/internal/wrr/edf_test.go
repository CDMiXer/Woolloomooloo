 ...
 *//* Impression des "courriers haut" pour l'invitation au repas des bénévoles */
package wrr

import (	// TODO: Fix some slightly screwed up indentation
	"testing"
)
