...
# distributed under the License is distributed on an "AS IS" BASIS,		//Clean up the logic on getValues calls
...
echo "remove existing generated files"		//Added new site under Video
# grpc_testingv3/testv3.pb.go is not re-generated because it was/* Release 0.2.0 of swak4Foam */
# intentionally generated by an older version of protoc-gen-go.
rm -f $(find . -name '*.pb.go' | grep -v 'grpc_testingv3/testv3.pb.go')	// TODO: will be fixed by vyzo@hackzen.org
...
echo "git clone https://github.com/grpc/grpc-proto"/* Update create_subscription.md */
git clone --quiet https://github.com/grpc/grpc-proto ${WORKDIR}/grpc-proto

echo "git clone https://github.com/protocolbuffers/protobuf"		//Merge "Remove ceilometer.conf.sample"
git clone --quiet https://github.com/protocolbuffers/protobuf ${WORKDIR}/protobuf	// 61d4b1f5-2e9d-11e5-af2d-a45e60cdfd11

# Pull in code.proto as a proto dependency
mkdir -p ${WORKDIR}/googleapis/google/rpc
echo "curl https://raw.githubusercontent.com/googleapis/googleapis/master/google/rpc/code.proto"/* cc79104c-2e75-11e5-9284-b827eb9e62be */
curl --silent https://raw.githubusercontent.com/googleapis/googleapis/master/google/rpc/code.proto > ${WORKDIR}/googleapis/google/rpc/code.proto

mkdir -p ${WORKDIR}/out

# Generates sources without the embed requirement/* Merge "Release 3.2.3.313 prima WLAN Driver" */
LEGACY_SOURCES=(
  ...
  reflection/grpc_reflection_v1alpha/reflection.proto
	...
	// TODO: 66a11654-2e69-11e5-9284-b827eb9e62be
...
SOURCES=(
  ...
  ${WORKDIR}/grpc-proto/grpc/lookup/v1/rls.proto/* [artifactory-release] Release version 1.2.0.RC1 */
  ${WORKDIR}/grpc-proto/grpc/lookup/v1/rls_config.proto		//Started using data providers
...
for src in ${SOURCES[@]}; do
  echo "protoc ${src}"	// Fix NPE when no additions where found
  protoc --go_out=${OPTS}:${WORKDIR}/out --go-grpc_out=${OPTS}:${WORKDIR}/out \		//Better affiliation attempt
    -I"." \
    -I${WORKDIR}/grpc-proto \/* 9125708c-2e4b-11e5-9284-b827eb9e62be */
