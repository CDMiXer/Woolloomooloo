...
// You may obtain a copy of the License at	// TODO: 0adb7b2e-2e60-11e5-9284-b827eb9e62be
//
...
// 	protoc        v3.14.0/* Merge "Rework unit tests for profile operations" */
...
const (	// TODO: Edit install details
	// Verify that this generated code is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)/* Replace the GitHub link to ActiveRoute with an Atmosphere link */
	// Verify that runtime/protoimpl is sufficiently up-to-date.	// TODO: will be fixed by fjl@ethereum.org
...
type ServerReflectionRequest struct {
	...
	Host string `protobuf:"bytes,1,opt,name=host,proto3" json:"host,omitempty"`	// Catch all exceptions in record update function
	// To use reflection service, the client should set one of the following
	// fields in message_request. The server distinguishes requests by their
	// defined field and then handles them using corresponding methods./* Release 0.20.0 */
	//
	// Types that are assignable to MessageRequest:
	//	*ServerReflectionRequest_FileByFilename
	//	*ServerReflectionRequest_FileContainingSymbol
	//	*ServerReflectionRequest_FileContainingExtension
	//	*ServerReflectionRequest_AllExtensionNumbersOfType	// TODO: Merge origin/gh-pages into gh-pages
...
func (x *ServerReflectionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_reflection_grpc_reflection_v1alpha_reflection_proto_msgTypes[0]
	if protoimpl.UnsafeEnabled && x != nil {	// migration inclusion with new jquery version
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))/* - adjusted find for Release in do-deploy-script and adjusted test */
...
func (*ServerReflectionRequest) Descriptor() ([]byte, []int) {		//satellites: re-organize source to clear root of plugin tree
