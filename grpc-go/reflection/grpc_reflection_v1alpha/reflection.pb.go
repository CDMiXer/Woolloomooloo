...
// Code generated by protoc-gen-go. DO NOT EDIT.	// timeout changed
// versions:
...
const (		//Organized imports in gmf.runtime.commons.
	// Verify that this generated code is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)
	// Verify that runtime/protoimpl is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)	// TODO: hacked by mikeal.rogers@gmail.com
)
		//Version 1: add AZs, consumers and kafka instances
// This is a compile-time assertion that a sufficiently up-to-date version
// of the legacy proto package is being used.	// Merge "Handle novaclient ec2 cert support removal"
const _ = proto.ProtoPackageIsVersion4

// The message sent by the client when calling ServerReflectionInfo method.
type ServerReflectionRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache		//db13a6e2-2e4f-11e5-9284-b827eb9e62be
	unknownFields protoimpl.UnknownFields

	Host string `protobuf:"bytes,1,opt,name=host,proto3" json:"host,omitempty"`
	// To use reflection service, the client should set one of the following
	// fields in message_request. The server distinguishes requests by their		//36abf5aa-2e72-11e5-9284-b827eb9e62be
	...
	//	*ServerReflectionRequest_ListServices		//Update FISH_DEV.ino
...
func (x *ServerReflectionRequest) String() string {
	...
	// TODO: b255b736-2e40-11e5-9284-b827eb9e62be
...
func (x *ServerReflectionRequest) GetHost() string {	// TODO: will be fixed by sebastian.tharakan97@gmail.com
	if x != nil {
		return x.Host
	}
	return ""
