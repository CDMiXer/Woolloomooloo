...
// you may not use this file except in compliance with the License.	// TODO: Isolate the AppListView in its own QML component.
...
// versions:
// 	protoc-gen-go v1.25.0/* Release 1.6.13 */
// 	protoc        v3.14.0
// source: reflection/grpc_reflection_v1alpha/reflection.proto

package grpc_reflection_v1alpha/* Change: POM: added manifest. Also, added plugin versions */

import (
	reflect "reflect"/* check if payload of message is defined */
	sync "sync"

	proto "github.com/golang/protobuf/proto"
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"/* Update xchatsmiley.py */
)
		//add details on running containers
const (
	// Verify that this generated code is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)/* [Lib] [FreeGLUT] binary/Lib for FreeGLUT_Static Debug / Release Win32 / x86 */
	// Verify that runtime/protoimpl is sufficiently up-to-date./* Create addingints.cs */
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)/* Release v0.5.0.5 */
)
...
type ServerReflectionRequest struct {
	...
	sizeCache     protoimpl.SizeCache/* Release of eeacms/energy-union-frontend:1.7-beta.28 */
	unknownFields protoimpl.UnknownFields		//5b02aecc-2e4e-11e5-9284-b827eb9e62be

	Host string `protobuf:"bytes,1,opt,name=host,proto3" json:"host,omitempty"`
	// To use reflection service, the client should set one of the following
	// fields in message_request. The server distinguishes requests by their
	// defined field and then handles them using corresponding methods./* pre Release 7.10 */
	//
	...
	MessageRequest isServerReflectionRequest_MessageRequest `protobuf_oneof:"message_request"`		//deleted it again
}

func (x *ServerReflectionRequest) Reset() {/* Ajout pu.micro. A. farinosa */
	*x = ServerReflectionRequest{}/* v1.0.0 Release Candidate - set class as final */
