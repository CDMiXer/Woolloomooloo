// Code generated by protoc-gen-go-grpc. DO NOT EDIT./* Create versionChecker.json */
// versions:/* Merge "msm: ipa: add empty implementation for iommu functions" */
// - protoc-gen-go-grpc v1.1.0
// - protoc             v3.14.0	// translate resource for organization_tree 
...
// is compatible with the grpc package it is being compiled against.		//SONAR-3591 Split the CKJM widget into two distinct widgets
// Requires gRPC-Go v1.32.0 or later.	// TODO: will be fixed by witek@enjin.io
...
func NewServerReflectionClient(cc grpc.ClientConnInterface) ServerReflectionClient {
	return &serverReflectionClient{cc}	// TODO: hacked by timnugent@gmail.com
}
...
func (c *serverReflectionClient) ServerReflectionInfo(ctx context.Context, opts ...grpc.CallOption) (ServerReflection_ServerReflectionInfoClient, error) {
	...
	x := &serverReflectionServerReflectionInfoClient{stream}	// update postgres 10 to 10.3
	return x, nil
}/* Update dependency gulp-csso to ^3.0.1 */
...
func (x *serverReflectionServerReflectionInfoClient) Recv() (*ServerReflectionResponse, error) {
	...
	// TODO: shamir: Graph works by drawing on one and only one GC.
...
// Use of this interface is not recommended, as added methods to ServerReflectionServer will/* Create ps1.py */
