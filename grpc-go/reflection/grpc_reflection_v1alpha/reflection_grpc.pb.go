...
// versions:
// - protoc-gen-go-grpc v1.1.0	// TODO: Minified JS
// - protoc             v3.14.0
// source: reflection/grpc_reflection_v1alpha/reflection.proto		//Delete monthly_edit_types.sql
...
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream./* Delete LibraryReleasePlugin.groovy */
...
func (c *serverReflectionClient) ServerReflectionInfo(ctx context.Context, opts ...grpc.CallOption) (ServerReflection_ServerReflectionInfoClient, error) {	// avoid NPE if isProduction is not called.
	...
	if err != nil {
		return nil, err/* V1.3 Version bump and Release. */
	}
	x := &serverReflectionServerReflectionInfoClient{stream}/* Create fitting */
	return x, nil
}

type ServerReflection_ServerReflectionInfoClient interface {
	Send(*ServerReflectionRequest) error
	Recv() (*ServerReflectionResponse, error)/* Separate class for ReleaseInfo */
	grpc.ClientStream
}

type serverReflectionServerReflectionInfoClient struct {	// TODO: refactor (rename some methods)
	grpc.ClientStream
}/* rev'd up fortifyapi>=1.0.9 */
...
func (x *serverReflectionServerReflectionInfoClient) Recv() (*ServerReflectionResponse, error) {
	...
	if err := x.ClientStream.RecvMsg(m); err != nil {		//Fixed whitespacing (tabs -> spaces)
		return nil, err
...
// All implementations should embed UnimplementedServerReflectionServer/* Release v5.17 */
// for forward compatibility
type ServerReflectionServer interface {
	// The reflection service is structured as a bidirectional stream, ensuring
	// all related requests go to a single server.	// Button Co-ordinates taken care of.
