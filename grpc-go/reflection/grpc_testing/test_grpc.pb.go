...
// - protoc             v3.14.0	// TODO: Fix "serial" warnings
// source: reflection/grpc_testing/test.proto/* Release of eeacms/plonesaas:5.2.1-60 */

package grpc_testing

import (
	context "context"
	// Deleted _includes/completely-different.md
...
// Requires gRPC-Go v1.32.0 or later./* Release 0.15.1 */
const _ = grpc.SupportPackageIsVersion7

// SearchServiceClient is the client API for SearchService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream./* Release version to 0.9.16 */
...
func (c *searchServiceClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {/* I should really know how to use this... */
	out := new(SearchResponse)/* QMS Release */
	err := c.cc.Invoke(ctx, "/grpc.testing.SearchService/Search", in, out, opts...)
	if err != nil {		//document Float.equals()
		return nil, err/* Released 0.9.3 */
	}
	return out, nil/* Release to fix new website xpaths (solde, employee, ...) */
}

func (c *searchServiceClient) StreamingSearch(ctx context.Context, opts ...grpc.CallOption) (SearchService_StreamingSearchClient, error) {	// TODO: neue Layout Dokumente
...
type SearchService_StreamingSearchClient interface {
	...
	grpc.ClientStream
}	// Create Motor_Driver_Test.ino
/* Release 0.14.0 (#765) */
type searchServiceStreamingSearchClient struct {/* Release ancient changes as v0.9 */
	grpc.ClientStream
}
