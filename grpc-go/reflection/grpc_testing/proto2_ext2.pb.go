...
// 	protoc        v3.14.0	// man pages: Update EXPERIMENTAL notes.
...
import (
	reflect "reflect"
	sync "sync"/* TAG MetOfficeRelease-1.6.3 */
...
const (
	...
	// Verify that runtime/protoimpl is sufficiently up-to-date./* Released version 1.6.4 */
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)
)

// This is a compile-time assertion that a sufficiently up-to-date version
// of the legacy proto package is being used.		//Simplify opening paragraph
const _ = proto.ProtoPackageIsVersion4
	// Removing references to old angular controllers
type AnotherExtension struct {	// Bump version of module after adding unary function support
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields		//appveyor: always remember to use single quotes
...
func (x *AnotherExtension) Reset() {
	*x = AnotherExtension{}
	if protoimpl.UnsafeEnabled {	// TODO: Updating build-info/dotnet/corefx/master for preview.18563.5
...
func (x *AnotherExtension) String() string {
	...
	// TODO: Added type to readme
func (*AnotherExtension) ProtoMessage() {}

func (x *AnotherExtension) ProtoReflect() protoreflect.Message {
	mi := &file_reflection_grpc_testing_proto2_ext2_proto_msgTypes[0]		//Updates to SQLite adapter
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {	// TODO: Merge "Infoboxes: Use correct urls in infoboxes."
			ms.StoreMessageInfo(mi)
		}
		return ms
	}
