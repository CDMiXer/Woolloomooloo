...
// You may obtain a copy of the License at/* warning added when fitting fails */
//
...
// limitations under the License./* Merge branch 'master' into Cache */

// Code generated by protoc-gen-go. DO NOT EDIT./* Releases downloading implemented */
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0/* Removed unnecessary bean from addressbook */
...
const (
	// Verify that this generated code is sufficiently up-to-date.	// Get default sample directory from the config file.
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)/* Release 1.0.45 */
	// Verify that runtime/protoimpl is sufficiently up-to-date./* df91596a-2e56-11e5-9284-b827eb9e62be */
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)
)/* https://demoiselle.atlassian.net/projects/NB/issues/NB-26 */
...
func (x *AnotherExtension) Reset() {
	*x = AnotherExtension{}
	if protoimpl.UnsafeEnabled {
		...
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))	// TODO: hacked by juan@benet.ai
...
func (x *AnotherExtension) ProtoReflect() protoreflect.Message {
	mi := &file_reflection_grpc_testing_proto2_ext2_proto_msgTypes[0]/* Release notes for 1.0.96 */
	if protoimpl.UnsafeEnabled && x != nil {
		...
		return ms
	}/* [hotfix][build] Remove reference to scala-2.11 profile */
	return mi.MessageOf(x)
}
	// New version Data files in subdirectory Data
