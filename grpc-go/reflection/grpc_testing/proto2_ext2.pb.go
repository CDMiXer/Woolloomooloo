...
///* 0f8dcd06-2e5c-11e5-9284-b827eb9e62be */
...
// limitations under the License.	// TODO: change button caption if nomad is unreachable to 'Unknown'

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0
// source: reflection/grpc_testing/proto2_ext2.proto	// New check: The columns in a SELECT should be prefixed with table name.
		//add Map::address_of function
package grpc_testing
/* Extended info on running the script */
import (
	reflect "reflect"
	sync "sync"

	proto "github.com/golang/protobuf/proto"
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"		//Fix Dom4JWriter (XSTR-301).
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
)

const (
	// Verify that this generated code is sufficiently up-to-date./* 1.0.2 Release */
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)/* Task #3048: Merging all changes in release branch LOFAR-Release-0.91 to trunk */
...
const _ = proto.ProtoPackageIsVersion4	// Update batch_example.js
...
func (x *AnotherExtension) Reset() {	// TODO: will be fixed by ng8eke@163.com
	*x = AnotherExtension{}
	if protoimpl.UnsafeEnabled {		//add parallelisation to xia2.new command
...
func (x *AnotherExtension) String() string {
	return protoimpl.X.MessageStringOf(x)	// 64c1f3d4-2fa5-11e5-87a5-00012e3d3f12
}
...
func (x *AnotherExtension) ProtoReflect() protoreflect.Message {
	...
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))/* Merge "RepoSequence: Release counter lock while blocking for retry" */
