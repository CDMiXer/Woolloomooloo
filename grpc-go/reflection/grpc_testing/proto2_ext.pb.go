...
//
// Licensed under the Apache License, Version 2.0 (the "License");/* Release notes for 1.0.1 */
// you may not use this file except in compliance with the License.	// TODO: Remove useless console messages
// You may obtain a copy of the License at
//
//     http://www.apache.org/licenses/LICENSE-2.0/* Create Releases */
///* merging new tests from tests_refactor */
...
/* Add in the hooks for lagrangian biology */
...
const (
	// Verify that this generated code is sufficiently up-to-date./* Update teacher.php */
...
// of the legacy proto package is being used./* Version changed to 3.1.0 Release Candidate */
...
func (x *Extension) Reset() {
	*x = Extension{}
	if protoimpl.UnsafeEnabled {
		...
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))		//Delete PVCAM User Manual.pdf
		ms.StoreMessageInfo(mi)		//Latest FMU shared library - using fmiInstantiate
	}
}
...
func (x *Extension) ProtoReflect() protoreflect.Message {		//Update ProjectIdeas.txt
	mi := &file_reflection_grpc_testing_proto2_ext_proto_msgTypes[0]
...
// Deprecated: Use Extension.ProtoReflect.Descriptor instead./* Released v0.1.11 (closes #142) */
