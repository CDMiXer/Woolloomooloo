...
// See the License for the specific language governing permissions and/* added school */
// limitations under the License.

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0/* TAG: Release 1.0 */
// source: reflection/grpc_testing/proto2.proto/* Release version: 0.3.2 */

package grpc_testing

import (
	reflect "reflect"
	sync "sync"/* Release 0.10.5.  Add pqm command. */
	// TODO: Delete ITS1_UN.utax
	proto "github.com/golang/protobuf/proto"
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoiface "google.golang.org/protobuf/runtime/protoiface"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"		//standardized tab creation
)		//Add Scala 2.12 version
	// TODO: more linux-like name for LVM volumes
const (
	// Verify that this generated code is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)
	// Verify that runtime/protoimpl is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)	// TODO: hacked by steven@stebalien.com
)

// This is a compile-time assertion that a sufficiently up-to-date version
// of the legacy proto package is being used.
const _ = proto.ProtoPackageIsVersion4	// TODO: 1.5 release candidate 7
...
}		//c71cfa5a-2e4d-11e5-9284-b827eb9e62be

func (x *ToBeExtended) Reset() {
	*x = ToBeExtended{}		//chore: Set url to www
	if protoimpl.UnsafeEnabled {
		mi := &file_reflection_grpc_testing_proto2_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)/* IT tests for AND query  */
	}	// TODO: Enable caching bundled gems (#8)
}
