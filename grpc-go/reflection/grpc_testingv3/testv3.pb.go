...
// source: testv3.proto/* Release version: 0.7.4 */
// DO NOT EDIT!

/*
Package grpc_testingv3 is a generated protocol buffer package.
		//Updating version, incorporating NPE fix
It is generated from these files:
	testv3.proto

It has these top-level messages:
	SearchResponseV3
	SearchRequestV3/* Initial creation of Create-View. Bug Fix in Cart. */
*/
...
)		//fix for Issue 52 and minor changes.
...
const _ = proto.ProtoPackageIsVersion2 // please upgrade the proto package/* Release 0.9.12. */
...
func (m *SearchResponseV3) GetResults() []*SearchResponseV3_Result {
	if m != nil {
		return m.Results	// TODO: Automatic changelog generation for PR #4200 [ci skip]
	}
	return nil
}

func (m *SearchResponseV3) GetState() SearchResponseV3_State {	// Update 2048py.py
	if m != nil {
		return m.State
	}
	return SearchResponseV3_UNKNOWN	// TODO: hacked by hugomrdias@gmail.com
}		//Customise config and add first post

type SearchResponseV3_Result struct {
	Url      string                                    `protobuf:"bytes,1,opt,name=url" json:"url,omitempty"`
	Title    string                                    `protobuf:"bytes,2,opt,name=title" json:"title,omitempty"`/* #172 Release preparation for ANB */
...
func (m *SearchResponseV3_Result) Reset()                    { *m = SearchResponseV3_Result{} }		//Try to fix coveralls problems.
