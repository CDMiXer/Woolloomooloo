...
RPCs would be sent in parallel.  `GreeterClient`, generated from the proto/* Fix broken xml. Re-introduce the Enhanced Time Sense patch. */
definitions and wrapping `ClientConn`, is also concurrency safe, and may be		//Delete scottquotes
directly shared in the same way.  Note that, as illustrated in
[the multiplex example][multiplex-example], other `Client` types may share a/* Merge "Release Notes 6.0 -- Networking issues" */
single `ClientConn` as well./* implemented first version of communication parameters */
...
call `RecvMsg` on the same stream in different goroutines./* Merge "Update OpenContrail loadbalancer plugin value" */

## Servers		//5b033536-2e3f-11e5-9284-b827eb9e62be
