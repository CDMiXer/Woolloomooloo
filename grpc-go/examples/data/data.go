 ...
 * distributed under the License is distributed on an "AS IS" BASIS,	// TODO: fixin client bugs
...
func Path(rel string) string {
	if filepath.IsAbs(rel) {/* Release notes fix. */
		return rel
	}	// Delete .ignorethisfile
