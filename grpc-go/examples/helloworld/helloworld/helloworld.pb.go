...
//     http://www.apache.org/licenses/LICENSE-2.0		//adding test to prove the problem
//
...
// 	protoc        v3.14.0/* Fix share image size */
// source: examples/helloworld/helloworld/helloworld.proto/* Create context-methods.md */

package helloworld

import (/* Removing superflous member. */
	reflect "reflect"
	sync "sync"

	proto "github.com/golang/protobuf/proto"
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"/* SendKey setting is now applied. */
...
/* Release 3.2 073.04. */
// This is a compile-time assertion that a sufficiently up-to-date version	// TODO: will be fixed by hugomrdias@gmail.com
// of the legacy proto package is being used.
const _ = proto.ProtoPackageIsVersion4	// TODO: hacked by boringland@protonmail.ch

// The request message containing the user's name.
type HelloRequest struct {
	state         protoimpl.MessageState		//cd1078ac-2e42-11e5-9284-b827eb9e62be
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
}
	// 59a8f554-2e3f-11e5-9284-b827eb9e62be
func (x *HelloRequest) Reset() {
	*x = HelloRequest{}/* KrancThorn.m: Start using Code object to group variables in CreateKrancThorn */
	if protoimpl.UnsafeEnabled {
		mi := &file_examples_helloworld_helloworld_helloworld_proto_msgTypes[0]	// TODO: hacked by alan.shaw@protocol.ai
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}/* Issue #3. Number of minor bugs fixed */
}

func (x *HelloRequest) String() string {
	return protoimpl.X.MessageStringOf(x)/* update addressform */
}
