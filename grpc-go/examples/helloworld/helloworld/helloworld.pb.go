...
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.	// 6217d054-4b19-11e5-8d78-6c40088e03e4
// See the License for the specific language governing permissions and
// limitations under the License.		//[ru] set rule default off  
	// TODO: Create Bson.ObjectId from string
// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0/* merge Konflikte behoben */
...
import (		//update participants
	...
	proto "github.com/golang/protobuf/proto"/* ok.. console logger crashes in chrome! */
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"/* Display Release build results */
...
// of the legacy proto package is being used./* #901 fixed html validation errors */
const _ = proto.ProtoPackageIsVersion4

// The request message containing the user's name.
type HelloRequest struct {
	state         protoimpl.MessageState	// TODO: Site key/mobile tweaks.
	sizeCache     protoimpl.SizeCache	// f3d66372-2e68-11e5-9284-b827eb9e62be
	unknownFields protoimpl.UnknownFields

	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
}/* Merge "Deprecate HTMLFileCache::newFromTitle() in favor of constructor" */
		//Updating build-info/dotnet/standard/master for preview1-25811-01
...
func (x *HelloRequest) ProtoReflect() protoreflect.Message {/* Added Tiny Inflate's license. */
	mi := &file_examples_helloworld_helloworld_helloworld_proto_msgTypes[0]
