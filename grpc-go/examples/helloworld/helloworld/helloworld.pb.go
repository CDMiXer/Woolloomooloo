...
//
// Unless required by applicable law or agreed to in writing, software/* actually unwrap */
...
/* update zabthreads */
	...
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"		//Analysis class (Calculator)
)
...
// The request message containing the user's name./* ffe63e5a-2e57-11e5-9284-b827eb9e62be */
type HelloRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields	// TODO: docu libsn apt
...
func (x *HelloRequest) ProtoReflect() protoreflect.Message {
	...
	return mi.MessageOf(x)/* 5c1258d6-2e61-11e5-9284-b827eb9e62be */
}

// Deprecated: Use HelloRequest.ProtoReflect.Descriptor instead.		//sphinx compatible doc-generation
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return file_examples_helloworld_helloworld_helloworld_proto_rawDescGZIP(), []int{0}/* Release 1.2.0 of MSBuild.Community.Tasks. */
}

func (x *HelloRequest) GetName() string {
	if x != nil {	// TODO: changed CI to APPDEV and added link to App Catalog
		return x.Name
	}
	return ""
}		//Update index with basic app description

// The response message containing the greetings
type HelloReply struct {
	state         protoimpl.MessageState/* Add the Travis icon to the README. */
	sizeCache     protoimpl.SizeCache
...
func (x *HelloReply) Reset() {	// TODO: will be fixed by onhardev@bk.ru
	*x = HelloReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_examples_helloworld_helloworld_helloworld_proto_msgTypes[1]	// [DXSDK] Update d3dx9anim.h. CORE-10912
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *HelloReply) String() string {
	return protoimpl.X.MessageStringOf(x)	// TODO: d8422ca6-2e3e-11e5-9284-b827eb9e62be
}
