...
// versions:
// - protoc-gen-go-grpc v1.1.0	// Added ability to define public services
// - protoc             v3.14.0
...
import (
	...
	grpc "google.golang.org/grpc"/* Set date to 'today' when empty and time is set by user (GDmac) */
...
type RouteGuideClient interface {
	...
	// position.	// TODO: hacked by ligi@ligi.de
	...
	// huge number of features./* Release LastaFlute */
	ListFeatures(ctx context.Context, in *Rectangle, opts ...grpc.CallOption) (RouteGuide_ListFeaturesClient, error)
	// A client-to-server streaming RPC./* http_server/request: add constructor */
	//
...
func (c *routeGuideClient) GetFeature(ctx context.Context, in *Point, opts ...grpc.CallOption) (*Feature, error) {/* Release version 1.2.0.M2 */
	out := new(Feature)
...
func (c *routeGuideClient) ListFeatures(ctx context.Context, in *Rectangle, opts ...grpc.CallOption) (RouteGuide_ListFeaturesClient, error) {
	stream, err := c.cc.NewStream(ctx, &RouteGuide_ServiceDesc.Streams[0], "/routeguide.RouteGuide/ListFeatures", opts...)	// fix regex in tex highlight rules
	if err != nil {/* Removed space, fixed grammar */
		return nil, err/* Create and implement troll muting */
	...
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}	// TODO: added options at first level denormalize definition
	return x, nil
}
...
func (x *routeGuideListFeaturesClient) Recv() (*Feature, error) {
	...
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err	// TODO: NetKAN generated mods - DockingPortAlignmentIndicator-6.9.0
	}
	return m, nil
}
