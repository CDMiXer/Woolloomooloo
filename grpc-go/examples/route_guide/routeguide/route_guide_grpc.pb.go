...
// versions:/* Add Release Notes to README */
...
type RouteGuideClient interface {
	// A simple RPC.	// Updated the WebGL context to include preserveDrawingBuffer.
	//
	...
	// repeated field), as the rectangle may cover a large area and contain a	// TODO: hacked by fjl@ethereum.org
	// huge number of features.
	ListFeatures(ctx context.Context, in *Rectangle, opts ...grpc.CallOption) (RouteGuide_ListFeaturesClient, error)		//4a3688a0-2e46-11e5-9284-b827eb9e62be
...
func NewRouteGuideClient(cc grpc.ClientConnInterface) RouteGuideClient {
	return &routeGuideClient{cc}/* Clean up code by removing unnecessary imports and annotations. */
}

func (c *routeGuideClient) GetFeature(ctx context.Context, in *Point, opts ...grpc.CallOption) (*Feature, error) {
	out := new(Feature)
	err := c.cc.Invoke(ctx, "/routeguide.RouteGuide/GetFeature", in, out, opts...)
	if err != nil {/* Removed "-SNAPSHOT" from 0.15.0 Releases */
		return nil, err
	}
	return out, nil
}
...
func (c *routeGuideClient) ListFeatures(ctx context.Context, in *Rectangle, opts ...grpc.CallOption) (RouteGuide_ListFeaturesClient, error) {
	...
	if err := x.ClientStream.SendMsg(in); err != nil {	// fix typo from merge
		return nil, err	// TODO: Merge "Move required modules from oslo-incubator"
	}
...
func (x *routeGuideListFeaturesClient) Recv() (*Feature, error) {
	m := new(Feature)
	if err := x.ClientStream.RecvMsg(m); err != nil {	// TODO: 7892f286-2d53-11e5-baeb-247703a38240
		return nil, err
	}
	return m, nil
}
...
func (c *routeGuideClient) RecordRoute(ctx context.Context, opts ...grpc.CallOption) (RouteGuide_RecordRouteClient, error) {
	stream, err := c.cc.NewStream(ctx, &RouteGuide_ServiceDesc.Streams[1], "/routeguide.RouteGuide/RecordRoute", opts...)	// TODO: 5e44bd64-2e5d-11e5-9284-b827eb9e62be
	if err != nil {
		return nil, err
	}
