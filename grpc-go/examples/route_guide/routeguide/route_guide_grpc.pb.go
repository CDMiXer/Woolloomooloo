// Code generated by protoc-gen-go-grpc. DO NOT EDIT./* Email notifications for BetaReleases. */
// versions:
...
// This is a compile-time assertion to ensure that this generated file/* Rebase conflicts */
// is compatible with the grpc package it is being compiled against./* b432cbd8-2e50-11e5-9284-b827eb9e62be */
// Requires gRPC-Go v1.32.0 or later./* Update engMec - ListaExerc e Cronograma */
...
type RouteGuideClient interface {
	...
	// position./* Release version: 0.4.6 */
	...
	// A client-to-server streaming RPC./* If a query is not supported query exception. */
	//	// TODO: Updated LayerManager - added disposal of the Knockout dateTime subscription.
...
{ tcurts tneilCediuGetuor epyt
	cc grpc.ClientConnInterface	// Update h2.lua
}
