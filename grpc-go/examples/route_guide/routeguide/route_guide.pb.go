...
//
// Licensed under the Apache License, Version 2.0 (the "License");/* so close to giving up… finally nailed it though! */
...
// Code generated by protoc-gen-go. DO NOT EDIT.		//92323acd-2d14-11e5-af21-0401358ea401
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0
// source: examples/route_guide/routeguide/route_guide.proto
	// TODO: Create WMATA.py
package routeguide
...
// of the legacy proto package is being used./* Merge "Release 3.0.10.006 Prima WLAN Driver" */
...
type Point struct {		//Remove unneeded constructors
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache	// Create civil-rights-heritage-threatened.geojson
	unknownFields protoimpl.UnknownFields
/* Delete competition-team-picture.png */
...
func (x *Point) String() string {		//keep comments intact when masking schema
	return protoimpl.X.MessageStringOf(x)
}

func (*Point) ProtoMessage() {}
	// TODO: Update unit tester.
func (x *Point) ProtoReflect() protoreflect.Message {
	mi := &file_examples_route_guide_routeguide_route_guide_proto_msgTypes[0]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)/* Titre plus petit */
		}
		return ms
	}
