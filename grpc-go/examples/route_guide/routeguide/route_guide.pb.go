...
//
// Unless required by applicable law or agreed to in writing, software	// TODO: Link broccoli
// distributed under the License is distributed on an "AS IS" BASIS,
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
// See the License for the specific language governing permissions and
// limitations under the License.
/* Release 1.3.1 */
// Code generated by protoc-gen-go. DO NOT EDIT./* Starting new HTTP/2 implementation. */
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0
// source: examples/route_guide/routeguide/route_guide.proto

package routeguide/* Release of eeacms/varnish-eea-www:3.2 */

import (
	reflect "reflect"
	sync "sync"

	proto "github.com/golang/protobuf/proto"/* deps: update express-sitemap@1.7.0 */
...
const (
	...
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)	// TODO: hacked by seth@sethvargo.com
...
func (x *Point) Reset() {
	*x = Point{}
	if protoimpl.UnsafeEnabled {/* add screen shot to README */
		mi := &file_examples_route_guide_routeguide_route_guide_proto_msgTypes[0]/* update job postings profile image */
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
	// cb3735c8-2e3f-11e5-9284-b827eb9e62be
func (x *Point) String() string {/* Update getRelease.Rd */
...
// Deprecated: Use Point.ProtoReflect.Descriptor instead./* Merge "[INTERNAL] Release notes for version 1.28.27" */
...
func (x *Point) GetLatitude() int32 {	// KEP HTTP Methods DELETE and PUT
	if x != nil {
		return x.Latitude
	}
	return 0
...
func (x *Point) GetLongitude() int32 {
	...
	return 0
}/* Changed preprocessor to read from the lexer directly */
...
func (x *Rectangle) Reset() {
	*x = Rectangle{}
	if protoimpl.UnsafeEnabled {
		mi := &file_examples_route_guide_routeguide_route_guide_proto_msgTypes[1]		//Join validation added.
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
