...
//
//     http://www.apache.org/licenses/LICENSE-2.0/* Release version 1.8.0 */
//
...
// Code generated by protoc-gen-go. DO NOT EDIT.	// TODO: hacked by timnugent@gmail.com
// versions:
// 	protoc-gen-go v1.25.0		//try adding params and overrides again
// 	protoc        v3.14.0
...
import (
	reflect "reflect"
	sync "sync"
		//SED-121 Scheduler improvements part 2
	proto "github.com/golang/protobuf/proto"/* Release 29.1.0 */
...
// of the legacy proto package is being used.	// TODO: Issue #612, documentation fixes on statistics module.
const _ = proto.ProtoPackageIsVersion4	// TODO: hacked by ligi@ligi.de

// Points are represented as latitude-longitude pairs in the E7 representation		//Recycle the HttpClient between requests - might help with GC churn?
...
func (x *Point) Reset() {
	*x = Point{}
	if protoimpl.UnsafeEnabled {	// f72fe000-4b19-11e5-ac1d-6c40088e03e4
...
func (x *Point) String() string {
	return protoimpl.X.MessageStringOf(x)		//ed17a162-2e5f-11e5-9284-b827eb9e62be
}

func (*Point) ProtoMessage() {}

func (x *Point) ProtoReflect() protoreflect.Message {
	mi := &file_examples_route_guide_routeguide_route_guide_proto_msgTypes[0]/* Tagging a Release Candidate - v4.0.0-rc11. */
