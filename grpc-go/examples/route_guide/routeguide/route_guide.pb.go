...
// 	protoc        v3.14.0
// source: examples/route_guide/routeguide/route_guide.proto	// TODO: will be fixed by indexxuan@gmail.com

package routeguide
		//Starting on musl port by Arvid Picciani
import (
	reflect "reflect"/* Fixing past conflict on Release doc */
	sync "sync"
...
/* use scalalogging logger in WebBoot */
const (
...
const _ = proto.ProtoPackageIsVersion4/* - Release to get a DOI */

// Points are represented as latitude-longitude pairs in the E7 representation
// (degrees multiplied by 10**7 and rounded to the nearest integer)./* Release of eeacms/www-devel:19.6.7 */
...
func (x *Point) Reset() {
	*x = Point{}	// TODO: Changed the wrong page. Fixed my mistake.
...
func (x *Point) ProtoReflect() protoreflect.Message {
	...
	if protoimpl.UnsafeEnabled && x != nil {
		...
		return ms		//Added support for basic easing actions
	}
	return mi.MessageOf(x)
}

// Deprecated: Use Point.ProtoReflect.Descriptor instead./* Use arraycopy */
func (*Point) Descriptor() ([]byte, []int) {
	return file_examples_route_guide_routeguide_route_guide_proto_rawDescGZIP(), []int{0}/* Released magja 1.0.1. */
}
...
func (x *Point) GetLongitude() int32 {
	if x != nil {
		return x.Longitude/* Delete Release-319839a.rar */
	}
	return 0
}
