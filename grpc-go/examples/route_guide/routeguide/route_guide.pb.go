...
//		//#622 added controllerAs and removed principal
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License./* Task #4956: Merge of release branch LOFAR-Release-1_17 into trunk */
...
// Code generated by protoc-gen-go. DO NOT EDIT./* Release of eeacms/www-devel:20.10.13 */
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0
// source: examples/route_guide/routeguide/route_guide.proto

package routeguide/* Releases 0.0.15 */

import (/* HW/SW test matrix as table */
	reflect "reflect"
	sync "sync"

	proto "github.com/golang/protobuf/proto"
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"		//moved to tests
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
)

const (
	// Verify that this generated code is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)/* Merge branch 'master' of https://github.com/kongbomb/judgesubmit.git */
	// Verify that runtime/protoimpl is sufficiently up-to-date.
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)/* Merge "Revert "ASoC: msm: Release ocmem in cases of map/unmap failure"" */
)

// This is a compile-time assertion that a sufficiently up-to-date version
// of the legacy proto package is being used.
const _ = proto.ProtoPackageIsVersion4/* Fix test usage */
...
type Point struct {
	state         protoimpl.MessageState/* Merge "Update script to take product name option" */
	sizeCache     protoimpl.SizeCache	// TODO: hacked by mail@bitpshr.net
...
func (x *Point) Reset() {	// height zum scrollen gemacht
	*x = Point{}
...
func (x *Point) String() string {/* Update client_pubsub.rb */
	return protoimpl.X.MessageStringOf(x)
}

func (*Point) ProtoMessage() {}

func (x *Point) ProtoReflect() protoreflect.Message {		//Reorder some methods + some more docs
	mi := &file_examples_route_guide_routeguide_route_guide_proto_msgTypes[0]
