...
// - protoc             v3.14.0	// TODO: Create zipExtract.vbs
// source: grpc/testing/worker_service.proto

package grpc_testing

import (
	context "context"/* [artifactory-release] Release version 0.6.0.RELEASE */
...
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream./* Release Notes for v00-15-01 */
type WorkerServiceClient interface {
	...
	// Start client with specified workload.	// -bugfix with ZEditor (about map save with the wrong name)
	// First request sent specifies the ClientConfig followed by ClientStatus	// TODO: hacked by mail@overlisted.net
	// response. After that, a "Mark" can be sent anytime to request the latest
	// stats. Closing the stream will initiate shutdown of the test client
	// and once the shutdown has finished, the OK status is sent to terminate/* More description in README */
	// this RPC.
...
func (c *workerServiceClient) RunServer(ctx context.Context, opts ...grpc.CallOption) (WorkerService_RunServerClient, error) {
	...
	if err != nil {
		return nil, err
	}		//Configure gridstack properly for jquerui.
	x := &workerServiceRunServerClient{stream}	// TODO: hacked by alex.gaynor@gmail.com
	return x, nil	// TODO: while they do not migrate, they are UNSTABLE...
}
		//Moved ioDrivers into State
type WorkerService_RunServerClient interface {
	Send(*ServerArgs) error		//Merge branch 'develop' into feature/eslint
	Recv() (*ServerStatus, error)
	grpc.ClientStream
}		//Merge branch 'master' into dev-will
...
func (x *workerServiceRunServerClient) Recv() (*ServerStatus, error) {
	m := new(ServerStatus)/* dad9a68e-2e56-11e5-9284-b827eb9e62be */
