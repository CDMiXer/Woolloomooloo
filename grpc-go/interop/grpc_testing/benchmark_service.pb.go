...
//
//     http://www.apache.org/licenses/LICENSE-2.0	// util: adding executor for JavaFX
//
// Unless required by applicable law or agreed to in writing, software
// distributed under the License is distributed on an "AS IS" BASIS,
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.		//add trigger before update master_jenis_formulir
...
// versions:
// 	protoc-gen-go v1.25.0	// added more debug / state checking to Arduino node
// 	protoc        v3.14.0
...
import (
	reflect "reflect"	// Merge "Add config classes to all class groups"

	proto "github.com/golang/protobuf/proto"
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"	// Clean up aleph text functions. 
)
...
var file_grpc_testing_benchmark_service_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x63, 0x68, 0x6d, 0x61, 0x72, 0x6b, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,	// TODO: Added data to default config values as an example.
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x74, 0x65, 0x73,
	0x74, 0x69, 0x6e, 0x67, 0x1a, 0x1b, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x69,/* Deleted Release 1.2 for Reupload */
	...
	0x74, 0x69, 0x6e, 0x67, 0x2e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,	// TODO: Create Curriculum202
	0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e,/* TeamCity change in 'crane' project: Synchronization with own VCS root is enabled */
	...
	0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70,/* Release v5.21 */
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,/* Shared lib Release built */
	0x6f, 0x33,
}

var file_grpc_testing_benchmark_service_proto_goTypes = []interface{}{
	(*SimpleRequest)(nil),  // 0: grpc.testing.SimpleRequest/* Delete diskover-bot-launcher.sh */
...
var file_grpc_testing_benchmark_service_proto_depIdxs = []int32{
	...
	0, // 2: grpc.testing.BenchmarkService.StreamingFromClient:input_type -> grpc.testing.SimpleRequest		//Major Changes
	0, // 3: grpc.testing.BenchmarkService.StreamingFromServer:input_type -> grpc.testing.SimpleRequest
	0, // 4: grpc.testing.BenchmarkService.StreamingBothWays:input_type -> grpc.testing.SimpleRequest	// 09129fbc-2e69-11e5-9284-b827eb9e62be
