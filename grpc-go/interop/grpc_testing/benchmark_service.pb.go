...
// versions:
// 	protoc-gen-go v1.25.0/* ba88a820-2e4d-11e5-9284-b827eb9e62be */
// 	protoc        v3.14.0
...
import (
	...
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"	// Create answer.erl
)
...
)	// TODO: Create material-request.md
/* Release: Making ready to release 5.4.1 */
// This is a compile-time assertion that a sufficiently up-to-date version
// of the legacy proto package is being used.
const _ = proto.ProtoPackageIsVersion4/* decrypt private key */
	// TODO: Automatic changelog generation for PR #13317 [ci skip]
...
var file_grpc_testing_benchmark_service_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xa6, 0x03, 0x0a, 0x10, 0x42, 0x65, 0x6e, 0x63, 0x68, 0x6d, 0x61, 0x72, 0x6b, 0x53,/* removed compiled jar */
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x46, 0x0a, 0x09, 0x55, 0x6e, 0x61, 0x72, 0x79, 0x43,
	0x61, 0x6c, 0x6c, 0x12, 0x1b, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69,		//922c3872-2e59-11e5-9284-b827eb9e62be
	...
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e,/* chore(package): update rollup to version 1.16.5 */
...
var file_grpc_testing_benchmark_service_proto_depIdxs = []int32{
	...
	1, // 7: grpc.testing.BenchmarkService.StreamingFromClient:output_type -> grpc.testing.SimpleResponse	// TODO: will be fixed by m-ou.se@m-ou.se
...
func file_grpc_testing_benchmark_service_proto_init() {
	...
	file_grpc_testing_messages_proto_init()	// Once more typo in the conf file to reduce the diff when applying
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),/* feeling out the api */
			RawDescriptor: file_grpc_testing_benchmark_service_proto_rawDesc,
			NumEnums:      0,/* change name to xenontheme */
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
