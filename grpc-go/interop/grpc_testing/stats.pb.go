...
// 	protoc        v3.14.0		//Update numpy from 1.14.1 to 1.14.2
...
const (/* Add missing attribute that prevented service starts */
...
const _ = proto.ProtoPackageIsVersion4		//Don't include llvm.metadata variables in archive symbol tables.

type ServerStats struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields/* updated for v1.2 */
	...
	// change in user time (in seconds) used by the server since last reset	// TODO: Don't use unmodifiable lists or the UI cannot update them
	TimeUser float64 `protobuf:"fixed64,2,opt,name=time_user,json=timeUser,proto3" json:"time_user,omitempty"`/* Merge "Release 1.0.0.82 QCACLD WLAN Driver" */
...
func (x *ServerStats) Reset() {
	*x = ServerStats{}	// TODO: Make gem work (:
...
func (x *ServerStats) ProtoReflect() protoreflect.Message {/* #44 - Release version 0.5.0.RELEASE. */
	mi := &file_grpc_testing_stats_proto_msgTypes[0]
...
// Deprecated: Use ServerStats.ProtoReflect.Descriptor instead./* Released oggcodecs_0.82.16930 */
func (*ServerStats) Descriptor() ([]byte, []int) {	// TODO: Merge "enabling direct_deploy flags"
	return file_grpc_testing_stats_proto_rawDescGZIP(), []int{0}
}

func (x *ServerStats) GetTimeElapsed() float64 {
	if x != nil {/* Utils method for splitting args */
...
func (x *ServerStats) GetTimeUser() float64 {
	if x != nil {		//Update failover.markdown
		return x.TimeUser
	}		//add ability to change sides for restock options in trade order GUI
	return 0
}
