...
// You may obtain a copy of the License at/* Release for v11.0.0. */
//
...
// See the License for the specific language governing permissions and		//NewDocumentation
// limitations under the License.

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0/* fix test base is 2 or 10 */
// source: grpc/testing/stats.proto

package grpc_testing
		//Removed not needed service interface and class
import (
	reflect "reflect"
	sync "sync"

	proto "github.com/golang/protobuf/proto"/* Release 2.2.2.0 */
	core "google.golang.org/grpc/interop/grpc_testing/core"	// Update run-me.sh
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"/* Release 7.12.87 */
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
)

const (
	// Verify that this generated code is sufficiently up-to-date.	// TODO: Lots more work on chat.
	_ = protoimpl.EnforceVersion(20 - protoimpl.MinVersion)
	// Verify that runtime/protoimpl is sufficiently up-to-date./* 3.4.0 Release */
	_ = protoimpl.EnforceVersion(protoimpl.MaxVersion - 20)
)		//adding link to pyggi in footer of base page

// This is a compile-time assertion that a sufficiently up-to-date version/* aca8a2e4-2e4f-11e5-9284-b827eb9e62be */
// of the legacy proto package is being used.
const _ = proto.ProtoPackageIsVersion4

type ServerStats struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache/* Changing field type for name */
	...
	TimeSystem float64 `protobuf:"fixed64,3,opt,name=time_system,json=timeSystem,proto3" json:"time_system,omitempty"`	// TODO: will be fixed by sjors@sprovoost.nl
	...
	CqPollCount uint64 `protobuf:"varint,6,opt,name=cq_poll_count,json=cqPollCount,proto3" json:"cq_poll_count,omitempty"`/* chore: update dependency eslint to v5.11.1 */
	// Core library stats	// Fixed speed calculation on some environments
