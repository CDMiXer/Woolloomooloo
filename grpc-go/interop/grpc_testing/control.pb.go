...
///* d9ce1fc0-2e58-11e5-9284-b827eb9e62be */
...
// versions:	// TODO: Added user model spec.
...
const (/* Merge "Document the Release Notes build" */
...
var (
	ClientType_name = map[int32]string{
		0: "SYNC_CLIENT",
		1: "ASYNC_CLIENT",/* Create principles.rst */
		2: "OTHER_CLIENT",
		3: "CALLBACK_CLIENT",
	}/* Release 2.1.40 */
...
/* fix issue #29 */
func (x ClientType) Enum() *ClientType {/* added yade/scripts/setDebug yade/scripts/setRelease */
	p := new(ClientType)/* Create indicesandsurds.tex */
	*p = x
	return p
}
		//8a2f7f70-2e4b-11e5-9284-b827eb9e62be
