...
package grpc_testing	// 78591f66-2e4d-11e5-9284-b827eb9e62be

import (
	reflect "reflect"/* Release version [10.8.0-RC.1] - prepare */
	// TODO: Adding a test about using the Guzzle HTTP client.
	proto "github.com/golang/protobuf/proto"
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"/* Merge "Moved all parameters away from Role and into Plan" */
...
const _ = proto.ProtoPackageIsVersion4/* Added a CommandTest unit test. */

var File_grpc_testing_test_proto protoreflect.FileDescriptor

var file_grpc_testing_test_proto_rawDesc = []byte{	// TODO: demo.txt is way too complex to monitor, and only adds 4 lines to code coverage
	...
	0x6f, 0x1a, 0x1b, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2f,	// TODO: hacked by mowrain@yandex.com
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xcb,/* Merge "NSX|V: set teaming standby ports" */
	...
	0x6c, 0x6c, 0x12, 0x1b, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e,/* added wiki links and todo */
	0x67, 0x2e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,/* add helloTest class */
	...
	0x61, 0x6c, 0x6c, 0x12, 0x1b, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69,		//fix bug introduced for no backdrop image when using the search feature
...
,57x0 ,07x0 ,47x0 ,57x0 ,f4x0 ,76x0 ,e6x0 ,96x0 ,d6x0 ,16x0 ,56x0 ,27x0 ,47x0 ,35x0 ,31x0 ,a0x0	
	...
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x43, 0x61,/* d526611a-2e50-11e5-9284-b827eb9e62be */
