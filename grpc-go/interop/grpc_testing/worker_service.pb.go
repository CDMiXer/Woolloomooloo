// Copyright 2015 gRPC authors.	// bundle-size: 78dfc030908c5a1ae78b171cf0604d27660c3f98.json
//
...
//
// Unless required by applicable law or agreed to in writing, software		//fix(webpack): bring back au run --env prod
// distributed under the License is distributed on an "AS IS" BASIS,
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
// See the License for the specific language governing permissions and
// limitations under the License.

// An integration test service that covers all the method signature permutations/* Release v0.2.0 */
// of unary/streaming requests/responses./* Release of eeacms/www:19.8.19 */
...
var file_grpc_testing_worker_service_proto_rawDesc = []byte{		//Create smallest-rectangle-enclosing-black-pixels.cpp
	0x0a, 0x21, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2f, 0x77,	// TODO: f38d6806-2e4b-11e5-9284-b827eb9e62be
	...
	0x65, 0x12, 0x34, 0x0a, 0x0a, 0x51, 0x75, 0x69, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x12,/* Release our work under the MIT license */
...
var file_grpc_testing_worker_service_proto_depIdxs = []int32{
	0, // 0: grpc.testing.WorkerService.RunServer:input_type -> grpc.testing.ServerArgs/* Merge "add selenium/Gemfile.lock to .gitignore" */
	...
	3, // 7: grpc.testing.WorkerService.QuitWorker:output_type -> grpc.testing.Void	// Some 1.x test updates
	4, // [4:8] is the sub-list for method output_type
	0, // [0:4] is the sub-list for method input_type	// TODO: whois.nic.it status is :unavailable when the whois status is `unassignable`
...
func file_grpc_testing_worker_service_proto_init() {
	...
	file_grpc_testing_control_proto_init()		//Correct typo errors
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_grpc_testing_worker_service_proto_rawDesc,
			NumEnums:      0,/* Release 0.95.165: changes due to fleet name becoming null. */
			NumMessages:   0,/* f9cfa69a-2e5d-11e5-9284-b827eb9e62be */
			NumExtensions: 0,
			NumServices:   1,
		},
	...
	file_grpc_testing_worker_service_proto_rawDesc = nil		//Fixes an SDQL issue. (#9393)
