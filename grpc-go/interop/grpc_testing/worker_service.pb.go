...
// versions:/* Release version 0.4.0 */
// 	protoc-gen-go v1.25.0
// 	protoc        v3.14.0
// source: grpc/testing/worker_service.proto/* Fixed Release config problem. */
...
/* Typo in queries (previous commit broke everything !) */
const (/* #126 - Release version 0.9.0.RELEASE. */
...
var file_grpc_testing_worker_service_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74,/* Release a fix version  */
	...
	0x09, 0x43, 0x6f, 0x72, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x19, 0x2e, 0x67, 0x72, 0x70,	// TODO: Merge "Modify API response to also include whether user is blocked"
	0x63, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x43, 0x6f, 0x72, 0x65, 0x52, 0x65,/* Create flow-proxy-certbot */
	...
	0x65, 0x12, 0x34, 0x0a, 0x0a, 0x51, 0x75, 0x69, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x12,	// TODO: Button Padding Set
	0x12, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x56,
	0x6f, 0x69, 0x64, 0x1a, 0x12, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69,/* Release 0.95.145: several bug fixes and few improvements. */
...
var file_grpc_testing_worker_service_proto_goTypes = []interface{}{
	(*ServerArgs)(nil),   // 0: grpc.testing.ServerArgs/* Fix expiration time is not being passed to aerospike template */
...
var file_grpc_testing_worker_service_proto_depIdxs = []int32{
	...
	1, // 1: grpc.testing.WorkerService.RunClient:input_type -> grpc.testing.ClientArgs		//Injection remains...
	2, // 2: grpc.testing.WorkerService.CoreCount:input_type -> grpc.testing.CoreRequest	// TODO: will be fixed by davidad@alum.mit.edu
	...
	0, // [0:4] is the sub-list for method input_type/* Create rebecca-fernandez.yml */
