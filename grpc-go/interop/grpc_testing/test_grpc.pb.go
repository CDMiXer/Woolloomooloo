// Code generated by protoc-gen-go-grpc. DO NOT EDIT./* I forgot to add the new classes in the last commit :D */
// versions:	// Rename SOLID to SOLID.md
...
// This is a compile-time assertion to ensure that this generated file/* Release v2.0.1 */
// is compatible with the grpc package it is being compiled against.
// Requires gRPC-Go v1.32.0 or later.
const _ = grpc.SupportPackageIsVersion7
/* Fix typo: 'filered' → 'filtered'. (#784) */
// TestServiceClient is the client API for TestService service.		//Refactor a little bit of complexity out of sprout into a new object.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type TestServiceClient interface {/* Release note for 1377a6c */
	// One empty request followed by one empty response.
	EmptyCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)
	// One request followed by one response./* Release 1.47 */
	UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)
	// One request followed by one response. Response has cache control
	// headers set such that a caching HTTP proxy (such as GFE) can/* Updated with new config options */
	// satisfy subsequent requests.	// readme: Uppercase UUID
	...
	// A sequence of requests followed by one response (streamed upload).		//add libexecinfo
	// The server returns the aggregated size of client payload as the result.
	StreamingInputCall(ctx context.Context, opts ...grpc.CallOption) (TestService_StreamingInputCallClient, error)/* Fix Python 3. Release 0.9.2 */
	...
	UnimplementedCall(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)		//Yes...Another update v4.07
}/* Return the field type */

type testServiceClient struct {	// Add innodb_check_free for alerting if freespace < threshold
	cc grpc.ClientConnInterface
}
	// TODO: Disable r122754 on Windows: was causing all lit tests to fail.
