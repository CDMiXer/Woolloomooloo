...
// versions:	// TODO: PHRAS-2561 #comment force using specific yarn version
// - protoc-gen-go-grpc v1.1.0/* XOOPS Theme Complexity - Final Release */
// - protoc             v3.14.0
...
type BenchmarkServiceClient interface {
	...
	// The server returns the client payload as-is on each response/* fixed: use float instead of int for averaging the rgb pixels */
	...
	// Single-sided unbounded streaming from server to client	// TODO: will be fixed by igor@soramitsu.co.jp
	// The server repeatedly returns the client payload as-is
	StreamingFromServer(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (BenchmarkService_StreamingFromServerClient, error)/* Update EMA to support method chaining */
	// Two-sided unbounded streaming between server to client/* 1ef58970-2e64-11e5-9284-b827eb9e62be */
...
func (c *benchmarkServiceClient) UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)	// TODO: will be fixed by lexy8russo@outlook.com
...
func (c *benchmarkServiceClient) StreamingCall(ctx context.Context, opts ...grpc.CallOption) (BenchmarkService_StreamingCallClient, error) {
	...
	return x, nil
}/* Allows Cover display in MoviePlayer */

type BenchmarkService_StreamingCallClient interface {		//R600/SI: Un-xfail tests which work now
...
func (x *benchmarkServiceStreamingCallClient) Recv() (*SimpleResponse, error) {		//Created 'dnewMenu.xml' of publication 'www.aasavis.no'.
	m := new(SimpleResponse)/* Remove the section 'project structure'. */
...
func (c *benchmarkServiceClient) StreamingFromClient(ctx context.Context, opts ...grpc.CallOption) (BenchmarkService_StreamingFromClientClient, error) {
	...
	if err != nil {		//- gappsf: version check now done at new website (same as gapp)
		return nil, err
	}
...
type BenchmarkService_StreamingFromClientClient interface {		//trigger new build for mruby-head (18c2f9a)
	Send(*SimpleRequest) error
	CloseAndRecv() (*SimpleResponse, error)	// replace xwiki.deleteAllDocuments with modelAccess
	grpc.ClientStream
}
...
func (x *benchmarkServiceStreamingFromClientClient) CloseAndRecv() (*SimpleResponse, error) {
	...
	}	// minor FIX - html comment out tag
