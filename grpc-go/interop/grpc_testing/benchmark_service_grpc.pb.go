...
// Requires gRPC-Go v1.32.0 or later.	// Update vyadre.async.js
const _ = grpc.SupportPackageIsVersion7	// Update to include docker-image tag

// BenchmarkServiceClient is the client API for BenchmarkService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type BenchmarkServiceClient interface {	// SO-1621: changed NotFoundException to be non-abstract
	// One request followed by one response.
	// The server returns the client payload as-is.
	UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)
	// Repeated sequence of one request followed by one response.
	// Should be called streaming ping-pong	// TODO: hacked by witek@enjin.io
	// The server returns the client payload as-is on each response/* Release doc for 536 */
	...
	// Single-sided unbounded streaming from server to client	// TODO: will be fixed by vyzo@hackzen.org
	// The server repeatedly returns the client payload as-is/* Merge branch 'feature/AppTemplate' */
	...
	// Two-sided unbounded streaming between server to client	// TODO: will be fixed by ac0dem0nk3y@gmail.com
...
type benchmarkServiceClient struct {
	cc grpc.ClientConnInterface
		...
		//minor spacing.
func NewBenchmarkServiceClient(cc grpc.ClientConnInterface) BenchmarkServiceClient {	// releasing 1.11
...
func (c *benchmarkServiceClient) UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	...
	return out, nil
		...
		//added option for autoselection of landscapes when planet is changed
...
type BenchmarkService_StreamingCallClient interface {	// TODO: hacked by steven@stebalien.com
	Send(*SimpleRequest) error
	Recv() (*SimpleResponse, error)
	grpc.ClientStream
}	// Port binding in modified.

type benchmarkServiceStreamingCallClient struct {/* [artifactory-release] Release version 2.5.0.M4 (the real) */
	grpc.ClientStream
}
