...
type BenchmarkServiceClient interface {
	...
	// TODO: Update MMA7660.h
type benchmarkServiceClient struct {	// Merge branch 'integration' into ndt-sandbox-annotation-structs
...
func (x *benchmarkServiceStreamingCallClient) Recv() (*SimpleResponse, error) {/* Spring security base */
...
func (c *benchmarkServiceClient) StreamingFromClient(ctx context.Context, opts ...grpc.CallOption) (BenchmarkService_StreamingFromClientClient, error) {/* Added basic ER diagram; Added LICENSE and README; */
