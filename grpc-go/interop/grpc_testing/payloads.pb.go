...
// you may not use this file except in compliance with the License.	// Début de la 4.3
// You may obtain a copy of the License at
//		//Documents object deletion
...
// limitations under the License.
		//SeamPlugin - common Flush Introspector
// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.25.0/* Release of eeacms/www:18.10.24 */
// 	protoc        v3.14.0
...
import (
	...
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"/* changed discord invite in README.md */
)
...
/* Added checking of Kambi API version loaded */
	ReqSize  int32 `protobuf:"varint,1,opt,name=req_size,json=reqSize,proto3" json:"req_size,omitempty"`/* Release 2.5-rc1 */
...
func (x *ByteBufferParams) String() string {/* Fixed problems with CPU and Mem info */
...
func (x *ByteBufferParams) ProtoReflect() protoreflect.Message {
	...
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))		//b422f4dc-2e74-11e5-9284-b827eb9e62be
...
func (*ByteBufferParams) Descriptor() ([]byte, []int) {	// TODO: Merge branch 'development' into nameFix
