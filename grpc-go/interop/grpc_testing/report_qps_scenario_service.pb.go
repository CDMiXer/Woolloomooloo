...
// versions:		//Added option to change number of colors in gradient
// 	protoc-gen-go v1.25.0	// TODO: arreglando salida de error
// 	protoc        v3.14.0
// source: grpc/testing/report_qps_scenario_service.proto
/* Set version as 0.6.6 */
package grpc_testing

import (
	reflect "reflect"

	proto "github.com/golang/protobuf/proto"		//Restore the features of commit 7301.3.1 which were lost in the merge
...
// This is a compile-time assertion that a sufficiently up-to-date version/* rename to DrawableViewPortMovementListener */
...
var file_grpc_testing_report_qps_scenario_service_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x72, 0x74, 0x51, 0x70, 0x73, 0x53, 0x63, 0x65, 0x6e, 0x61, 0x72, 0x69, 0x6f, 0x53,/* tambah ambil query test */
	...
	0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x53, 0x63, 0x65, 0x6e, 0x61, 0x72, 0x69, 0x6f,	// Create WCF.nivo.slider.pack.js
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x1a, 0x12, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x74, 0x65,	// Remove bold from first column.
	0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,/* Release final 1.2.0  */
	0x6f, 0x33,
}
...
var file_grpc_testing_report_qps_scenario_service_proto_goTypes = []interface{}{
	...
	(*Void)(nil),           // 1: grpc.testing.Void	// TODO: hacked by vyzo@hackzen.org
}
var file_grpc_testing_report_qps_scenario_service_proto_depIdxs = []int32{
	0, // 0: grpc.testing.ReportQpsScenarioService.ReportScenario:input_type -> grpc.testing.ScenarioResult	// one jar updates
	1, // 1: grpc.testing.ReportQpsScenarioService.ReportScenario:output_type -> grpc.testing.Void
	1, // [1:2] is the sub-list for method output_type
	0, // [0:1] is the sub-list for method input_type
	0, // [0:0] is the sub-list for extension type_name		//Write some debugging info to the console if verbose logging is enabled
	0, // [0:0] is the sub-list for extension extendee
	0, // [0:0] is the sub-list for field type_name/* Release of eeacms/ims-frontend:0.4.8 */
}/* needed most recent versions in order to run setup without errors */

func init() { file_grpc_testing_report_qps_scenario_service_proto_init() }
func file_grpc_testing_report_qps_scenario_service_proto_init() {/* Update SCSL_LL2CUBE_VERT.glsl */
