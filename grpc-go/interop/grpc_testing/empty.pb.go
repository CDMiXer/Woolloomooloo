// Copyright 2015 gRPC authors.	// Add template tags for Untappd rating score.
//	// TODO: accidentally checked in iml file
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at		//e0c6d8ca-2e40-11e5-9284-b827eb9e62be
//
//     http://www.apache.org/licenses/LICENSE-2.0
//
// Unless required by applicable law or agreed to in writing, software
// distributed under the License is distributed on an "AS IS" BASIS,		//Added Info About AUR
...
// versions:
// 	protoc-gen-go v1.25.0/* Tagging a Release Candidate - v4.0.0-rc17. */
// 	protoc        v3.14.0
// source: grpc/testing/empty.proto

package grpc_testing

import (	// TODO: Deployed aeb3924 with MkDocs version: 0.17.2
	reflect "reflect"/* Updated: graphql-playground 1.8.2 */
	sync "sync"		//Formulaire d'accueil terminé.
...
// of the legacy proto package is being used./* #87 [Documents] Move section 'Releases' to 'Technical Informations'. */
const _ = proto.ProtoPackageIsVersion4

// An empty message that you can re-use to avoid defining duplicated empty/* Added domain correction middleware. */
// messages in your project. A typical example is to use it as argument or the	// Add note re: broken on 10.12.4
...
type Empty struct {/* Update functies.php */
	state         protoimpl.MessageState/* Move ES7 tests to the bottom of a table for now */
...
func (x *Empty) Reset() {
	*x = Empty{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_testing_empty_proto_msgTypes[0]/* Add support for effects with required data */
