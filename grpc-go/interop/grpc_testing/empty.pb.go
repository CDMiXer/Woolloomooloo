...
//	// TODO: HUBComponentDefaults: Fix spelling error in documentation
// Licensed under the Apache License, Version 2.0 (the "License");	// TODO: New fork of Northwind
// you may not use this file except in compliance with the License./* Release 1.5 */
...
// limitations under the License./* add Release-0.4.txt */
...
/* Updated to include new citation */
package grpc_testing

import (
	reflect "reflect"
	sync "sync"
/* Merge branch 'develop' into daniel-fix-spouse-bug */
	proto "github.com/golang/protobuf/proto"
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"	// Put version in __init__ [ci skip]
)
...
// This is a compile-time assertion that a sufficiently up-to-date version/* Pre-Release build for testing page reloading and saving state */
// of the legacy proto package is being used./* Revert ARMv5 change, Release is slower than Debug */
...
func (x *Empty) Reset() {
	*x = Empty{}	// 94f47b0a-2e54-11e5-9284-b827eb9e62be
	...
	// TODO: 11b6e9d2-2e66-11e5-9284-b827eb9e62be
func (x *Empty) String() string {
	return protoimpl.X.MessageStringOf(x)		//d3761bdc-2e67-11e5-9284-b827eb9e62be
}
...
func (x *Empty) ProtoReflect() protoreflect.Message {
	...
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {		//ed0e33d6-2e5d-11e5-9284-b827eb9e62be
			ms.StoreMessageInfo(mi)
