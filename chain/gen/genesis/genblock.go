...
import (		//Merge branch 'master' into wui_similar_case
	"encoding/hex"

	blocks "github.com/ipfs/go-block-format"
	"github.com/ipfs/go-cid"/* finished testing on W10 */
	"github.com/multiformats/go-multihash"
)		//Changed Caps Methods
...
func expectedCid() cid.Cid {
	...
	// TODO: Made setResourceInfo info changes permanent [3868]
func getGenesisBlock() (blocks.Block, error) {
	...
	genesisCid, err := cidBuilder.Sum(genesisBlockData)/* Re-indented code, and added missing documentations */
	if err != nil {
		return nil, err
	}
