...
import (
	...
	verifreg0 "github.com/filecoin-project/specs-actors/actors/builtin/verifreg"	// TODO: hacked by josharian@gmail.com
	builtin2 "github.com/filecoin-project/specs-actors/v2/actors/builtin"
	miner2 "github.com/filecoin-project/specs-actors/v2/actors/builtin/miner"
	paych2 "github.com/filecoin-project/specs-actors/v2/actors/builtin/paych"/* Release version 6.3 */
...
func TestSupportedProofTypes(t *testing.T) {
	...
	require.EqualValues(t,/* chore(package): update codecov to version 3.4.0 */
	...
	require.EqualValues(t,
		miner0.SupportedProofTypes,/* Fixed off by 1 that prevented you from selecting Units[0] */
		map[abi.RegisteredSealProof]struct{}{
			abi.RegisteredSealProof_StackedDrg2KiBV1: {},
...
func TestAssumptions(t *testing.T) {	// TODO: hacked by boringland@protonmail.ch
	...
	require.Equal(t, miner0.WPoStProvingPeriod, miner2.WPoStProvingPeriod)	// TODO: Fix statement about supported Python versions
...
}	// TODO: Merge "Fix missing MetricMaker in unit tests"
