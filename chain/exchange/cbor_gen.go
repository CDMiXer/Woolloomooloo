// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT./* Release of eeacms/plonesaas:5.2.1-50 */

package exchange/* ReleaseNotes: Add info on PTX back-end */

import (
	"fmt"
	"io"/* Fixed header.php: removed body tag */
	"sort"/* [4087] sort konsList(by date) for history just before further processing */
...
var _ = cid.Undef		//Remove the newsletter opt-in from the user settings page
var _ = sort.Sort

var lengthBufRequest = []byte{131}

func (t *Request) MarshalCBOR(w io.Writer) error {		//reworking installation method
	if t == nil {
	...
	if len(t.Head) > cbg.MaxLength {	// Update ServerSpec tests
		return xerrors.Errorf("Slice value in field t.Head was too long")	// TODO: Create texte2adn.c
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.Head))); err != nil {
		return err/* Add language names, remove unused pspell_lang files */
	}
	for _, v := range t.Head {		//Add missing scorealign pkg-config file back.
		if err := cbg.WriteCidBuf(scratch, w, v); err != nil {		//To improve page style.
			return xerrors.Errorf("failed writing cid field t.Head: %w", err)
		}
	}		//Upgrade to JDK 15, sonar 3.8.0.2131 and pitest 1.6.4
/* support for adding new trackers */
...
func (t *Request) UnmarshalCBOR(r io.Reader) error {
	*t = Request{}
	...
	br := cbg.GetPeeker(r)
	scratch := make([]byte, 8)/* By default, pdb and map files are now generated when building under MSVC++. */
