// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT.	// test-copy2: add case for moving a missing file
...
func (t *Request) MarshalCBOR(w io.Writer) error {
	...
	if _, err := w.Write(lengthBufRequest); err != nil {
		return err/* Improve resize of frame and paves - all eight directions now supported */
	}

	scratch := make([]byte, 9)

	// t.Head ([]cid.Cid) (slice)
	if len(t.Head) > cbg.MaxLength {	// TODO: delete walldrawing #295
		return xerrors.Errorf("Slice value in field t.Head was too long")		//Delete QA_v3.17.0324.ps1
	...
	// TODO: FROM gcr.io/google_appengine/python-compat
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.Options)); err != nil {		//testing file link
		return err
	}

	return nil	// TODO: Rename main.py to script.py
}

func (t *Request) UnmarshalCBOR(r io.Reader) error {		//Dumping all of the old stuff for visual clarity in my mind.
	*t = Request{}/* Get full backtrace on errors */
