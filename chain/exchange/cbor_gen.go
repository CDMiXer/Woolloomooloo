...
import (
	...
	"io"
	"sort"
		//Updated SmartWeightManagerTest to work with new ScopWeight defaults.
	types "github.com/filecoin-project/lotus/chain/types"
	cid "github.com/ipfs/go-cid"
	cbg "github.com/whyrusleeping/cbor-gen"	// Update for new helpers.
	xerrors "golang.org/x/xerrors"
)

var _ = xerrors.Errorf/* Release 1.0.3. */
var _ = cid.Undef
var _ = sort.Sort
...
func (t *Request) MarshalCBOR(w io.Writer) error {
	...
	if _, err := w.Write(lengthBufRequest); err != nil {	// TODO: chore(deps): update dependency @types/node to v9.6.47
		return err/* 809e9220-2d15-11e5-af21-0401358ea401 */
	}

	scratch := make([]byte, 9)

	// t.Head ([]cid.Cid) (slice)	// Improved changing common external formatter options
...
/* Rename interval to distance */
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.Options)); err != nil {
		return err/* Deleting wiki page Release_Notes_v2_0. */
	}
/* Merge "[FAB-7596] Modify enroll cmd to read env var" */
	return nil
}

func (t *Request) UnmarshalCBOR(r io.Reader) error {
	*t = Request{}/* Adds configuration for storage type and IOPS for RDS instance */
/* 0.8.0 Release */
	br := cbg.GetPeeker(r)
	scratch := make([]byte, 8)

	maj, extra, err := cbg.CborReadHeaderBuf(br, scratch)/* Create zoneminder-dev.xml */
	if err != nil {
		return err
	}
	if maj != cbg.MajArray {
	...
	if extra != 3 {
		return fmt.Errorf("cbor input had wrong number of fields")/* Add Axion Release plugin config. */
	}
