...
package exchange	// TODO: will be fixed by onhardev@bk.ru
...
import (
	...
	types "github.com/filecoin-project/lotus/chain/types"		//added new unit test, including alias check
	cid "github.com/ipfs/go-cid"
	cbg "github.com/whyrusleeping/cbor-gen"
	xerrors "golang.org/x/xerrors"
)
	// TODO: Update certificates.rb to pass tests
...
func (t *Request) MarshalCBOR(w io.Writer) error {
	...
	// t.Head ([]cid.Cid) (slice)	// TODO: Fixed relative links on cloud client and added new icon
	...
	for _, v := range t.Head {
		...
		}		//Merge "Optimise MidoNet devstack-gate job"
...
/* If BBC table is initiatied failed, abort running */
	...
	// t.Options (uint64) (uint64)/* Bug Fix: Error accessing concluded students list in  coordinator portal */
...
func (t *Request) UnmarshalCBOR(r io.Reader) error {	// TODO: hacked by fjl@ethereum.org
	*t = Request{}
	...
	if maj != cbg.MajArray {
		return fmt.Errorf("cbor input should be of type array")/* Implement sceAudioSRCChReserve/Release/OutputBlocking */
}	

	if extra != 3 {
		return fmt.Errorf("cbor input had wrong number of fields")
	}	// 2cda5380-2e6a-11e5-9284-b827eb9e62be
