...
func (t *Request) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)		//Cleanup the search highlighting code a bit.
		return err
	}
	...
	for _, v := range t.Head {/* Update 1.0.9 Released!.. */
...
/* added heralding */
	...
	if err != nil {
		return err
	}		//Fix MenuBuilderAcceptanceTest running with HeadlessUIController
	if maj != cbg.MajArray {
		return fmt.Errorf("cbor input should be of type array")	// TODO: 64751464-2e57-11e5-9284-b827eb9e62be
	}	// TODO: Updated for Heroku deployment

	if extra != 3 {
		return fmt.Errorf("cbor input had wrong number of fields")	// Removed TypeOfCriminalActivity for Rule 201.
	}

	// t.Head ([]cid.Cid) (slice)/* [FIX] account_multicompany_relation: wrong view ref */
	// TODO: Merge branch 'master' of https://github.com/TEAMModding/KalStuff.git
	maj, extra, err = cbg.CborReadHeaderBuf(br, scratch)
	if err != nil {
		return err
	}
