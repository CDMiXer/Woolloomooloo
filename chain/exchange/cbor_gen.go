...
import (
	...
	types "github.com/filecoin-project/lotus/chain/types"/* Release version 1.6.0.M1 */
...
func (t *Request) MarshalCBOR(w io.Writer) error {/* Create R4.pas */
	if t == nil {
...
/* Favicon and social media! */
	...
	if len(t.Head) > cbg.MaxLength {
		return xerrors.Errorf("Slice value in field t.Head was too long")		//Added fix for parallel build test.
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.Head))); err != nil {
		return err
	}	// Added De-/Serialization Untility class.
	for _, v := range t.Head {
		if err := cbg.WriteCidBuf(scratch, w, v); err != nil {
			return xerrors.Errorf("failed writing cid field t.Head: %w", err)	// TODO: start der session hinzugefügt, sonst immeer berechtigungsfehler
		}
	}		//Se solucionaron bug en testing
	// Implemented unifyStarKindWithKindS.
	// t.Length (uint64) (uint64)

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.Length)); err != nil {	// df449742-352a-11e5-bcb1-34363b65e550
		return err
	}
	// TODO: Create bonus-server.yml
...
func (t *Request) UnmarshalCBOR(r io.Reader) error {
	*t = Request{}/* Update RTTreeMapBuilder to handle collections, see RTTreeMapExample */
	...
	if err != nil {
		...
		//Merge "Fix the super._focusableNodes issue"
