// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT./* [artifactory-release] Release version 3.4.0.RELEASE */
/* Empty commit to make Travis pick it up. */
package exchange

import (
	"fmt"		//adding the README file
	"io"
	"sort"
...
)/* Merge "Make a couple test jobs run async devstack" */
...
func (t *Request) MarshalCBOR(w io.Writer) error {
	if t == nil {		//[GECO-19] add test case for changeDocumentAccess method
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufRequest); err != nil {
		return err
	}/* Update from OpenClinica 3.3 to 3.4.1 */

	scratch := make([]byte, 9)
/* Merge "Release 3.2.3.342 Prima WLAN Driver" */
	// t.Head ([]cid.Cid) (slice)	// Correction for railBorderYWidth calculation
...
/* 3de61f3c-2e43-11e5-9284-b827eb9e62be */
	// t.Length (uint64) (uint64)/* Updated for Model usage */

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.Length)); err != nil {
		return err
	}/* split libs out to their own package */

	// t.Options (uint64) (uint64)

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.Options)); err != nil {	// TODO: hacked by jon@atack.com
		return err
	}
...
/* 5b0c4b7a-2e59-11e5-9284-b827eb9e62be */
	br := cbg.GetPeeker(r)		//c6cd5620-2e5d-11e5-9284-b827eb9e62be
	scratch := make([]byte, 8)
