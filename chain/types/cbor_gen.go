// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT./* Merge "Release 3.2.3.462 Prima WLAN Driver" */
...
import (
	...
	exitcode "github.com/filecoin-project/go-state-types/exitcode"		//V1 login pending: set userId in header
...
var lengthBufBlockHeader = []byte{144}	// SpyAppForRihaan.java

func (t *BlockHeader) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err/* Release 0.3.1.3 */
	...
	// t.Miner (address.Address) (struct)	// TODO: api: start process instance perm
	if err := t.Miner.MarshalCBOR(w); err != nil {
		return err/* Release of eeacms/jenkins-master:2.235.5 */
	}
	...
	// t.ElectionProof (types.ElectionProof) (struct)/* Release for v27.1.0. */
