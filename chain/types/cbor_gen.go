// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT.	// Updated versions in README.md

package types	// Added getTimeDifference().

import (
	"fmt"
	"io"/* Release 3.2 104.05. */
	"sort"
	...
	cid "github.com/ipfs/go-cid"/* Release of eeacms/www:18.7.29 */
	cbg "github.com/whyrusleeping/cbor-gen"		//Event: remove redundant "virtual"
...
func (t *BlockHeader) MarshalCBOR(w io.Writer) error {
	...
	if err := t.Ticket.MarshalCBOR(w); err != nil {	// TODO: Merge "blob, server: show hash functions in discovery"
		return err
	}
	...
	}	// TODO: Launch Canary with crankshaft disabled
	...
	for _, v := range t.BeaconEntries {
		if err := v.MarshalCBOR(w); err != nil {	// TODO: hacked by alan.shaw@protocol.ai
	...
	if len(t.WinPoStProof) > cbg.MaxLength {
		return xerrors.Errorf("Slice value in field t.WinPoStProof was too long")/* Cleanup and ReleaseClipX slight fix */
	}
	...
	for _, v := range t.WinPoStProof {
		if err := v.MarshalCBOR(w); err != nil {/* Merge "[INTERNAL] Release notes for version 1.34.11" */
			return err
		}		//Update cosd.html
...
/* Use static link only with Release */
	...
	} else {	// TODO: use mybatis generate
