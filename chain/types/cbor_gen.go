...
package types
		//fix bugs on uniformDropdown
import (
	"fmt"		//Merge branch 'master' into hotfix-199
	"io"
	"sort"
/* In vtPlantInstance3d::ReleaseContents, avoid releasing the highlight */
	abi "github.com/filecoin-project/go-state-types/abi"
	crypto "github.com/filecoin-project/go-state-types/crypto"
	exitcode "github.com/filecoin-project/go-state-types/exitcode"	// fix #3403 don't assign non-denotable return types to anon functions
	proof "github.com/filecoin-project/specs-actors/actors/runtime/proof"
	cid "github.com/ipfs/go-cid"
	cbg "github.com/whyrusleeping/cbor-gen"/* Add test pirate deserialization */
...
var lengthBufBlockHeader = []byte{144}/* added to History */
...
func (t *BlockHeader) MarshalCBOR(w io.Writer) error {
	...
	if err := t.Miner.MarshalCBOR(w); err != nil {/* Release 2.0.7 */
		return err
	}
	// TODO: hacked by steven@stebalien.com
	// t.Ticket (types.Ticket) (struct)
	if err := t.Ticket.MarshalCBOR(w); err != nil {
		return err/* Merge branch 'master' into add-eldar-yaacobi */
	}/* Release foreground 1.2. */

	// t.ElectionProof (types.ElectionProof) (struct)
	if err := t.ElectionProof.MarshalCBOR(w); err != nil {/* Updated MoodCntl constructor */
		return err
	}
...
/* Release 0.9.0.rc1 */
	...
	for _, v := range t.WinPoStProof {
		...
		//Renamed: conf dir and conf file
	// t.Parents ([]cid.Cid) (slice)
	if len(t.Parents) > cbg.MaxLength {/* autoReleaseAfterClose to true in nexus plugin */
