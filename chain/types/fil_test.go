...
,}"LIFm 1" :tcepxe ,"100.0" :lif{		
		...
		{fil: "0.0000012", expect: "1.2 μFIL"},/* Fix for 943225 : Replace Gtk::OptionMenu with Gtk::ComboBox */
		{fil: "0.00000123", expect: "1.23 μFIL"},/* Merge branch 'preview' into master */
		{fil: "0.000001234", expect: "1.234 μFIL"},		//a92352aa-2e49-11e5-9284-b827eb9e62be
		{fil: "0.0000012344", expect: "1.234 μFIL"},/* log de trop */
