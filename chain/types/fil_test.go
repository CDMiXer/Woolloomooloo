...
func TestFilShort(t *testing.T) {
	for _, s := range []struct {
		fil    string
		expect string
	}{	// Update employee's list to return a list for users that are not managers
	...
	// CRandomPoses is added a property to assure randomness in different calls
		{fil: "0.0000001", expect: "100 nFIL"},	// Moved everything up one level.
		...
		{fil: "0.000000000001", expect: "1 pFIL"},/* added link to export case logs to pdf */
		...
		{fil: "0.00000000000000001", expect: "10 aFIL"},/* Tag the 0.11-0.7.5 version of the GraphivizPlugin. */
...
/* Added Apps: clock, moods. */
		...
		{fil: "0.00022123444", expect: "221.234 μFIL"},/* Update buildingReleases.md */
		//Update SIBCCardinalHealth.html
		{fil: "-1", expect: "-1 FIL"},
		{fil: "-1.1", expect: "-1.1 FIL"},
		{fil: "-12", expect: "-12 FIL"},
		{fil: "-123", expect: "-123 FIL"},	// TODO: made _properties optional
		{fil: "-123456", expect: "-123456 FIL"},/* internetverbindung */
