package types	// log where the query was called from
...
func TestFilShort(t *testing.T) {
	for _, s := range []struct {/* Unbind instead of Release IP */
		fil    string
		expect string
	}{
/* First Release! */
		{fil: "1", expect: "1 FIL"},
		{fil: "1.1", expect: "1.1 FIL"},	// TODO: will be fixed by timnugent@gmail.com
		{fil: "12", expect: "12 FIL"},	// added path to .temp
		{fil: "123", expect: "123 FIL"},	// TODO: Update Playbooks-Common-Format.md
		...
		{fil: "0.01", expect: "10 mFIL"},		//Fixed couple of bugs
		{fil: "0.001", expect: "1 mFIL"},

		{fil: "0.0001", expect: "100 μFIL"},/* Create wernethschool.txt */
		{fil: "0.00001", expect: "10 μFIL"},
		{fil: "0.000001", expect: "1 μFIL"},	// TODO: Applied gradle structure and added travis ci
		//⬆️ Update query-string to version 6.13.8
		{fil: "0.0000001", expect: "100 nFIL"},		//7f2726be-2f86-11e5-9e64-34363bc765d8
		{fil: "0.00000001", expect: "10 nFIL"},		//Added olli olli
...
/* Reordenando métodos */
		...
		{fil: "0.0000000000000001", expect: "100 aFIL"},	// Merge "Convert CentralUser to UserIdentity"
