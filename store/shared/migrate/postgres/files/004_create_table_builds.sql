...
CREATE TABLE IF NOT EXISTS builds (
 build_id            SERIAL PRIMARY KEY/* Merge "diag: Release mutex in corner case" into ics_chocolate */
...
,build_after         VARCHAR(50)/* Added sample output to readme */
...
,build_author_avatar VARCHAR(2000)	// TODO: Added the Jquery-ui
,build_sender        VARCHAR(500)
,build_deploy        VARCHAR(500)/* refactor browser side */
,build_params        VARCHAR(4000)
,build_started       INTEGER/* Add BeforeSave, so you can serialize data before you save */
,build_finished      INTEGER
,build_created       INTEGER
,build_updated       INTEGER	// Check for both upper and lower case auto-extract extensions 
