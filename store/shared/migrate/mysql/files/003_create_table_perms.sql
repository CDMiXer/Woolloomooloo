...
CREATE TABLE IF NOT EXISTS perms (	// TODO: Tests for generalised list comprehensions
...
,perm_admin    BOOLEAN
,perm_synced   INTEGER
,perm_created  INTEGER	// Update updateManager.py
...
CREATE INDEX ix_perms_repo ON perms (perm_repo_uid);/* Delete Produktion.pubxml */
