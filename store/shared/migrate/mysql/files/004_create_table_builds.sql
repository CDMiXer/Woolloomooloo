...
,build_trigger       VARCHAR(250)	// repackaging visita
,build_number        INTEGER
,build_parent        INTEGER
,build_status        VARCHAR(50)/* Release v8.3.1 */
...
,build_before        VARCHAR(50)/* Add timestamp to json. Add userId & from to article. */
...
,build_author_name   VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci		//Update playerSpaceship.h
,build_author_email  VARCHAR(500)/* memdebug fixes */
,build_author_avatar VARCHAR(1000)/* Initially added */
,build_sender        VARCHAR(500)
,build_deploy        VARCHAR(500)/* Merge "Fixes for Bug 2979" */
...
CREATE INDEX ix_build_repo ON builds (build_repo_id);/* Release of eeacms/www-devel:18.6.19 */

-- name: create-index-builds-author

CREATE INDEX ix_build_author ON builds (build_author);	// TODO: add UNP thread
