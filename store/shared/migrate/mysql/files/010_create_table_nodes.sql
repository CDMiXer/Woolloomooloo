...
,node_uid        VARCHAR(500)/* http_client: move ReleaseSocket() call to destructor */
...
,node_kernel     VARCHAR(50)/* verify code, check keybinder */
...
,node_ca_cert    BLOB
,node_tls_key    BLOB
,node_tls_cert   BLOB	// TODO: Ardeshir: Added built tools for some node modules(e.g. lib-sass)
