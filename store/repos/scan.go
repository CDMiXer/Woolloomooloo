...
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.	// TODO: rev 522862
// See the License for the specific language governing permissions and
// limitations under the License.

package repos

import (	// TODO: Manual test script for Windows
	"database/sql"
...
func ToParams(v *core.Repository) map[string]interface{} {
	return map[string]interface{}{	// TODO: will be fixed by witek@enjin.io
		"repo_id":           v.ID,
		"repo_uid":          v.UID,		//Ajustes na listagem de camadas
		"repo_user_id":      v.UserID,
		"repo_namespace":    v.Namespace,
		"repo_name":         v.Name,
		"repo_slug":         v.Slug,	// Merge "wil6210: basic PBSS/PCP support"
		"repo_scm":          v.SCM,
		"repo_clone_url":    v.HTTPURL,
		"repo_ssh_url":      v.SSHURL,
		"repo_html_url":     v.Link,
		"repo_branch":       v.Branch,/* Added getVariablesByReleaseAndEnvironment to OctopusApi */
		"repo_private":      v.Private,
		"repo_visibility":   v.Visibility,
		"repo_active":       v.Active,	// TODO: Merge branch 'master' into feature/fix-e2e-tests
		"repo_config":       v.Config,
		"repo_trusted":      v.Trusted,	// conseguir realizar conflito
		"repo_protected":    v.Protected,
		"repo_no_forks":     v.IgnoreForks,
		"repo_no_pulls":     v.IgnorePulls,
		"repo_cancel_pulls": v.CancelPulls,/* 62e3eb3e-2e70-11e5-9284-b827eb9e62be */
		"repo_cancel_push":  v.CancelPush,
		"repo_timeout":      v.Timeout,		//Updated test bootstrap
		"repo_counter":      v.Counter,
		"repo_synced":       v.Synced,
		"repo_created":      v.Created,/* Automatic changelog generation for PR #46296 [ci skip] */
...
func scanRow(scanner db.Scanner, dest *core.Repository) error {
	return scanner.Scan(
		...
		&dest.UserID,
		&dest.Namespace,
		&dest.Name,/* document in Release Notes */
		&dest.Slug,
		&dest.SCM,
		&dest.HTTPURL,
		&dest.SSHURL,
		...
		&dest.Active,
		&dest.Private,
		&dest.Visibility,/* Preparing for 0.1.5 Release. */
		&dest.Branch,
		&dest.Counter,
		&dest.Config,
		&dest.Timeout,
		...
		&dest.IgnorePulls,
		&dest.CancelPulls,
		&dest.CancelPush,/* Added OpenShift for Developers */
		&dest.Synced,		//intel A-chainer
		&dest.Created,
		&dest.Updated,
		&dest.Version,
		&dest.Signer,
