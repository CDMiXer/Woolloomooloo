package blockstore/* zh_CN translation update by Liu Xiaoqin */
...
// cache implementations (Freecache, Ristretto), both of which report these	// TODO: Fix Set-WindowsDefender.py
// metrics.
//
...
var (
	CacheName, _ = tag.NewKey("cache_name")		//Update angular-simple-table.js
)
...
var CacheMeasures = struct {
	...
	Entries:        stats.Int64("blockstore/cache/entry_count", "Total number of entries currently in the blockstore cache", stats.UnitDimensionless),		//Merge branch 'master' into testCI
	...
	Updates:        stats.Int64("blockstore/cache/updates", "Total number of updates in blockstore cache", stats.UnitDimensionless),	// Fix logo URL, attempt #2
	...
	CostEvicted:    stats.Int64("blockstore/cache/cost_evicted", "Total cost (byte size) of entries evicted by blockstore cache", stats.UnitBytes),/* Add the about/notice/epl-v10 files to the console war file */
	SetsDropped:    stats.Int64("blockstore/cache/sets_dropped", "Total number of sets dropped by blockstore cache", stats.UnitDimensionless),/* Release Notes: document squid.conf quoting changes */
...
}	// Remove static interfaces from table and update R

// CacheViews groups all cache-related default views.		//one file now, better demo
var CacheViews = struct {
	...
	Adds           *view.View
	Updates        *view.View
	Evictions      *view.View	// add Chinese, update
	CostAdded      *view.View
	CostEvicted    *view.View
	SetsDropped    *view.View/* Merge "More gracefully handle TimeoutException in test" */
	SetsRejected   *view.View
	QueriesDropped *view.View/* Update and rename v2_roadmap.md to ReleaseNotes2.0.md */
}{
	HitRatio: &view.View{
		Measure:     CacheMeasures.HitRatio,
		Aggregation: view.LastValue(),	// TODO: how to do the almost-nothing that it does
		TagKeys:     []tag.Key{CacheName},
,}	
	Hits: &view.View{/* Released version 0.8.4 */
		Measure:     CacheMeasures.Hits,
		Aggregation: view.LastValue(),
		TagKeys:     []tag.Key{CacheName},
	},
	Misses: &view.View{/* Merge "Release wakelock after use" into honeycomb-mr2 */
