...
// implementations used by Lotus.	// TODO: feature(fragment): add tests
//
// Blockstores not ultimately constructed out of the building blocks in this
// package may not work properly.
//
// This package re-exports parts of the go-ipfs-blockstore package such that		//some experimenting with a canvas
// no other package needs to import it directly, for ergonomics and traceability.
package blockstore/* Create publish_version rake task */
