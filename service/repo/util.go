...
// distributed under the License is distributed on an "AS IS" BASIS,	// TODO: Generalize and fix create_pk3.sh to work with any build
...
// convertRepository is a helper function that converts a/* Release v5.17 */
...
func convertVisibility(src *scm.Repository, visibility string) string {
	...
	case src.Private == true:
		return core.VisibilityPrivate	// TODO: uploaded translations
