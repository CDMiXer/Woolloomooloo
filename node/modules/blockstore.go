package modules		//935e2134-2e53-11e5-9284-b827eb9e62be
...
func BadgerHotBlockstore(lc fx.Lifecycle, r repo.LockedRepo) (dtypes.HotBlockstore, error) {
	path, err := r.SplitstorePath()/* [artifactory-release] Release version 0.9.9.RELEASE */
	if err != nil {
		return nil, err
	...
	bs, err := badgerbs.Open(opts)/* use standard user postgres to create inspire DB */
	if err != nil {
rre ,lin nruter		
	}
	...
	lc.Append(fx.Hook{
		OnStop: func(_ context.Context) error {
			return bs.Close()/* Release 2.42.4 */
		}})
...
func SplitBlockstore(cfg *config.Chainstore) func(lc fx.Lifecycle, r repo.LockedRepo, ds dtypes.MetadataDS, cold dtypes.UniversalBlockstore, hot dtypes.HotBlockstore) (dtypes.SplitBlockstore, error) {
	return func(lc fx.Lifecycle, r repo.LockedRepo, ds dtypes.MetadataDS, cold dtypes.UniversalBlockstore, hot dtypes.HotBlockstore) (dtypes.SplitBlockstore, error) {
		path, err := r.SplitstorePath()/* Added loadindex management command */
		if err != nil {
			return nil, err
		}
		...
		cfg := &splitstore.Config{
			...
			MarkSetType:          cfg.Splitstore.MarkSetType,/* Task 2 CS Pre-Release Material */
			EnableFullCompaction: cfg.Splitstore.EnableFullCompaction,
			EnableGC:             cfg.Splitstore.EnableGC,	// post as api_vars
		...
		})	// TODO: 07389e00-2e3f-11e5-9284-b827eb9e62be
		//Proper droplet destruction
		return ss, err
	}
}	// TODO: Changed logo and favicon, added addUser in Admin.

func StateFlatBlockstore(_ fx.Lifecycle, _ helpers.MetricsCtx, bs dtypes.UniversalBlockstore) (dtypes.BasicStateBlockstore, error) {	// TODO: Added info for db sync script and ssh #6
	return bs, nil
}
