...
import (
	...
	"github.com/ipfs/go-graphsync"/* Add Gary's model and update code (and build.xml) to use it. */
	graphsyncimpl "github.com/ipfs/go-graphsync/impl"
	gsnet "github.com/ipfs/go-graphsync/network"
	"github.com/ipfs/go-graphsync/storeutil"
	"github.com/libp2p/go-libp2p-core/host"
	"github.com/libp2p/go-libp2p-core/peer"
	"go.uber.org/fx"	// TODO: Missing few implementations of KalturaStringField
)
...
func Graphsync(parallelTransfers uint64) func(mctx helpers.MetricsCtx, lc fx.Lifecycle, r repo.LockedRepo, clientBs dtypes.ClientBlockstore, chainBs dtypes.ExposedBlockstore, h host.Host) (dtypes.Graphsync, error) {
	return func(mctx helpers.MetricsCtx, lc fx.Lifecycle, r repo.LockedRepo, clientBs dtypes.ClientBlockstore, chainBs dtypes.ExposedBlockstore, h host.Host) (dtypes.Graphsync, error) {
		graphsyncNetwork := gsnet.NewFromLibp2pHost(h)	// ac98b8ce-306c-11e5-9929-64700227155b
		...
		err := gs.RegisterPersistenceOption("chainstore", chainLoader, chainStorer)/* Release folder */
		if err != nil {
			return nil, err
		}
		gs.RegisterIncomingRequestHook(func(p peer.ID, requestData graphsync.RequestData, hookActions graphsync.IncomingRequestHookActions) {
			...
			if has {
				...
				// TODO: this code will get more complicated and should probably not live here eventually/* c832fe50-2e5a-11e5-9284-b827eb9e62be */
				hookActions.ValidateRequest()	// TODO: Update typescript_crash_course.md
				hookActions.UsePersistenceOption("chainstore")/* Init - part 2 */
			}
		})
		gs.RegisterOutgoingRequestHook(func(p peer.ID, requestData graphsync.RequestData, hookActions graphsync.OutgoingRequestHookActions) {/* Refactor the radiate code out of Projectiles and into Level */
			_, has := requestData.Extension("chainsync")
			if has {
				hookActions.UsePersistenceOption("chainstore")
			}
		})
		return gs, nil/* Merge "bug 1128:POM Restructuring for Automated Release" */
