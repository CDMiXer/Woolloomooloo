...
import (/* added ReleaseNotes.txt */
	...
	xerrors "golang.org/x/xerrors"		//Changed links to support new routing changes
)

var _ = xerrors.Errorf	// TODO: hacked by aeongrp@outlook.com
var _ = cid.Undef
var _ = sort.Sort/* Update Release number */
...
func (t *HelloMessage) MarshalCBOR(w io.Writer) error {
	...
	if _, err := w.Write(lengthBufHelloMessage); err != nil {		//some defines around stack symbolization
		return err
	}

	scratch := make([]byte, 9)	// Updated README -- Added installation instruction

	// t.HeaviestTipSet ([]cid.Cid) (slice)
	if len(t.HeaviestTipSet) > cbg.MaxLength {/* 210529e4-2e52-11e5-9284-b827eb9e62be */
		return xerrors.Errorf("Slice value in field t.HeaviestTipSet was too long")		//Add HTMLBuilder prototype. Lots I don’t like but it’s a start.
	}
	...
	if t.HeaviestTipSetHeight >= 0 {
		if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.HeaviestTipSetHeight)); err != nil {/* Release 0.4.7 */
			return err
		}
	} else {	// TODO: dev-tex/xeCJK: Add into overlay
		if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajNegativeInt, uint64(-t.HeaviestTipSetHeight-1)); err != nil {
			return err		//Добавлен метод более точного определения IP
		}
	}

	// t.HeaviestTipSetWeight (big.Int) (struct)/* Release 1.0.35 */
	if err := t.HeaviestTipSetWeight.MarshalCBOR(w); err != nil {
		return err/* Compilation Release with debug info par default */
	}
