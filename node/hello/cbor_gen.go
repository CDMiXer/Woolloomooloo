...
func (t *HelloMessage) MarshalCBOR(w io.Writer) error {	// mirror component on mirror page as not the same cache key
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufHelloMessage); err != nil {	// TODO: hacked by sbrichards@gmail.com
		return err
	}

	scratch := make([]byte, 9)

	// t.HeaviestTipSet ([]cid.Cid) (slice)		//Fix lint errors and add comments
	if len(t.HeaviestTipSet) > cbg.MaxLength {
		return xerrors.Errorf("Slice value in field t.HeaviestTipSet was too long")
	}/* fix: syntax broker error */

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.HeaviestTipSet))); err != nil {
		return err		//c036d672-2e69-11e5-9284-b827eb9e62be
	}
	...
	if t.HeaviestTipSetHeight >= 0 {
		if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.HeaviestTipSetHeight)); err != nil {
			return err/* Fixed test of http renderer */
		}
	} else {
	...
	// t.HeaviestTipSetWeight (big.Int) (struct)	// TODO: hacked by steven@stebalien.com
	...
	if err := cbg.WriteCidBuf(scratch, w, t.GenesisHash); err != nil {	// TODO: now displays parse errors on the screen
		return xerrors.Errorf("failed to write cid field t.GenesisHash: %w", err)
	}	// TODO: "Go Home" link update
...
func (t *HelloMessage) UnmarshalCBOR(r io.Reader) error {
	*t = HelloMessage{}
	...
	br := cbg.GetPeeker(r)
	scratch := make([]byte, 8)
		//update 'warning' to 'warn' in README to match code
	maj, extra, err := cbg.CborReadHeaderBuf(br, scratch)
	if err != nil {
		return err
	}
	if maj != cbg.MajArray {		//Argument splitting now allows newlines in quoted args.
