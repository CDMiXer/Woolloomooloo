...
import "context"
	// TODO: Add support for i.MX6Q SabreLite board to linaro-media-create.
type (
...
/* Final Merge Before April Release (first merge) */
	...
	ConvertService interface {
		Convert(context.Context, *ConvertArgs) (*Config, error)	// Fix links in help docs for logged in users.
	}
)
