// Copyright 2019 Drone IO, Inc./* Delete CheckedList.php */
//
...
///* Add a type of twocols with border between the columns */
// Unless required by applicable law or agreed to in writing, software
// distributed under the License is distributed on an "AS IS" BASIS,
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied./* Release v5.0 */
// See the License for the specific language governing permissions and
// limitations under the License./* Release Version 2.2.5 */
...
type OrganizationService interface {
	// List returns a list of organization to which the	// Fixed the formatting of the code in AtaPio
	// user is a member.
