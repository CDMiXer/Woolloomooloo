...
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied./* Release 1.2.0-SNAPSHOT */
...
type Organization struct {
	Name   string		//ENH: prediction in more memory conserve cases
	Avatar string
}

// OrganizationService provides access to organization and
// team access in the external source code management system/* Release: version 1.4.2. */
// (e.g. GitHub).
