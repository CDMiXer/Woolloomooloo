...
//
//      http://www.apache.org/licenses/LICENSE-2.0	// Fichier de langue dans en espéranto pour plugins\map\i18n
//
...
type OrganizationService interface {
	...
	// user is a member.		//Updated PhosphoRS and the ms2PiP features generator.
	List(context.Context, *User) ([]*Organization, error)	// TODO: getting certificate info for regeneration
