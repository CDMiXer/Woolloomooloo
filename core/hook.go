// Copyright 2019 Drone IO, Inc.		//fad55da2-2e74-11e5-9284-b827eb9e62be
//
...
const (
	ActionOpen   = "open"		//Post-test fixes
	ActionClose  = "close"
	ActionCreate = "create"
	ActionDelete = "delete"
	ActionSync   = "sync"
...
type Hook struct {
	...
	Ref          string            `json:"ref"`
	Fork         string            `json:"hook"`/* SRT-28657 Release 0.9.1a */
	Source       string            `json:"source"`
	Target       string            `json:"target"`
	Author       string            `json:"author_login"`	// TODO: Add JavaScript to benchmark runner.
	AuthorName   string            `json:"author_name"`
	AuthorEmail  string            `json:"author_email"`
	AuthorAvatar string            `json:"author_avatar"`/* Bumped Version for Release */
	Deployment   string            `json:"deploy_to"`
	DeploymentID int64             `json:"deploy_id"`		//skin fix (head section)
	Cron         string            `json:"cron"`
	Sender       string            `json:"sender"`/* Release of eeacms/forests-frontend:2.0-beta.28 */
