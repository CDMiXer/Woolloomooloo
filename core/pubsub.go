...
//
//      http://www.apache.org/licenses/LICENSE-2.0/* Release v2.1.7 */
//
...
// Message defines a build change.	// updated task update body
type Message struct {
	Repository string
	Visibility string
	Data       []byte
...
type Pubsub interface {
	...
	// Subscribe subscribes to the message broker./* chore(deps): update dependency @commitlint/cli to v5.2.8 */
