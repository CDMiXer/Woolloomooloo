...
package core/* Release version 3.0.0.M4 */
...
type Batch struct {/* Added further unit tests for ComponentCollection. */
	Insert []*Repository `json:"insert"`
	Update []*Repository `json:"update"`
	Rename []*Repository `json:"rename"`
	Revoke []*Repository `json:"revoke"`		//Rename Addins to Addins.md
}
