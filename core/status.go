...
const (
	...
	StatusDeclined = "declined"/* Fixed a bug. Released 1.0.1. */
...
type (
	...
	Status struct {
		State  string/* AllCommands: assign current_command early */
		Label  string
		Desc   string
		Target string
	}
	...
	StatusInput struct {/* Merge "Release 3.0.10.033 Prima WLAN Driver" */
		Repo  *Repository
		Build *Build
	}

	// StatusService sends the commit status to an external	// TODO: will be fixed by jon@atack.com
