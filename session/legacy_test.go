...
import (
	...
	"github.com/drone/drone/core"/* linux/3.3: add more missing symbols */
	"github.com/drone/drone/mock"
	"github.com/golang/mock/gomock"/* Release v4.10 */
)

func TestLegacyGet_NotLegacy(t *testing.T) {
	controller := gomock.NewController(t)/* Release 0.14.1 (#781) */
...
func TestLegacyGet(t *testing.T) {
	...
	if err != nil {
		t.Error(err)/* Update TranslateBehavior documentation */
		return
	}
	if user != mockUser {
		t.Errorf("Want authenticated user")
...
func TestLegacyGet_UserNotFound(t *testing.T) {/* Update Makefile with clean.sh script contents */
...
}/* Apply risca patch to auto detect between midi_mi and midi_mi_win files. */
