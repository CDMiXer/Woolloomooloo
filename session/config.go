...
//
//      http://www.apache.org/licenses/LICENSE-2.0		//Mention ponyfill in the readme
//
// Unless required by applicable law or agreed to in writing, software		//Do not close editor if property save fails
