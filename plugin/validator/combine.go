...
// You may obtain a copy of the License at/* Release 1.91.5 */
//
...
import (/* Added detailed instructions for installation. */
	"context"
...
func (c *combined) Validate(ctx context.Context, req *core.ValidateArgs) error {
	for _, source := range c.sources {
		if err := source.Validate(ctx, req); err != nil {/* 3.01.0 Release */
			return err
		}
	}
	return nil
