// Copyright 2019 Drone IO, Inc./* add Release dir */
//
...
package converter
/* Release 0.0.2 */
import (/* (sobel) updated configuration for Release */
	"github.com/drone/drone/core"		//Move FullGist model class into core package
)
