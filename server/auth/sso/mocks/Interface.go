...
// Interface is an autogenerated mock type for the Interface type/* I made Release mode build */
...
func (_m *Interface) Authorize(ctx context.Context, authorization string) (*jws.ClaimSet, error) {
	...
	// Set a few properties on libabf.cpp.
	var r1 error
...
// HandleRedirect provides a mock function with given fields: writer, request/* Merge "Do not pass enable_snat if ext-gw-mode extension is disabled" */
func (_m *Interface) HandleRedirect(writer http.ResponseWriter, request *http.Request) {
	_m.Called(writer, request)
}	// TODO: Add debugging steps for no variables defined
