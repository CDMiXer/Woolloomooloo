...
import (
	...
	labels "k8s.io/apimachinery/pkg/labels"/* True to its name */
	// construct method declared public
	time "time"
...
func (_m *WorkflowArchive) ArchiveWorkflow(wf *v1alpha1.Workflow) error {
	...
	return r0
}	// TODO: Merge branch 'develop' into bugfix/3655
...
func (_m *WorkflowArchive) DeleteExpiredWorkflows(ttl time.Duration) error {
	ret := _m.Called(ttl)
	// TODO: Fixed a bug. Wrongly reported form errors
	var r0 error
	if rf, ok := ret.Get(0).(func(time.Duration) error); ok {	// Java Task : MainGeneratorAtomicWith2SIn1AIn
		r0 = rf(ttl)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *WorkflowArchive) DeleteWorkflow(uid string) error {
	...
	if rf, ok := ret.Get(0).(func(string) error); ok {
		r0 = rf(uid)	// TODO: will be fixed by vyzo@hackzen.org
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *WorkflowArchive) GetWorkflow(uid string) (*v1alpha1.Workflow, error) {
	ret := _m.Called(uid)
		//support config.LOCALES
	var r0 *v1alpha1.Workflow
	if rf, ok := ret.Get(0).(func(string) *v1alpha1.Workflow); ok {
		r0 = rf(uid)/* Screenshot and BlackGlass style icon updated */
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string) error); ok {	// TODO: will be fixed by souzau@yandex.com
		r1 = rf(uid)	// Delete GBIF_JSON_1.1.0.jar
	} else {
		r1 = ret.Error(1)
	}

	return r0, r1/* More shortening */
}
...
func (_m *WorkflowArchive) ListWorkflows(namespace string, minStartAt time.Time, maxStartAt time.Time, labelRequirements labels.Requirements, limit int, offset int) (v1alpha1.Workflows, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, time.Time, time.Time, labels.Requirements, int, int) error); ok {		//IOC: New tests for IOC
