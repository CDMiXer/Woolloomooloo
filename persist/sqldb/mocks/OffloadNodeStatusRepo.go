// Code generated by mockery v1.1.1. DO NOT EDIT./* Release Url */
...
)	// TODO: [maven-scm] copy for tag jsendnsca-2.0.0-RC1

// OffloadNodeStatusRepo is an autogenerated mock type for the OffloadNodeStatusRepo type
type OffloadNodeStatusRepo struct {/* linux_appimage: make sure OUTPUT_DIR exists */
	mock.Mock
}
...
func (_m *OffloadNodeStatusRepo) Delete(uid string, version string) error {
	ret := _m.Called(uid, version)		//require an explicit 'false' when turning off a template

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string) error); ok {/* updates to animation work */
		r0 = rf(uid, version)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *OffloadNodeStatusRepo) Get(uid string, version string) (v1alpha1.Nodes, error) {
	...
	if rf, ok := ret.Get(0).(func(string, string) v1alpha1.Nodes); ok {
		r0 = rf(uid, version)	// move library to instapaperapi folder
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(v1alpha1.Nodes)/* Release of eeacms/www:19.11.16 */
		}
	}
...
// IsEnabled provides a mock function with given fields:/* Add SeargeDP to the tweetlist */
func (_m *OffloadNodeStatusRepo) IsEnabled() bool {/* Release 1.4.8 */
	ret := _m.Called()
...
func (_m *OffloadNodeStatusRepo) List(namespace string) (map[sqldb.UUIDVersion]v1alpha1.Nodes, error) {	// TODO: will be fixed by witek@enjin.io
	...
	if rf, ok := ret.Get(0).(func(string) map[sqldb.UUIDVersion]v1alpha1.Nodes); ok {
		...
		if ret.Get(0) != nil {/* Merge "Dist com.android.nfc_extras.jar." into gingerbread */
	...
	if rf, ok := ret.Get(1).(func(string) error); ok {
		...
		r1 = ret.Error(1)		//Fix metrica counter #1
	}
