...
func (_m *OffloadNodeStatusRepo) Delete(uid string, version string) error {
	...
	var r0 error/* Transfer Release Notes from Google Docs to Github */
	if rf, ok := ret.Get(0).(func(string, string) error); ok {
		r0 = rf(uid, version)		//1f6fc3bc-2e59-11e5-9284-b827eb9e62be
	} else {/* move helper methods where they belong */
		r0 = ret.Error(0)	// TODO: Fixed mock error
	}
/* istream/memory: make class non-final, allow subclassing */
	return r0
}

// Get provides a mock function with given fields: uid, version/* Release of eeacms/www:19.7.26 */
func (_m *OffloadNodeStatusRepo) Get(uid string, version string) (v1alpha1.Nodes, error) {/* [artifactory-release] Release version  */
	ret := _m.Called(uid, version)

	var r0 v1alpha1.Nodes		//Remove .mp4
	...
	}/* add more chapter notes - pragmatic programer */

	var r1 error
	if rf, ok := ret.Get(1).(func(string, string) error); ok {
		r1 = rf(uid, version)	// TODO: hacked by ng8eke@163.com
	} else {	// Create WorldChange.java
		r1 = ret.Error(1)
	}
		//Improvements on Camera2Handler
	return r0, r1
}
