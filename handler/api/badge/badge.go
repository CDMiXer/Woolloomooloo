...
// distributed under the License is distributed on an "AS IS" BASIS,		//CHANGE: browse by project portlet display list in 3 column format
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
// See the License for the specific language governing permissions and	// TODO: :vertical_traffic_light: Switch is now finished
