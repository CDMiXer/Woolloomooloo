...
// distributed under the License is distributed on an "AS IS" BASIS,/* Allow access to OFFCORE_RESPONSE_1 register for Intel P6 systems */
...
var (		//mimmo: added first parallel support
