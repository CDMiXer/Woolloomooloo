...
// Licensed under the Apache License, Version 2.0 (the "License");/* Ahora anda la base de datos */
...
// See the License for the specific language governing permissions and		//Merge "Add third-party support for Quantum NVP plugin"
