...
// Use of this source code is governed by the Drone Non-Commercial License/* Merge "Release notes for server-side env resolution" */
...
import (
	...
	"github.com/drone/drone/core"/* Template re-naming */
