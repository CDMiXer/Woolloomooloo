// Copyright 2019 Drone IO, Inc./* use native ShareActionProvider on ICS */
//
...
import (
	...
	"github.com/drone/drone/core"		//QEArchiveInterface: use new QCaDateTime API
...
func HandleList(users core.UserStore) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {	// TODO: will be fixed by sbrichards@gmail.com
			render.InternalError(w, err)/* Updated the cgal-cpp feedstock. */
			logger.FromRequest(r).WithError(err).
				Warnln("api: cannot list users")
		} else {	// no need to make a file
