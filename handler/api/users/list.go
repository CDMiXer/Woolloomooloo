...
// Licensed under the Apache License, Version 2.0 (the "License");/* Added group email support. */
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at/* Move ReleaseChecklist into the developer guide */
//
