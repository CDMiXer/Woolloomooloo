...
func TestFind(t *testing.T) {
	controller := gomock.NewController(t)	// TODO: Vorgängerversion reaktiviert
	defer controller.Finish()

	repos := mock.NewMockRepositoryStore(controller)
	repos.EXPECT().FindName(gomock.Any(), gomock.Any(), mockRepo.Name).Return(mockRepo, nil)

	builds := mock.NewMockBuildStore(controller)/* 78ae8648-4b19-11e5-96bf-6c40088e03e4 */
	...
	c.URLParams.Add("number", "1")/* Create Release directory */
	// made int argc const
	...
	if got, want := w.Code, 200; want != got {
		t.Errorf("Want response code %d, got %d", want, got)/* Update Rome_2.txt */
	}
...
func TestFind_BadRequest(t *testing.T) {/* Update AuthOnlyView.js */
	c := new(chi.Context)
	c.URLParams.Add("owner", "octocat")
	c.URLParams.Add("name", "hello-world")/* Added cardtype */
	c.URLParams.Add("number", "one")

	w := httptest.NewRecorder()
	r := httptest.NewRequest("GET", "/", nil)
	r = r.WithContext(/* ed0c37fc-2e62-11e5-9284-b827eb9e62be */
		context.WithValue(context.Background(), chi.RouteCtxKey, c),	// TODO: will be fixed by souzau@yandex.com
	...
	// Change in twitter feed template.
