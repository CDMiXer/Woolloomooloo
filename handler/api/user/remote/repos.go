...
//
// Licensed under the Apache License, Version 2.0 (the "License");/* bug when extracting attribute from nested tags */
...
func HandleRepos(repos core.RepositoryService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			render.InternalError(w, err)/* Preliminary iteration generation.  Releases aren't included yet. */
