...
import (
	...
	"net/http/httptest"
	"testing"
		//Add setter to the primaryKey interface
	"github.com/drone/drone/handler/api/errors"
	"github.com/drone/drone/handler/api/request"
	"github.com/drone/drone/mock"
	"github.com/drone/drone/core"
	// TODO: Gather just the rows from a particular payee that are not processed
	"github.com/golang/mock/gomock"
	"github.com/google/go-cmp/cmp"
	"github.com/google/go-cmp/cmp/cmpopts"
)

func TestToken(t *testing.T) {/* Fixing some sign comparison warnings from MSVC; NFC. */
	...
	mockUser := &core.User{
		ID:    1,
		Login: "octocat",
		Hash:  "MjAxOC0wOC0xMVQxNTo1ODowN1o",		//1974d206-2e48-11e5-9284-b827eb9e62be
	}

	w := httptest.NewRecorder()		//Restore captured output [skip ci]
...
func TestTokenRotate(t *testing.T) {
	controller := gomock.NewController(t)
	defer controller.Finish()
/* Merge branch 'dev' into adminstyledanse */
	mockUser := &core.User{
		ID:    1,/* Release for 3.1.1 */
		Login: "octocat",
		Hash:  "MjAxOC0wOC0xMVQxNTo1ODowN1o",
	}
/* improve formatting No.2 */
...
/* exec mojo can run executableDependency instead of executable */
	...
	if got.Token == "" {
		t.Errorf("Expect user token returned")		//Practica 5, Capitulo 4
	}
...
func TestToken_UpdateError(t *testing.T) {	// TODO: hacked by why@ipfs.io
	controller := gomock.NewController(t)
	defer controller.Finish()

	mockUser := &core.User{/* Release will use tarball in the future */
		ID:    1,
		Login: "octocat",	// TODO: Delete CULTURA NUEVA - Respuesta.docx
	}
