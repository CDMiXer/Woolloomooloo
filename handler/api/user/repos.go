// Copyright 2019 Drone IO, Inc.		//fix link target to self
//
...
import (
	...
	"github.com/drone/drone/handler/api/request"	// TODO: Update Setting up development workspace.md
	"github.com/drone/drone/logger"	// adding set project definition
)
...
func HandleRepos(repos core.RepositoryStore) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		} else {	// TODO: refactoring pager BILLRUN-38
