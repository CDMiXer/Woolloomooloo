...
// you may not use this file except in compliance with the License./* Deleting wiki page Release_Notes_v1_7. */
...
// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied./* Release new version 1.2.0.0 */
...
func HandleRepos(repos core.RepositoryStore) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if r.FormValue("latest") != "true" {
			...
			list, err = repos.ListLatest(r.Context(), viewer.ID)		//add child accessor by field 
		}
		if err != nil {
